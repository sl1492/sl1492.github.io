  ...
  [1268],
  {
    91268: (e, t, s) => {
      ...
      class A extends $ {
        ...
        toString() {
          return `[${this.inverted ? "^" : ""}${this.ranges.map(
            ([e, t]) => String.fromCodePoint(e) + (t == e + 1 ? "" : "-" + String.fromCodePoint(t))
          )}]`;
        }
        eq(e) {
          return (
      ...
      class Y {
        ...
        join(e) {
          ...
          return new Y(Math.max(this.precedence, e.precedence), Z(this.ambigGroups, e.ambigGroups), Math.max(this.cut, e.cut));
        }
        cmp(e) {
      ...
      class X {
        ...
        toString() {
          return `-> ${this.target.id}[label=${JSON.stringify(
            this.from < 0 ? "ε" : ee(this.from) + (this.to > this.from + 1 ? "-" + ee(this.to - 1) : "")
          )}]`;
        }
      }
      function ee(e) {
      ...
      class Xe {
        ...
        cmp(e) {
          return e instanceof Ve ? 1 : this.term.id - e.term.id || this.rule.name.id - e.rule.name.id || this.rule.parts.length - e.rule.parts.length;
        }
        matches(e, t) {
      ...
      class st {
        ...
        eq(e) {
          ...
          return this.skip == e.skip && this.tokenGroup == e.tokenGroup && He(this.actions, e.actions) && He(this.goto, e.goto);
        }
      }
      function it(e, t) {
        let s = [],
      ...
      class Rt {
        ...
        getParserFile() {
          ...
          let A = p.map((e) => {
            if (e instanceof rs) {
              ...
              return `{term: ${e.term.id}, get: (value${s}, stack${s}) => (${t}(value, stack) << 1)${
                e.ast.type == "extend" ? ` | ${1}` : ""
              }, external: ${t}${e.ast.type == "extend" ? ", extend: true" : ""}}`;
            } else {
        ...
        resolveSpecialization(e) {
          ...
          else if (e.content instanceof O && e.content.exprs.every((e) => e instanceof N)) a = e.content.exprs.map((e) => e.value);
