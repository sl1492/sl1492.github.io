    ...
    95566: (e, t, r) => {
      ...
      function a(e) {
        ...
        function h(e, l) {
          ...
          if (s.hexNumber && ((c == "0" && e.match(/^[xX][0-9a-fA-F]+/)) || ((c == "x" || c == "X") && e.match(/^'[0-9a-fA-F]*'/)))) {
            return "number";
          } else if (s.binaryNumber && (((c == "b" || c == "B") && e.match(/^'[01]+'/)) || (c == "0" && e.match(/^b[01]*/)))) {
            return "number";
            ...
            return "keyword";
          } else if (s.escapeConstant && (c == "e" || c == "E") && (e.peek() == "'" || (e.peek() == '"' && s.doubleQuote))) {
            ...
            e.skipToEnd();
            return "comment";
          } else if ((s.commentHash && c == "#") || (c == "-" && e.eat("-") && (!s.commentSpaceRequired || e.eat(" ")))) {
            e.skipToEnd();
            return "comment";
          } else if (c == "/" && e.eat("*")) {
            l.tokenize = f(1);
            ...
            e.eatWhile(g);
            return "punctuation";
          } else if (c == "{" && (e.match(/^( )*(d|D|t|T|ts|TS)( )*'[^']*'( )*}/) || e.match(/^( )*(d|D|t|T|ts|TS)( )*"[^"]*"( )*}/))) {
            return "number";
          } else {
            e.eatWhile(/^[_\w\d]/);
        ...
        return {
          ...
          languageData: {
            commentTokens: { line: s.commentSlashSlash ? "//" : s.commentHash ? "#" : "--", block: { open: "/*", close: "*/" } },
      ...
      const m = a({
        ...
        atoms: c("is not null like and or in left right between inner outer join all any some cross unpivot pivot exists"),
        operatorChars: /^[*+\-%<>!=^\&|\/]/,
        brackets: /^[\{}\(\)]/,
        punctuation: /^[;.,:/]/,
      ...
      const p = a({
        client: c("charset clear connect edit ego exit go help nopager notee nowarning pager print prompt quit rehash source status system tee"),
        keywords: c(
          l +
      ...
      const y = a({
        ...
        backslashStringEscapes: false,
        dateSQL: c("date time timestamp"),
        support: c("ODBCdotTable decimallessFloat zerolessFloat binaryNumber hexNumber nCharCast charsetCast escapeConstant"),
      });
      const v = a({
        keywords: c("ancestor and asc by contains desc descendant distinct from group has in is limit offset on order select superset where"),
        atoms: c("false true"),
