    ...
    95446: (t, e, s) => {
      ...
      const Y = (t, e, s, n, i, c) => {
        ...
        if (a !== "root") {
          ...
          if (!H[a]) {
            H[a] = { id: a, shape: e, description: r.e.sanitizeText(a, (0, r.c)()), classes: `${l} ${S}` };
          }
          const n = H[a];
          if (s.description) {
          ...
          if (!n.type && s.doc) {
            ...
            n.type = "group";
            n.dir = tt(s);
            n.shape = s.type === o.a ? w : v;
            n.classes = n.classes + " " + E + " " + (c ? V : "");
          }
          const i = {
            labelStyle: "",
            shape: n.shape,
      ...
      const Z = (t, e, s, n, i, c) => {
        ...
        s.forEach((s) => {
          switch (s.stmt) {
            ...
            case o.S:
              {
                Y(t, e, s.state1, n, i, c);
                Y(t, e, s.state2, n, i, c);
                const o = {
                  id: "edge" + J,
                  arrowhead: "normal",
                ...
                t.setEdge(s.state1.id, s.state2.id, o, J);
                J++;
              }
              break;
          }
      ...
      const et = async function (t, e, s, o) {
        ...
        const u = new n.T({ multigraph: true, compound: true })
          .setGraph({ rankdir: tt(o.db.getRootDocV2()), nodesep: d, ranksep: p, marginx: 8, marginy: 8 })
          .setDefaultEdgeLabel(function () {
            return {};
          });
        Y(u, void 0, o.db.getRootDocV2(), b, o.db, true);
        let g;
        if (a === "sandbox") {
          g = (0, i.Ltv)("#i" + e);
        }
        const h = a === "sandbox" ? (0, i.Ltv)(g.nodes()[0].contentDocument.body) : (0, i.Ltv)("body");
        ...
        const x = v.width + w * 2;
        const m = v.height + w * 2;
        y.attr("class", T);
        const k = y.node().getBBox();
        (0, r.i)(y, m, x, l.useMaxWidth);
        const S = `${k.x - w} ${k.y - w} ${x} ${m}`;
        r.l.debug(`viewBox ${S}`);
        y.attr("viewBox", S);
      ...
      const st = { setConf: K, getClasses: Q, draw: et };
      const ot = {
        parser: o.p,
        db: o.d,
        renderer: st,
