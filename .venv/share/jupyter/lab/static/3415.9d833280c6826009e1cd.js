  ...
  [3415],
  {
    53415: (t, e, n) => {
      ...
      const L = function (t, e, n) {
        ...
        i.ry = 3;
        A(s, i);
        F(n)(e.text, s, i.x, i.y, i.width, i.height, { class: "journey-section section-type-" + e.num }, n, e.colour);
      };
      let V = -1;
      const D = function (t, e, n) {
        ...
        F(n)(e.task, i, o.x, o.y, o.width, o.height, { class: "task" }, n, e.colour);
      };
      ...
      const B = { drawRect: A, drawCircle: I, drawSection: L, drawText: P, drawLabel: j, drawTask: D, drawBackgroundRect: O, initGraphics: N };
      const R = function (t) {
      ...
      function W(t) {
        ...
        Object.keys(z).forEach((s) => {
          const i = z[s].color;
          const r = { cx: 20, cy: n, r: 7, fill: i, stroke: "#000", pos: z[s].position };
          B.drawCircle(t, r);
      ...
      const Y = (0, s.c)().journey;
      const q = Y.leftMargin;
      const J = function (t, e, n, r) {
        ...
        const l = o === "sandbox" ? (0, i.Ltv)(c.nodes()[0].contentDocument.body) : (0, i.Ltv)("body");
        X.init();
        const h = l.select("#" + e);
        B.initGraphics(h);
        ...
        let p = 0;
        f.forEach((t) => {
          z[t] = { color: a.actorColours[p % a.actorColours.length], position: p };
          p++;
        });
        W(h);
        X.insert(0, 0, q, Object.keys(z).length * 50);
        U(h, u, 0);
        const d = X.getBounds();
        if (y) {
          h.append("text").text(y).attr("x", q).attr("font-size", "4ex").attr("font-weight", "bold").attr("y", 25);
        }
        const g = d.stopy - d.starty + 2 * a.diagramMarginY;
        const x = q + d.stopx + 2 * a.diagramMarginX;
      ...
      const X = {
        ...
        updateBounds: function (t, e, n, i) {
          ...
          function c(s) {
            return function c(l) {
              ...
              a.updateVal(X.data, "startx", t - h * r.boxMargin, Math.min);
              a.updateVal(X.data, "stopx", n + h * r.boxMargin, Math.max);
              if (!(s === "activation")) {
                a.updateVal(l, "startx", t - h * r.boxMargin, Math.min);
                a.updateVal(l, "stopx", n + h * r.boxMargin, Math.max);
                a.updateVal(X.data, "starty", e - h * r.boxMargin, Math.min);
                a.updateVal(X.data, "stopy", i + h * r.boxMargin, Math.max);
              }
            };
          }
        ...
        insert: function (t, e, n, s) {
          ...
          this.updateVal(X.data, "starty", a, Math.min);
          this.updateVal(X.data, "stopx", r, Math.max);
          this.updateVal(X.data, "stopy", o, Math.max);
      ...
      const G = Y.sectionFills;
      const H = Y.sectionColours;
      const U = function (t, e, n) {
        ...
        for (const [s, y] of e.entries()) {
          if (r !== y.section) {
            ...
            const o = { x: s * i.taskMargin + s * i.width + q, y: 50, text: y.section, fill: l, num: u, colour: h, taskCount: n };
            B.drawSection(t, o, i);
            r = y.section;
            c++;
          }
          ...
          y.x = s * i.taskMargin + s * i.width + q;
          y.y = o;
          ...
          y.actors = n;
          B.drawTask(t, y, i);
          X.insert(y.x, y.y, y.x + y.width + i.taskMargin, 300 + 5 * 30);
        }
      };
      const Z = { setConf: R, draw: J };
      const K = {
        parser: y,
        db: T,
        renderer: Z,
