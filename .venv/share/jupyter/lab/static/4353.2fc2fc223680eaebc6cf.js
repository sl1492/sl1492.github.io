  ...
  [4353],
  {
    44353: (e, t, n) => {
      ...
      n.d(t, {
        ...
        deleteCharBackwardStrict: () => Lt,
        deleteCharForward: () => Mt,
        deleteGroupBackward: () => Tt,
        deleteGroupForward: () => Ot,
        deleteLine: () => Kt,
        deleteLineBoundaryBackward: () => Vt,
        deleteLineBoundaryForward: () => Nt,
        deleteToLineEnd: () => It,
        deleteToLineStart: () => Rt,
        ...
        insertBlankLine: () => Yt,
        insertNewline: () => $t,
        insertNewlineAndIndent: () => Xt,
        insertNewlineKeepIndent: () => qt,
        insertTab: () => on,
        invertedEffects: () => L,
        isolateHistory: () => x,
        lineComment: () => m,
      ...
      const b = r.StateField.define({
        ...
        update(e, t) {
          ...
          if (o) {
            ...
            else s = $(s, t.startState.selection);
      ...
      function $(e, t) {
        if (!e.length) {
          ...
          let n = e[e.length - 1];
          let r = n.selectionsAfter.slice(Math.max(0, n.selectionsAfter.length - K));
      ...
      class Z {
        ...
        addSelection(e, t, n, r) {
          ...
          return new Z($(this.done, e), this.undone, t, n);
        }
        addMapping(e) {
        ...
        pop(e, t, n) {
          ...
          if (n && o.selectionsAfter.length) {
            return t.update({
              ...
              annotations: D.of({ side: e, rest: q(r), selection: l }),
      ...
      const ee = [
        ...
        { key: "Mod-u", run: N, preventDefault: true },
        { key: "Alt-u", mac: "Mod-Shift-u", run: U, preventDefault: true },
      ];
      function te(e, t) {
      ...
      const Ne = (e) => re(e, (t) => Oe(e, t, se(e)));
      const Ue = (e) => re(e, (t) => r.EditorSelection.cursor(e.lineBlockAt(t.head).from, 1));
      ...
      const vt = ({ state: e, dispatch: t }) => {
        let n = Ft(e).map(({ from: t, to: n }) => r.EditorSelection.range(t, Math.min(n + 1, e.doc.length)));
      ...
      const xt = (e) => Dt(e, false, true);
      const Lt = (e) => Dt(e, false, false);
      const Mt = (e) => Dt(e, true, false);
      const bt = (e, t) =>
        Bt(e, (n) => {
          let o = n.head,
            { state: l } = e,
      ...
      const Tt = (e) => bt(e, false);
      const Ot = (e) => bt(e, true);
      const It = (e) =>
        Bt(e, (t) => {
      ...
      const Ht = ({ state: e, dispatch: t }) => Pt(e, t, false);
      const zt = ({ state: e, dispatch: t }) => Pt(e, t, true);
      function Wt(e, t, n) {
        if (e.readOnly) return false;
        let r = [];
        for (let o of Ft(e)) {
      ...
      const _t = ({ state: e, dispatch: t }) => Wt(e, t, false);
      const jt = ({ state: e, dispatch: t }) => Wt(e, t, true);
      const Kt = (e) => {
        if (e.state.readOnly) return false;
        let { state: t } = e,
          n = t.changes(
            Ft(t).map(({ from: e, to: n }) => {
              if (e > 0) e--;
      ...
      const on = ({ state: e, dispatch: t }) => {
        if (e.selection.ranges.some((e) => !e.empty)) return nn({ state: e, dispatch: t });
      ...
      const sn = [
        ...
        { key: "Mod-ArrowLeft", mac: "Alt-ArrowLeft", run: de, shift: qe, preventDefault: true },
        ...
        { mac: "Cmd-ArrowRight", run: Ne, shift: ht, preventDefault: true },
        ...
        { key: "Mod-Delete", mac: "Alt-Delete", run: Ot },
        { mac: "Mod-Backspace", run: Vt },
        { mac: "Mod-Delete", run: Nt },
      ].concat(ln.map((e) => ({ mac: e.key, run: e.run, shift: e.shift })));
      const an = [
        { key: "Alt-ArrowLeft", mac: "Ctrl-ArrowLeft", run: Ce, shift: nt },
        { key: "Alt-ArrowRight", mac: "Ctrl-ArrowRight", run: Be, shift: rt },
        { key: "Alt-ArrowUp", run: Ht },
        { key: "Shift-Alt-ArrowUp", run: _t },
        { key: "Alt-ArrowDown", run: zt },
        { key: "Shift-Alt-ArrowDown", run: jt },
        { key: "Escape", run: Ct },
        { key: "Mod-Enter", run: Yt },
      ...
      const cn = { key: "Tab", run: nn, shift: rn };
    },
  },
]);
