...
(self["webpackChunk_jupyterlab_application_top"] = self["webpackChunk_jupyterlab_application_top"] || []).push([
  [4701],
  {
    94701: (t, e, n) => {
            ...
            while (true) {
              ...
              if (typeof v === "undefined" || !v.length || !v[0]) {
                ...
                if (f.showPosition) {
                  ...
                  M = "Parse error on line " + (l + 1) + ": Unexpected " + (_ == u ? "end of input" : "'" + (this.terminals_[_] || _) + "'");
                }
                this.parseError(M, { text: f.match, token: this.terminals_[_] || _, line: f.yylineno, loc: m, expected: L });
              }
      ...
      const M = { clear: k, getCommonDb: _, addSection: v, getSections: w, getTasks: S, addTask: $, addTaskOrg: I, addEvent: E };
      ...
      const D = function (t, e, n) {
        ...
        s.append("line")
          ...
          .attr("stroke", "#666");
        N(s, { cx: i, cy: 300 + (5 - e.score) * 30, score: e.score });
        const a = B();
        a.x = e.x;
        a.y = e.y;
        a.fill = e.fill;
      ...
      const Y = {
        ...
        drawLabel: P,
        drawTask: D,
        drawBackgroundRect: W,
        getTextObj: R,
        getNoteRect: B,
        initGraphics: V,
        drawNode: G,
        getVirtualNodeHeight: J,
      };
      const Z = function (t, e, n, r) {
        ...
        const u = h === "sandbox" ? (0, s.Ltv)(d.nodes()[0].contentDocument.body) : (0, s.Ltv)("body");
        const p = u.select("#" + e);
        p.append("g");
        ...
        g.forEach(function (t) {
          ...
          const n = Y.getVirtualNodeHeight(p, e, c);
        ...
        for (const [s, M] of f.entries()) {
          const t = { number: s, descr: M, section: M.section, width: 150, padding: 20, maxHeight: x };
          const e = Y.getVirtualNodeHeight(p, t, c);
          i.l.debug("taskHeight before draw", e);
          x = Math.max(x, e + 20);
          $ = Math.max($, M.events.length);
          let n = 0;
          for (let i = 0; i < M.events.length; i++) {
            const t = M.events[i];
            const e = { descr: t, section: M.section, number: M.section, width: 150, padding: 20, maxHeight: 50 };
            n += Y.getVirtualNodeHeight(p, e, c);
          }
          E = Math.max(E, n);
        }
        ...
        b = S ? m + x + 150 : x + 100;
        const L = p.append("g").attr("class", "lineWrapper");
        L.append("line")
          .attr("x1", l)
          .attr("y1", b)
          .attr("x2", I.width + 3 * l)
      ...
      const K = function (t, e, n, s, r, a, o, c, l, h, d) {
        var u;
        for (const p of e) {
      ...
      const nt = et;
      const it = { db: A, renderer: Q, parser: f, styles: nt };
    },
  },
]);
