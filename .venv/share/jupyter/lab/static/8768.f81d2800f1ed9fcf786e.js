...
(self["webpackChunk_jupyterlab_application_top"] = self["webpackChunk_jupyterlab_application_top"] || []).push([
  [8768],
  {
    28768: (t, e, r) => {
      ...
      function b(t) {
        const e = (0, n.Ltv)(document.createElementNS("http://www.w3.org/2000/svg", "foreignObject"));
      ...
      const $ = P;
      const R = { node: M, circle: _, ellipse: T, polygon: E, rect: $ };
      const Y = async (t, e) => {
      ...
      const F = (t, e) => {
        ...
        const u = e.padding / 2;
        (0, n.Ltv)(y).attr("transform", "translate( " + (p.width > g.width ? 0 : (g.width - p.width) / 2) + ", " + (g.height + u + 5) + ")");
        (0, n.Ltv)(h).attr("transform", "translate( " + (p.width < g.width ? 0 : -(g.width - p.width) / 2) + ", 0)");
        p = l.node().getBBox();
      ...
      const K = async (t, e) => {
        ...
        e.intersect = function (t) {
          ...
          return R.circle(e, n.width / 2 + s, t);
        };
        return r;
      };
      const tt = async (t, e) => {
        ...
        e.intersect = function (t) {
          ...
          return R.circle(e, n.width / 2 + s + i, t);
        };
        return r;
      };
      const et = async (t, e) => {
      ...
      const st = (t, e) => {
        ...
        (0, n.Ltv)(v).attr("class", "classTitle");
        let S = v.getBBox();
        if ((0, a.m)((0, a.c)().flowchart.htmlLabels)) {
        ...
        if (u) {
          let t = (p - b.width) / 2;
          (0, n.Ltv)(x).attr("transform", "translate( " + ((-1 * p) / 2 + t) + ", " + (-1 * f) / 2 + ")");
          y = b.height + s;
        }
        let _ = (p - S.width) / 2;
        (0, n.Ltv)(v).attr("transform", "translate( " + ((-1 * p) / 2 + _) + ", " + ((-1 * f) / 2 + y) + ")");
        y += S.height + s;
        ...
        y += i;
        M.forEach((t) => {
          (0, n.Ltv)(t).attr("transform", "translate( " + -p / 2 + ", " + ((-1 * f) / 2 + y + i / 2) + ")");
        ...
        y += i;
        T.forEach((t) => {
          (0, n.Ltv)(t).attr("transform", "translate( " + -p / 2 + ", " + ((-1 * f) / 2 + y) + ")");
          const e = t == null ? void 0 : t.getBBox();
          y += ((e == null ? void 0 : e.height) ?? 0) + s;
        });
        c.attr("style", e.style)
      ...
      const Bt = function (t, e, r, s, i, o, l) {
        ...
        const { x: y, y: u } = yt(r);
        const w = (0, n.n8j)().x(y).y(u).curve(g);
        let x;
        switch (r.thickness) {
          case "normal":
