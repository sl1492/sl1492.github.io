...
(self["webpackChunk_jupyterlab_application_top"] = self["webpackChunk_jupyterlab_application_top"] || []).push([
  [1673],
  {
      ...
      var S = (function (c) {
        ...
        t.prototype.addDelimiterVStyles = function (c, t, e) {
          ...
          if (n) {
            ...
            S.height = "50%";
            c["mjx-stretchy-v" + t + " > mjx-mid"] = { "margin-top": this.em(-u / 2), "margin-bottom": this.em(-u / 2) };
          }
          if (l) {
        ...
        t.prototype.addCharStyles = function (c, t, e, i) {
          ...
          c[s + "::before"] = { padding: this.padding(i, 0, f.ic || 0), content: f.c != null ? '"' + f.c + '"' : this.charContent(e) };
        };
        ...
        t.prototype.charContent = function (c) {
          return '"' + (c >= 32 && c <= 126 && c !== 34 && c !== 39 && c !== 92 ? String.fromCharCode(c) : "\\" + c.toString(16).toUpperCase()) + '"';
        };
        ...
        t.defaultFonts = { "@font-face /* 0 */": { "font-family": "MJXZERO", src: 'url("%%URL%%/MathJax_Zero.woff") format("woff")' } };
        return t;
      })(n.FontData);
      t.CHTMLFontData = S;
      function u(c, t) {
    ...
    1673: function (c, t, e) {
      ...
      var O = (function (c) {
        ...
        t.defaultFonts = f(f({}, r.CHTMLFontData.defaultFonts), {
          "@font-face /* 1 */": { "font-family": "MJXTEX", src: 'url("%%URL%%/MathJax_Main-Regular.woff") format("woff")' },
          "@font-face /* 2 */": { "font-family": "MJXTEX-B", src: 'url("%%URL%%/MathJax_Main-Bold.woff") format("woff")' },
          "@font-face /* 3 */": { "font-family": "MJXTEX-I", src: 'url("%%URL%%/MathJax_Math-Italic.woff") format("woff")' },
          "@font-face /* 4 */": { "font-family": "MJXTEX-MI", src: 'url("%%URL%%/MathJax_Main-Italic.woff") format("woff")' },
          "@font-face /* 5 */": { "font-family": "MJXTEX-BI", src: 'url("%%URL%%/MathJax_Math-BoldItalic.woff") format("woff")' },
          "@font-face /* 6 */": { "font-family": "MJXTEX-S1", src: 'url("%%URL%%/MathJax_Size1-Regular.woff") format("woff")' },
          "@font-face /* 7 */": { "font-family": "MJXTEX-S2", src: 'url("%%URL%%/MathJax_Size2-Regular.woff") format("woff")' },
          "@font-face /* 8 */": { "font-family": "MJXTEX-S3", src: 'url("%%URL%%/MathJax_Size3-Regular.woff") format("woff")' },
          "@font-face /* 9 */": { "font-family": "MJXTEX-S4", src: 'url("%%URL%%/MathJax_Size4-Regular.woff") format("woff")' },
          "@font-face /* 10 */": { "font-family": "MJXTEX-A", src: 'url("%%URL%%/MathJax_AMS-Regular.woff") format("woff")' },
          "@font-face /* 11 */": { "font-family": "MJXTEX-C", src: 'url("%%URL%%/MathJax_Calligraphic-Regular.woff") format("woff")' },
          "@font-face /* 12 */": { "font-family": "MJXTEX-CB", src: 'url("%%URL%%/MathJax_Calligraphic-Bold.woff") format("woff")' },
          "@font-face /* 13 */": { "font-family": "MJXTEX-FR", src: 'url("%%URL%%/MathJax_Fraktur-Regular.woff") format("woff")' },
          "@font-face /* 14 */": { "font-family": "MJXTEX-FRB", src: 'url("%%URL%%/MathJax_Fraktur-Bold.woff") format("woff")' },
          "@font-face /* 15 */": { "font-family": "MJXTEX-SS", src: 'url("%%URL%%/MathJax_SansSerif-Regular.woff") format("woff")' },
          "@font-face /* 16 */": { "font-family": "MJXTEX-SSB", src: 'url("%%URL%%/MathJax_SansSerif-Bold.woff") format("woff")' },
          "@font-face /* 17 */": { "font-family": "MJXTEX-SSI", src: 'url("%%URL%%/MathJax_SansSerif-Italic.woff") format("woff")' },
          "@font-face /* 18 */": { "font-family": "MJXTEX-SC", src: 'url("%%URL%%/MathJax_Script-Regular.woff") format("woff")' },
          "@font-face /* 19 */": { "font-family": "MJXTEX-T", src: 'url("%%URL%%/MathJax_Typewriter-Regular.woff") format("woff")' },
          "@font-face /* 20 */": { "font-family": "MJXTEX-V", src: 'url("%%URL%%/MathJax_Vector-Regular.woff") format("woff")' },
          "@font-face /* 21 */": { "font-family": "MJXTEX-VB", src: 'url("%%URL%%/MathJax_Vector-Bold.woff") format("woff")' },
        });
        return t;
    ...
    59316: (c, t, e) => {
      ...
      var i = e(92952);
      var f = e(51091);
      t.boldItalic = (0, i.AddCSS)(f.boldItalic, { 305: { f: "B" }, 567: { f: "B" }, 8260: { c: "/" }, 8710: { c: "\\394" }, 10744: { c: "/" } });
    },
    78451: (c, t, e) => {
      Object.defineProperty(t, "__esModule", { value: true });
      t.bold = void 0;
    ...
    11211: (c, t, e) => {
      ...
      var i = e(92952);
      var f = e(94872);
      t.sansSerifBold = (0, i.AddCSS)(f.sansSerifBold, { 8213: { c: "\\2014" }, 8215: { c: "_" }, 8260: { c: "/" }, 8710: { c: "\\394" } });
    },
    76316: (c, t, e) => {
      Object.defineProperty(t, "__esModule", { value: true });
    ...
    6987: (c, t, e) => {
      ...
      var k = { c: 9180, dir: i.H, sizes: [0.778, 1], schar: [8994, 8994], variants: [5, 0], stretch: [57680, 57684, 57681], HDW: [0.32, 0.2, 0.5] };
      var y = { c: 9181, dir: i.H, sizes: [0.778, 1], schar: [8995, 8995], variants: [5, 0], stretch: [57682, 57684, 57683], HDW: [0.32, 0.2, 0.5] };
      ...
      t.delimiters = {
        ...
        8212: o,
        8213: o,
        8214: { dir: i.V, sizes: [0.602, 1], schar: [0, 8741], variants: [1, 0], stretch: [0, 8741], HDW: [0.602, 0, 0.556] },
        8215: o,
        8254: r,
        8407: l,
        8592: n,
        ...
        8722: v,
        8725: f,
        8730: { dir: i.V, sizes: t.VSIZES, stretch: [57345, 57344, 9143], fullExt: [0.65, 2.3], HDW: [0.85, 0.35, 1.056] },
        8739: m,
        ...
        9168: { dir: i.V, sizes: [0.602, 1], schar: [0, 8739], variants: [1, 0], stretch: [0, 8739], HDW: [0.602, 0, 0.333] },
        9180: k,
        9181: y,
        9182: I,
        9183: A,
