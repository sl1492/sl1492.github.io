  ...
  [3538],
  {
    13538: (t, n, e) => {
      ...
      function w() {
        ...
        let S = 6;
        function M() {
          const t = { nodes: E.apply(null, arguments), links: A.apply(null, arguments) };
          T(t);
          I(t);
          C(t);
          O(t);
        ...
        M.nodes = function (t) {
          return arguments.length ? ((E = typeof t === "function" ? t : y(t)), M) : E;
        };
        M.links = function (t) {
      ...
      M.prototype = T.prototype = {
        ...
        arcTo: function (t, n, e, i, s) {
          ...
          if (this._x1 === null) {
            ...
            var f = e - r,
              ...
              g = Math.sqrt(d),
              _ = Math.sqrt(h),
              x = s * Math.tan((L - Math.acos((d + h - p) / (2 * g * _))) / 2),
              k = x / _,
              m = x / g;
            if (Math.abs(k - 1) > A) {
        ...
        arc: function (t, n, e, i, s, r) {
          ...
          if (h > S) {
            ...
            this._ +=
              "A" + e + "," + e + ",0," + +(h >= L) + "," + u + "," + (this._x1 = t + e * Math.cos(s)) + "," + (this._y1 = n + e * Math.sin(s));
          }
        },
            ...
            while (true) {
              ...
              switch (b[0]) {
                ...
                case 2:
                  ...
                  if (x) {
                    L._$.range = [o[o.length - (A || 1)].range[0], o[o.length - 1].range[1]];
                  }
                  w = this.performAction.apply(L, [c, u, a, p.yy, b[1], r, o].concat(y));
      ...
      const yt = function (t, n, e, r) {
        ...
        const u = o === "sandbox" ? (0, s.Ltv)(a.nodes()[0].contentDocument.body) : (0, s.Ltv)("body");
        const h = o === "sandbox" ? u.select(`[id="${n}"]`) : (0, s.Ltv)(`[id="${n}"]`);
