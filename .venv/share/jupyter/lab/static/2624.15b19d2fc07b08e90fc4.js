    ...
    12624: (t, i, e) => {
      ...
      class A extends b {
        constructor(t, i, e, s, n) {
          super(t, s, n, i);
          this.categories = e;
          this.scale = (0, a.WH)().domain(this.categories).range(this.getRange());
        }
        setRange(t) {
          super.setRange(t);
        }
        recalculateScale() {
          this.scale = (0, a.WH)().domain(this.categories).range(this.getRange()).paddingInner(1).paddingOuter(0).align(0.5);
      ...
      class w extends b {
        constructor(t, i, e, s, n) {
          super(t, s, n, i);
          this.domain = e;
          this.scale = (0, a.m4Y)().domain(this.domain).range(this.getRange());
        }
        getTickValues() {
        ...
        recalculateScale() {
          ...
          this.scale = (0, a.m4Y)().domain(t).range(this.getRange());
        }
        getScaleValue(t) {
          return this.scale(t);
        }
      ...
      let $ = O();
      let M = N();
      let z = $.plotColorPalette.split(",").map((t) => t.trim());
      let B = false;
      let W = false;
      function O() {
        const t = (0, s.D)();
      ...
      function q(t) {
        ...
        if (!B) {
          ...
          U(Math.min(i, 1), Math.max(e, t.length));
        }
        if (!W) {
          K(t);
        }
      ...
      const nt = function () {
        ...
        M = N();
        $ = O();
        z = $.plotColorPalette.split(",").map((t) => t.trim());
        B = false;
        W = false;
      };
      const at = {
