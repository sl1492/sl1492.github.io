...
(self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] = self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] || []).push([
  [6640],
  {
    /***/ 6640: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      ...
      /* harmony import */ var dompurify__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/ __webpack_require__.n(
        dompurify__WEBPACK_IMPORTED_MODULE_5__
      );
      ...
      const drawStartState = (g) =>
        g
          ...
          .attr("r", (0, _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_6__.c)().state.sizeUnit)
          .attr(
            "cx",
            (0, _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_6__.c)().state.padding +
              (0, _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_6__.c)().state.sizeUnit
          )
          .attr(
            "cy",
            (0, _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_6__.c)().state.padding +
      ...
      const drawDivider = (g) =>
        g
          ...
          .attr("x1", (0, _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_6__.c)().state.textHeight)
          .attr("class", "divider")
          .attr("x2", (0, _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_6__.c)().state.textHeight * 2)
          .attr("y1", 0)
          .attr("y2", 0);
      const drawSimpleState = (g, stateDef) => {
        const state = g
          .append("text")
          .attr("x", 2 * (0, _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_6__.c)().state.padding)
          .attr(
            "y",
            (0, _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_6__.c)().state.textHeight +
              2 * (0, _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_6__.c)().state.padding
          )
          .attr("font-size", (0, _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_6__.c)().state.fontSize)
          .attr("class", "state-title")
          .text(stateDef.id);
        const classBox = state.node().getBBox();
        g.insert("rect", ":first-child")
          .attr("x", (0, _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_6__.c)().state.padding)
          .attr("y", (0, _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_6__.c)().state.padding)
          .attr("width", classBox.width + 2 * (0, _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_6__.c)().state.padding)
          .attr("height", classBox.height + 2 * (0, _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_6__.c)().state.padding)
          .attr("rx", (0, _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_6__.c)().state.radius);
        return state;
      };
      const drawDescrState = (g, stateDef) => {
        ...
        const title = g
          ...
          .attr(
            "y",
            (0, _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_6__.c)().state.textHeight +
              1.3 * (0, _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_6__.c)().state.padding
          )
          .attr("font-size", (0, _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_6__.c)().state.fontSize)
          .attr("class", "state-title")
        ...
        const description = g
          ...
          .attr(
            "y",
            titleHeight +
              (0, _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_6__.c)().state.padding * 0.4 +
              (0, _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_6__.c)().state.dividerMargin +
              (0, _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_6__.c)().state.textHeight
          )
        ...
        const descrLine = g
          .append("line")
          .attr("x1", (0, _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_6__.c)().state.padding)
          .attr(
            "y1",
            (0, _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_6__.c)().state.padding +
              titleHeight +
              (0, _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_6__.c)().state.dividerMargin / 2
          )
          .attr(
            "y2",
            (0, _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_6__.c)().state.padding +
        ...
        g.insert("rect", ":first-child")
          .attr("x", (0, _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_6__.c)().state.padding)
          .attr("y", (0, _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_6__.c)().state.padding)
          .attr("width", width + 2 * (0, _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_6__.c)().state.padding)
          .attr("height", descrBox.height + titleHeight + 2 * (0, _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_6__.c)().state.padding)
          .attr("rx", (0, _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_6__.c)().state.radius);
        return g;
      };
      const addTitleAndBox = (g, stateDef, altBkg) => {
        ...
        const title = g
          .append("text")
          .attr("x", 0)
          .attr("y", (0, _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_6__.c)().state.titleShift)
          .attr("font-size", (0, _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_6__.c)().state.fontSize)
          .attr("class", "state-title")
          .text(stateDef.id);
        const titleBox = title.node().getBBox();
        ...
        g.insert("rect", ":first-child")
          ...
          .attr(
            ...
            graphBox.height +
              (0, _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_6__.c)().state.textHeight +
              (0, _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_6__.c)().state.titleShift +
              1
          )
          .attr("rx", "0");
        ...
        g.insert("rect", ":first-child")
          ...
          .attr("width", width)
          .attr("height", (0, _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_6__.c)().state.textHeight * 3)
          .attr("rx", (0, _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_6__.c)().state.radius);
        g.insert("rect", ":first-child")
          .attr("x", startX)
          .attr(
          ...
          .attr("width", width)
          .attr("height", graphBox.height + 3 + 2 * (0, _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_6__.c)().state.textHeight)
          .attr("rx", (0, _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_6__.c)().state.radius);
        return g;
      };
      const drawEndState = (g) => {
        g.append("circle")
          ...
          .attr(
            "r",
            (0, _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_6__.c)().state.sizeUnit +
              (0, _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_6__.c)().state.miniPadding
          )
          .attr(
            "cx",
            (0, _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_6__.c)().state.padding +
      ...
      const drawEdge = function (elem, path, relation) {
        ...
        const lineFunction = (0, d3__WEBPACK_IMPORTED_MODULE_0__ /* .line */.jvg)()
          .x(function (d) {
            return d.x;
          })
          .y(function (d) {
        ...
        if (relation.title !== void 0) {
          ...
          label
            ...
            .attr("class", "box")
            .attr("x", x - maxWidth / 2 - (0, _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_6__.c)().state.padding / 2)
            .attr("y", y - boxHeight / 2 - (0, _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_6__.c)().state.padding / 2 - 3.5)
            .attr("width", maxWidth + (0, _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_6__.c)().state.padding)
            .attr("height", boxHeight + (0, _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_6__.c)().state.padding);
