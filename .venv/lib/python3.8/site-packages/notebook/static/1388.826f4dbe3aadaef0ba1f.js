...
(self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] = self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] || []).push([
  [1388],
  {
    /***/ 91388: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      ...
      const drawNote = function (elem, note, conf, diagObj) {
        ...
        const rect = g
          ...
          .attr("height", noteBox.height + lines.length * conf.textHeight + conf.padding + 0.5 * conf.dividerMargin);
        const rectWidth = rect.node().getBBox().width;
        ...
        g.nodes().forEach(function (v) {
          if (v !== void 0 && g.node(v) !== void 0) {
            ...
            root
              ...
              .attr("transform", "translate(" + (g.node(v).x - g.node(v).width / 2) + "," + (g.node(v).y - g.node(v).height / 2) + " )");
          }
        });
