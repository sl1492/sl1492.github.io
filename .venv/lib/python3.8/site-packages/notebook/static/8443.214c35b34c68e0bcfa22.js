...
(self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] = self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] || []).push([
  [8443],
  {
    /***/ 98443: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      ...
      const createLabel = (_vertexText, style, isTitle, isNode) => {
        ...
        if (
          (0, _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_1__.m)((0, _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_1__.c)().flowchart.htmlLabels)
        ) {
      ...
      const labelHelper = async (parent, node, _classes, isNode) => {
        ...
        if (node.labelType === "markdown") {
          text = (0, _createText_a48a4c90_js__WEBPACK_IMPORTED_MODULE_2__.a)(
            label,
            (0, _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_1__.d)(
              (0, _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_1__.J)(labelText),
                ...
                (img) =>
                  new Promise((res) => {
                    function setupImage() {
                      ...
                      if (noImgText) {
                        const bodyFontSize = (0, _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_1__.c)().fontSize
                          ? (0, _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_1__.c)().fontSize
      ...
      function intersectPolygon(node, polyPoints, point2) {
        ...
        for (var i = 0; i < polyPoints.length; i++) {
          ...
          var intersect2 = intersectLine(node, point2, { x: left + p1.x, y: top + p1.y }, { x: left + p2.x, y: top + p2.y });
          if (intersect2) {
      ...
      const class_box = (parent, node) => {
        ...
        node.classData.members.forEach((member) => {
          ...
          const lbl = labelContainer
            .node()
            .appendChild(createLabel$1(parsedText, parsedInfo.cssStyle ? parsedInfo.cssStyle : node.labelStyle, true, true));
        ...
        node.classData.methods.forEach((member) => {
          ...
          const lbl = labelContainer
            .node()
            .appendChild(createLabel$1(displayText, parsedInfo.cssStyle ? parsedInfo.cssStyle : node.labelStyle, true, true));
          let bbox = lbl.getBBox();
          if (
            (0, _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_1__.m)((0, _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_1__.c)().flowchart.htmlLabels)
          ) {
      ...
      const insertEdgeLabel = (elem, edge) => {
        const useHtmlLabels = (0, _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_1__.m)(
          (0, _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_1__.c)().flowchart.htmlLabels
        );
        const labelElement =
          edge.labelType === "markdown"
            ? (0, _createText_a48a4c90_js__WEBPACK_IMPORTED_MODULE_2__.a)(elem, edge.label, {
  ...
  node        : x:${node.x} y:${node.y} w:${node.width} h:${node.height}`);
      ...
      const insertEdge = function (elem, e, edge, clusterDb, diagramType, graph, id) {
        ...
        let url = "";
        if (
          (0, _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_1__.c)().flowchart.arrowMarkerAbsolute ||
          (0, _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_1__.c)().state.arrowMarkerAbsolute
        ) {
