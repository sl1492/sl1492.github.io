...
(self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] = self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] || []).push([
  [7097],
  {
    /***/ 87097: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      ...
      const drawRelationshipFromLayout = function (svg, rel, g, insert, diagObj) {
        ...
        if (rel.type == diagObj.db.Relationships.CONTAINS) {
          ...
          svgPath.attr(
            "marker-end",
            "url(" +
              _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_6__.e.getUrl(conf.arrowMarkerAbsolute) +
              "#" +
      ...
      const drawReqs = (reqs, graph, svgNode) => {
        Object.keys(reqs).forEach((reqName) => {
          ...
          newBodyNode(
            groupNode,
            reqName + "_body",
            [`Id: ${req.id}`, `Text: ${req.text}`, `Risk: ${req.risk}`, `Verification: ${req.verifyMethod}`],
            titleNodeInfo.y
          );
