...
(self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] = self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] || []).push([
  [6281],
  {
    /***/ 81779: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      // EXPORTS
      ...
      var _baseClone = __webpack_require__(47853); // CONCATENATED MODULE: ../node_modules/lodash-es/clone.js
      ...
      var graph = __webpack_require__(7303); // CONCATENATED MODULE: ../node_modules/dagre-d3-es/src/graphlib/json.js
      function write(g) {
        var json = {
          options: {
    ...
    /***/ 86281: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      ...
      const isDescendant = (id, ancenstorId) => {
        _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_4__.l.trace(
          "In isDecendant",
          ancenstorId,
          " ",
          id,
          " = ",
          descendants[ancenstorId].includes(id)
        );
      ...
      const adjustClustersAndEdges = (graph, depth) => {
        ...
        _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_4__.l.warn(
          "Adjusted Graph",
          dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__ /* .write */
            .c(graph)
        );
        extractor(graph, 0);
      ...
      const rect = (parent, node) => {
        ...
        const useHtmlLabels = (0, _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_4__.m)(
          (0, _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_4__.c)().flowchart.htmlLabels
        );
        const label = shapeSvg.insert("g").attr("class", "cluster-label");
        const text =
          node.labelType === "markdown"
            ? (0, _createText_a48a4c90_js__WEBPACK_IMPORTED_MODULE_5__.a)(label, node.labelText, { style: node.labelStyle, useHtmlLabels })
            : label.node().appendChild((0, _edges_5ec2587c_js__WEBPACK_IMPORTED_MODULE_6__.c)(node.labelText, node.labelStyle, void 0, true));
        let bbox = text.getBBox();
        if (
          (0, _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_4__.m)((0, _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_4__.c)().flowchart.htmlLabels)
        ) {
        ...
        label.attr(
          ...
          "translate(" +
            ...
            (node.y -
              node.height / 2 -
              node.padding / 3 +
              ((0, _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_4__.m)(
                (0, _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_4__.c)().flowchart.htmlLabels
              )
                ? 5
                : 3)) +
