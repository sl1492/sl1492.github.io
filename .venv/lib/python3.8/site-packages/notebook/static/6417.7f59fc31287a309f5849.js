...
(self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] = self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] || []).push([
  [6417],
  {
    /***/ 74193: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      ...
      function addHtmlLabel(root, node) {
        ...
        _util_js__WEBPACK_IMPORTED_MODULE_0__ /* .applyStyle */
          .bg(div, node.labelStyle);
    ...
    /***/ 51723: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      /* harmony export */ __webpack_require__.d(__webpack_exports__, {
      ...
      function applyTransition(selection, g) {
        ...
        if (
          lodash_es__WEBPACK_IMPORTED_MODULE_0__ /* ["default"] */
            .Z(graph)
        ) {
    ...
    /***/ 66417: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      // EXPORTS
      ...
      var util = __webpack_require__(51723); // CONCATENATED MODULE: ../node_modules/dagre-d3-es/src/dagre-js/arrows.js
      var arrows = {
        normal,
        vee,
        undirected,
      ...
      var add_html_label = __webpack_require__(74193); // CONCATENATED MODULE: ../node_modules/dagre-d3-es/src/dagre-js/label/add-svg-label.js
      ...
      var createClusters = function (selection, g) {
        ...
        svgClusters = util /* applyTransition */
          .WR(svgClusters, g)
          .style("opacity", 1);

        svgClusters.selectAll("rect").each(function (c) {
          var node = g.node(c);
          var domCluster = src /* select */
            .Ys(this);
          util /* applyStyle */
            .bg(domCluster, node.style);
        });
      ...
      var range = __webpack_require__(36735); // CONCATENATED MODULE: ../node_modules/dagre-d3-es/src/dagre-js/intersect/intersect-node.js
      ...
      var createEdgePaths = function (selection, g, arrows) {
        ...
        svgPaths.each(function (e) {
          ...
          util /* applyClass */
            .$p(domEdge, edge["class"], (domEdge.classed("update") ? "update " : "") + "edgePath");
        });

        svgPaths.selectAll("path.path").each(function (e) {
          var edge = g.edge(e);
          edge.arrowheadId = uniqueId /* default */
            .Z("arrowhead");
      ...
      function enter(svgPaths, g) {
        ...
        svgPathsEnter
          ...
          .attr("d", function (e) {
            ...
            var points = range /* default */
              .Z(edge.points.length)
              .map(function () {
      ...
      var pick = __webpack_require__(87768); // CONCATENATED MODULE: ../node_modules/dagre-d3-es/src/dagre-js/create-nodes.js
      var createNodes = function (selection, g, shapes) {
        ...
        svgNodes.each(function (v) {
          ...
          var thisGroup = src /* select */
            .Ys(this);
          util /* applyClass */
            .$p(thisGroup, node["class"], (thisGroup.classed("update") ? "update " : "") + "node");

          thisGroup.select("g.label").remove();
          var labelGroup = thisGroup.append("g").attr("class", "label");
          var labelDom = addLabel(labelGroup, node);
          var shape = shapes[node.shape];
          var bbox = pick /* default */
            .Z(labelDom.node().getBBox(), "width", "height");
      ...
      function preProcessGraph(g) {
        g.nodes().forEach(function (v) {
          ...
          defaults /* default */
            .Z(node, NODE_DEFAULT_ATTRS);

          forEach /* default */
            .Z(["paddingLeft", "paddingRight", "paddingTop", "paddingBottom"], function (k) {
      ...
      var json = __webpack_require__(81779); // CONCATENATED MODULE: ../node_modules/mermaid/dist/flowDiagram-18ba08e1.js
          ...
          if (edge.text === void 0) {
            ...
            if ((0, mermaid_04fb0060.m)((0, mermaid_04fb0060.c)().flowchart.htmlLabels)) {
              ...
              edgeData.label = `<span id="L-${linkId}" class="edgeLabel L-${linkNameStart}' L-${linkNameEnd}" style="${
                edgeData.labelStyle
              }">${edge.text.replace(/fa[blrs]?:fa-[\w-]+/g, (s) => `<i class='${s.replace(":", " ")}'></i>`)}</span>`;
            } else {
      ...
      const draw = function (text, id, _version, diagObj) {
        ...
        for (i = subGraphs.length - 1; i >= 0; i--) {
          ...
          for (let j = 0; j < subG.nodes.length; j++) {
            mermaid_04fb0060.l.warn("Setting subgraph", subG.nodes[j], diagObj.db.lookUpDomId(subG.nodes[j]), diagObj.db.lookUpDomId(subG.id));
    ...
    /***/ 3675: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      // EXPORTS
      __webpack_require__.d(__webpack_exports__, {
      ...
      var dist_color = __webpack_require__(42528); // CONCATENATED MODULE: ../node_modules/khroma/dist/methods/channel.js
      /* IMPORT */

      /* MAIN */
      const channel = (color, channel) => {
        return utils /* default */.Z.lang
          .round(dist_color /* default */.Z.parse(color)[channel]);
      };
      /* EXPORT */
      /* harmony default export */ const methods_channel = channel;

      // EXTERNAL MODULE: ../node_modules/khroma/dist/methods/rgba.js
      var rgba = __webpack_require__(14728); // CONCATENATED MODULE: ../node_modules/mermaid/dist/styles-b39df0e1.js
      const conf = {};
      const setConf = function (cnf) {
        const keys = Object.keys(cnf);
        for (const key of keys) {
      ...
      const draw = async function (text, id, _version, diagObj) {
        ...
        for (let i2 = subGraphs.length - 1; i2 >= 0; i2--) {
          ...
          diagObj.db.addVertex(subG.id, { text: subG.title, type: subG.labelType }, "group", void 0, subG.classes, subG.dir);
        }
        const vert = diagObj.db.getVertices();
        const edges = diagObj.db.getEdges();
