...
(self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] = self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] || []).push([
  [5777, 5765],
  {
    /***/ 25777: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      // ESM COMPAT FLAG
      ...
      function h(e) {
        ...
        return function (e) {
          ...
          return (
              ...
              const t = f.current,
                ...
                n = (o) => {
                  o.target === f.current &&
                    ...
                    0 === T.current && "animationcancel" !== o.type && t.classList.remove(...e));
                };
            ...
            index_js_default().createElement(index_js_default().Fragment, null, u)
          );
        };
      }
      function y(t, e) {
      ...
      const v = {
        ...
        E = {
          ...
          spinner: function () {
            return index_js_default().createElement("div", { className: "Toastify__spinner" });
          },
        };
      function C(t) {
        ...
        function L(t, n) {
          ...
          if (
            ...
            (function (t) {
              return (
                !g.current || (C.props.enableMultiContainer && t.containerId !== C.props.containerId) || (h.has(t.toastId) && null == t.updateId)
              );
            })(i)
          )
            return;
          ...
          (M.iconOut = (function (t) {
            ...
            !1 === i.closeButton || f(i.closeButton)
              ...
              : !0 === i.closeButton && (M.closeButton = !f(b.closeButton) || b.closeButton);
          let x = t;
          (0, index_js_.isValidElement)(t) && !d(t.type)
            ? (x = (0, index_js_.cloneElement)(t, { closeToast: L, toastProps: M, data: T }))
      ...
      function _(t) {
        const [o, a] = (0, index_js_.useState)(!1),
          ...
          { autoClose: m, pauseOnHover: f, closeToast: g, onClick: h, closeOnClick: y } = t;
        function v(e) {
          if (t.draggable) {
            ...
            (u.canCloseOnClick = !0),
              ...
              "x" === t.draggableDirection
                ? ((u.start = u.x), (u.removalDistance = n.offsetWidth * (t.draggablePercent / 100)))
                : ((u.start = u.y),
        ...
        (0, index_js_.useEffect)(() => {
          ...
          (0, index_js_.useEffect)(
            () => (
              ...
              p(t.onOpen) && t.onOpen((0, index_js_.isValidElement)(t.children) && t.children.props),
              () => {
                const t = d.current;
                p(t.onClose) && t.onClose((0, index_js_.isValidElement)(t.children) && t.children.props);
              }
            ),
            []
          ),
          (0, index_js_.useEffect)(
            () => (
              t.pauseOnFocusLoss && (document.hasFocus() || C(), window.addEventListener("focus", E), window.addEventListener("blur", C)),
              () => {
        ...
        const O = { onMouseDown: v, onTouchStart: v, onMouseUp: T, onTouchEnd: T };
        return (
          ...
          { playToast: E, pauseToast: C, isRunning: o, preventExitTransition: r, toastRef: c, eventHandlers: O }
        );
      }
      function L(e) {
      ...
      function O(e) {
        ...
        const h = r || (u && 0 === d),
          y = { ...l, animationDuration: `${n}ms`, animationPlayState: o ? "running" : "paused", opacity: h ? 0 : 1 };
      ...
      const N = (n) => {
          const { isRunning: o, preventExitTransition: s, toastRef: r, eventHandlers: i } = _(n),
            {
              closeButton: l,
              children: u,
              autoClose: d,
            ...
            H = p(T) ? T({ rtl: x, position: v, type: f, defaultClassName: F }) : clsx_m(F, T),
            S = !!w || !d,
            q = { closeToast: h, type: f, theme: z };
          let Q = null;
          return (
            !1 === l || (Q = p(l) ? l(q) : (0, index_js_.isValidElement)(l) ? (0, index_js_.cloneElement)(l, q) : L(q)),
            index_js_default().createElement(
              y,
              { isIn: P, done: k, position: v, preventExitTransition: s, nodeRef: r },
              index_js_default().createElement(
                "div",
                { id: $, onClick: m, className: H, ...i, style: E, ref: r },
                index_js_default().createElement(
                  "div",
                  { ...(P && { role: R }), className: p(C) ? C({ type: f }) : clsx_m("Toastify__toast-body", C), style: b },
                  null != D &&
                    index_js_default().createElement(
                      "div",
                      { className: clsx_m("Toastify__toast-icon", { "Toastify--animate-icon Toastify__zoom-enter": !B }) },
                      D
                    ),
        ...
        M = function (t, e) {
          return (
            void 0 === e && (e = !1),
            { enter: `Toastify--animate Toastify__${t}-enter`, exit: `Toastify--animate Toastify__${t}-exit`, appendPosition: e }
          );
        },
        R = h(M("bounce", !0)),
        w = h(M("slide", !0)),
        ...
        k = (0, index_js_.forwardRef)((e, n) => {
          const { getToastToRender: o, containerRef: a, isToastActive: r } = C(e),
            { className: i, style: l, rtl: u, containerId: d } = e;
          function f(t) {
            const e = clsx_m("Toastify__toast-container", `Toastify__toast-container--${t}`, { "Toastify__toast-container--rtl": u });
            return p(i) ? i({ position: t, rtl: u, defaultClassName: e }) : clsx_m(e, m(i));
          }
          return (
            (0, index_js_.useEffect)(() => {
              ...
              o((e, n) => {
                ...
                return index_js_default().createElement(
                  ...
                  n.map((e, o) => {
                    ...
                    return index_js_default().createElement(
                      N,
                      { ...a, isIn: r(a.toastId), style: { ...a.style, "--nth": o + 1, "--len": n.length }, key: `toast-${a.key}` },
                      s
                    );
                  })
                );
      ...
      (Q.loading = (t, e) => H(t, S("default", { isLoading: !0, autoClose: !1, closeOnClick: !1, closeButton: !1, draggable: !1, ...e }))),
          ...
          const i = { isLoading: null, autoClose: null, closeOnClick: null, closeButton: null, draggable: null },
            l = (t, e, s) => {
              ...
              const a = { type: t, ...i, ...n, data: s },
                r = d(e) ? { render: e } : e;
              return o ? Q.update(o, { ...a, ...r }) : Q(r.render, { ...a, ...r }), s;
            },
            c = p(t) ? t() : t;
            ...
            setTimeout(() => {
              ...
              if (n) {
                const { props: o, content: s } = n,
                  a = { delay: 100, ...o, ...e, toastId: e.toastId || t, updateId: z() };
