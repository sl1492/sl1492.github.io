...
(self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] = self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] || []).push([
  [4105],
  {
    /***/ 74105: /***/ function (__unused_webpack_module, exports, __webpack_require__) {
      var __extends =
        (this && this.__extends) ||
        (function () {
        ...
        return (
          ...
          (_a.OPTIONS = __assign(__assign({}, BaseDocument.OPTIONS), {
            ...
            renderActions: (0, Options_js_1.expandable)(
              __assign(__assign({}, BaseDocument.OPTIONS.renderActions), { assistiveMml: [MathItem_js_1.STATE.ASSISTIVEMML] })
            ),
          })),
          (_a.assistiveStyles = {
            "mjx-assistive-mml": {
    ...
    /***/ 35659: /***/ function (__unused_webpack_module, exports, __webpack_require__) {
      var __extends =
        (this && this.__extends) ||
        (function () {
          var extendStatics = function (d, b) {
    ...
    /***/ 24616: /***/ function (__unused_webpack_module, exports, __webpack_require__) {
      var __extends =
        (this && this.__extends) ||
        (function () {
          var extendStatics = function (d, b) {
    ...
    /***/ 93281: /***/ function (__unused_webpack_module, exports, __webpack_require__) {
      var __values =
        (this && this.__values) ||
        function (o) {
          var s = typeof Symbol === "function" && Symbol.iterator,
      ...
      var AbstractVisitor = (function () {
        ...
        AbstractVisitor.methodName = function (kind) {
          return "visit" + (kind.charAt(0).toUpperCase() + kind.substr(1)).replace(/[^a-z0-9_]/gi, "_") + "Node";
        };
