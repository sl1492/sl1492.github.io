...
(self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] = self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] || []).push([
  [7969, 4498],
  {
    ...
    /***/ 83045: /***/ function (__unused_webpack_module, exports, __webpack_require__) {
      var __extends =
        (this && this.__extends) ||
        (function () {
      ...
      var AbstractMmlNode = (function (_super) {
        ...
        AbstractMmlNode.prototype.setInheritedAttributes = function (attributes, display, level, prime) {
          ...
          if (
            arity >= 0 &&
            arity !== Infinity &&
            ((arity === 1 && this.childNodes.length === 0) || (arity !== 1 && this.childNodes.length !== arity))
          ) {
    ...
    /***/ 19625: /***/ function (__unused_webpack_module, exports, __webpack_require__) {
      var __extends =
        (this && this.__extends) ||
        (function () {
          var extendStatics = function (d, b) {
        ...
        MmlMo.prototype.adjustTeXclass = function (prev) {
          ...
          if (
            ...
            while (
              ...
              (parent_1.childNodes.length === 1 || (!parent_1.isKind("mrow") && parent_1.core() === child))
            ) {
              child = parent_1;
    ...
    /***/ 99772: /***/ function (__unused_webpack_module, exports, __webpack_require__) {
      var __values =
        (this && this.__values) ||
        function (o) {
          var s = typeof Symbol === "function" && Symbol.iterator,
          ...
          if (isObject(sval) && dval !== null && (typeof dval === "object" || typeof dval === "function")) {
            ...
            if (
              ...
              ((ids.length === 1 && (ids[0] === exports.APPEND || ids[0] === exports.REMOVE) && Array.isArray(sval[ids[0]])) ||
                (ids.length === 2 &&
                  ids.sort().join(",") === exports.APPEND + "," + exports.REMOVE &&
