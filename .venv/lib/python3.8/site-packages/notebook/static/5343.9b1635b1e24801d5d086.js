...
(self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] = self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] || []).push([
  [5343],
  {
    /***/ 75343: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      ...
      var parser = (function () {
        ...
        var parser2 = {
          ...
          table: [
            ...
            { 3: 5, 4: $V0, 5: $V1, 6: $V2 },
            { 3: 6, 4: $V0, 5: $V1, 6: $V2 },
            o([1, 4, 5, 15, 16, 18, 21, 23, 24, 25, 26, 27, 28, 32, 34, 36, 37, 41, 44, 45, 46, 47, 50], $V3, { 7: 7 }),
            { 1: [2, 1] },
            { 1: [2, 2] },
            {
              1: [2, 3],
      ...
      function addRelationObjs(item1, item2, relationTitle) {
        ...
        currentDocument.relations.push({
          id1,
          id2,
          relationTitle: _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_0__.e.sanitizeText(
            relationTitle,
            (0, _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_0__.c)()
          ),
        });
      ...
      const addRelation = function (item1, item2, title) {
        if (typeof item1 === "object") {
          ...
          currentDocument.relations.push({
            id1,
            id2,
            title: _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_0__.e.sanitizeText(
              title,
              (0, _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_0__.c)()
            ),
          });
      ...
      const addDescription = function (id, descr) {
        ...
        theState.descriptions.push(
          _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_0__.e.sanitizeText(_descr, (0, _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_0__.c)())
        );
      };
