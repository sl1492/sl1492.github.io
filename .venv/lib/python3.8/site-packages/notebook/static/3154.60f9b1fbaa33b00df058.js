...
(self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] = self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] || []).push([
  [3154],
  {
    /***/ 43154: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
        ...
        if (itemId !== "root") {
          ...
          if (!nodeDb[itemId]) {
            nodeDb[itemId] = {
              id: itemId,
              shape,
              description: _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_8__.e.sanitizeText(
                itemId,
                (0, _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_8__.c)()
              ),
          ...
          if (parsedItem.description) {
            ...
            newNode.description = _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_8__.e.sanitizeTextOrArray(
              newNode.description,
              (0, _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_8__.c)()
            );
          }
            ...
            case _styles_401768ef_js__WEBPACK_IMPORTED_MODULE_7__.S:
              {
                ...
                const edgeData = {
                  ...
                  style: G_EDGE_STYLE,
                  labelStyle: "",
                  label: _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_8__.e.sanitizeText(
                    item.description,
                    (0, _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_8__.c)()
                  ),
                  arrowheadStyle: G_EDGE_ARROWHEADSTYLE,
