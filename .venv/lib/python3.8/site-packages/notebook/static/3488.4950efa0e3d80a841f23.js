(self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] = self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] || []).push([
  [3488],
  {
    ...
    /***/ 63488: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      "use strict";
      ...
      /* harmony import */ var dayjs_plugin_isoWeek_js__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/ __webpack_require__.n(
        dayjs_plugin_isoWeek_js__WEBPACK_IMPORTED_MODULE_2__
      );
      /* harmony import */ var dayjs_plugin_customParseFormat_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(69746);
      /* harmony import */ var dayjs_plugin_customParseFormat_js__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/ __webpack_require__.n(
        dayjs_plugin_customParseFormat_js__WEBPACK_IMPORTED_MODULE_3__
      );
      /* harmony import */ var dayjs_plugin_advancedFormat_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(79580);
      /* harmony import */ var dayjs_plugin_advancedFormat_js__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/ __webpack_require__.n(
        dayjs_plugin_advancedFormat_js__WEBPACK_IMPORTED_MODULE_4__
      );
      ...
      /* harmony import */ var dompurify__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/ __webpack_require__.n(
        dompurify__WEBPACK_IMPORTED_MODULE_6__
      );
      ...
      const draw = function (text, id, version, diagObj) {
        ...
        const root =
          securityLevel === "sandbox"
            ? (0, d3__WEBPACK_IMPORTED_MODULE_5__ /* .select */.Ys)(sandboxElement.nodes()[0].contentDocument.body)
            : (0, d3__WEBPACK_IMPORTED_MODULE_5__ /* .select */.Ys)("body");
        ...
        const timeScale = (0, d3__WEBPACK_IMPORTED_MODULE_5__ /* .scaleTime */.Xf)()
          .domain([
        ...
        function makeGant(tasks2, pageWidth, pageHeight) {
          ...
          const colorScale = (0, d3__WEBPACK_IMPORTED_MODULE_5__ /* .scaleLinear */.BYU)()
            .domain([0, categories.length])
            .range(["#00B9FA", "#F95002"])
            .interpolate(d3__WEBPACK_IMPORTED_MODULE_5__ /* .interpolateHcl */.JHv);
        ...
        function makeGrid(theSidePad, theTopPad, w2, h2) {
          let bottomXAxis = (0, d3__WEBPACK_IMPORTED_MODULE_5__ /* .axisBottom */.LLu)(timeScale)
            .tickSize(-h2 + theTopPad + conf.gridLineStartPadding)
            .tickFormat((0, d3__WEBPACK_IMPORTED_MODULE_5__ /* .timeFormat */.i$Z)(diagObj.db.getAxisFormat() || conf.axisFormat || "%Y-%m-%d"));
          ...
          if (resultTickInterval !== null) {
            ...
            switch (interval) {
              ...
              case "day":
                bottomXAxis.ticks(
                  d3__WEBPACK_IMPORTED_MODULE_5__ /* .timeDay */.rr1
                    .every(every)
                );
                break;
              case "week":
          ...
          if (diagObj.db.topAxisEnabled() || conf.topAxis) {
            let topXAxis = (0, d3__WEBPACK_IMPORTED_MODULE_5__ /* .axisTop */.F5q)(timeScale)
              .tickSize(-h2 + theTopPad + conf.gridLineStartPadding)
              .tickFormat((0, d3__WEBPACK_IMPORTED_MODULE_5__ /* .timeFormat */.i$Z)(diagObj.db.getAxisFormat() || conf.axisFormat || "%Y-%m-%d"));
            if (resultTickInterval !== null) {
              const every = resultTickInterval[1];
