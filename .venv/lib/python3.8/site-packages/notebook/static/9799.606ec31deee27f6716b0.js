          ...
          update(update) {
            ...
            if (this.composing != 0 /* CompositionState.None */)
              for (let tr of update.transactions) {
                if (getUserEvent(tr, conf) == "input") this.composing = 2 /* CompositionState.Changed */;
            ...
            for (let i = 0; i < this.running.length; i++) {
              ...
              if (query.done) {
                let active = new ActiveResult(
                  ...
                  query.done,
                  query.done.from,
                  (_a = query.done.to) !== null && _a !== void 0 ? _a : cur(query.updates.length ? query.updates[0].startState : this.view.state)
                );
