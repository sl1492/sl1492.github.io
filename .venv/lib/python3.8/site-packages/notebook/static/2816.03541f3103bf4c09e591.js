...
(self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] = self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] || []).push([
  [2816],
  {
    /***/ 92816: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      // ESM COMPAT FLAG
      ...
      var react_index_js_default = /*#__PURE__*/ __webpack_require__.n(react_index_js_); // CONCATENATED MODULE: ../node_modules/@jupyter/react-components/lib/react-utils.js
      function useProperties(targetElement, propName, value) {
        (0, react_index_js_.useEffect)(() => {
          if (value !== undefined && targetElement.current && targetElement.current[propName] !== value) {
      ...
      const AnchoredRegion = (0, react_index_js_.forwardRef)((props, forwardedRef) => {
        ...
        return react_index_js_default().createElement(
          "jp-anchored-region",
          {
            ...
            "horizontal-positioning-mode": props.horizontalPositioningMode || props["horizontal-positioning-mode"],
            "horizontal-default-position": props.horizontalDefaultPosition || props["horizontal-default-position"],
            "horizontal-threshold": props.horizontalThreshold || props["horizontal-threshold"],
            "horizontal-scaling": props.horizontalScaling || props["horizontal-scaling"],
            "vertical-positioning-mode": props.verticalPositioningMode || props["vertical-positioning-mode"],
            "vertical-default-position": props.verticalDefaultPosition || props["vertical-default-position"],
            "vertical-threshold": props.verticalThreshold || props["vertical-threshold"],
      ...
      const Anchor = (0, react_index_js_.forwardRef)((props, forwardedRef) => {
        const ref = (0, react_index_js_.useRef)(null);
        const { className, appearance, download, href, hreflang, ping, referrerpolicy, rel, target, type, control, ...filteredProps } = props;
      ...
      const Avatar = (0, react_index_js_.forwardRef)((props, forwardedRef) => {
        const ref = (0, react_index_js_.useRef)(null);
        const { className, src, alt, fill, color, link, shape, ...filteredProps } = props;
      ...
      const BreadcrumbItem = (0, react_index_js_.forwardRef)((props, forwardedRef) => {
        const ref = (0, react_index_js_.useRef)(null);
        const { className, download, href, hreflang, ping, referrerpolicy, rel, target, type, control, ...filteredProps } = props;
      ...
      const Checkbox = (0, react_index_js_.forwardRef)((props, forwardedRef) => {
        const ref = (0, react_index_js_.useRef)(null);
        const { className, readonly, readOnly, indeterminate, checked, disabled, required, ...filteredProps } = props;
      ...
      const DateField = (0, react_index_js_.forwardRef)((props, forwardedRef) => {
        const ref = (0, react_index_js_.useRef)(null);
        const { className, autofocus, step, max, min, disabled, required, ...filteredProps } = props;
      ...
      const DataGridCell = (0, react_index_js_.forwardRef)((props, forwardedRef) => {
        const ref = (0, react_index_js_.useRef)(null);
        const { className, cellType, gridColumn, rowData, columnDefinition, ...filteredProps } = props;
      ...
      const DataGridRow = (0, react_index_js_.forwardRef)((props, forwardedRef) => {
        ...
        return react_index_js_default().createElement(
          "jp-data-grid-row",
          {
            ref,
            ...filteredProps,
            "grid-template-columns": props.gridTemplateColumns || props["grid-template-columns"],
      ...
      const Dialog = (0, react_index_js_.forwardRef)((props, forwardedRef) => {
        const ref = (0, react_index_js_.useRef)(null);
        const { className, trapFocus, ariaDescribedby, ariaLabelledby, ariaLabel, modal, hidden, ...filteredProps } = props;
        ...
        (0, react_index_js_.useImperativeHandle)(forwardedRef, () => ({
          ...
          compose: (this_, elementDefinition) => ref.current.compose(this_, elementDefinition),
        }));
      ...
      const Listbox = (0, react_index_js_.forwardRef)((props, forwardedRef) => {
        const ref = (0, react_index_js_.useRef)(null);
        const { className, multiple, size, length, options, disabled, selectedIndex, selectedOptions, ...filteredProps } = props;
      ...
      const MenuItem = (0, react_index_js_.forwardRef)((props, forwardedRef) => {
        const ref = (0, react_index_js_.useRef)(null);
        const { className, role, disabled, expanded, checked, ...filteredProps } = props;
      ...
      const Option = (0, react_index_js_.forwardRef)((props, forwardedRef) => {
        const ref = (0, react_index_js_.useRef)(null);
        const { className, selected, value, checked, content, defaultSelected, disabled, selectedAttribute, dirtyValue, ...filteredProps } = props;
      ...
      const Radio = (0, react_index_js_.forwardRef)((props, forwardedRef) => {
        const ref = (0, react_index_js_.useRef)(null);
        const { className, readonly, readOnly, name, checked, disabled, required, ...filteredProps } = props;
      ...
      const RadioGroup = (0, react_index_js_.forwardRef)((props, forwardedRef) => {
        const ref = (0, react_index_js_.useRef)(null);
        const { className, readonly, disabled, name, value, orientation, readOnly, ...filteredProps } = props;
      ...
      const Switch = (0, react_index_js_.forwardRef)((props, forwardedRef) => {
        const ref = (0, react_index_js_.useRef)(null);
        const { className, readonly, readOnly, checked, disabled, required, ...filteredProps } = props;
      ...
      const Tabs = (0, react_index_js_.forwardRef)((props, forwardedRef) => {
        const ref = (0, react_index_js_.useRef)(null);
        const { className, orientation, activeid, activeindicator, activetab, ...filteredProps } = props;
      ...
      const TreeView = (0, react_index_js_.forwardRef)((props, forwardedRef) => {
        const ref = (0, react_index_js_.useRef)(null);
        const { className, renderCollapsedNodes, currentSelected, ...filteredProps } = props;
      ...
      const Picker = (0, react_index_js_.forwardRef)((props, forwardedRef) => {
        ...
        useProperties(ref, "defaultMenuOptionTemplate", props.defaultMenuOptionTemplate);
        useProperties(ref, "listItemContentsTemplate", props.listItemContentsTemplate);
        useProperties(ref, "menuOptionContentsTemplate", props.menuOptionContentsTemplate);
        ...
        return react_index_js_default().createElement(
          "jp-draft-picker",
          {
            ...
            "no-suggestions-text": props.noSuggestionsText || props["no-suggestions-text"],
            "suggestions-available-text": props.suggestionsAvailableText || props["suggestions-available-text"],
      ...
      const PickerMenu = (0, react_index_js_.forwardRef)((props, forwardedRef) => {
        ...
        /** Properties - run whenever a property has changed */
        useProperties(ref, "suggestionsAvailableText", props.suggestionsAvailableText);
