      ...
      class DocView extends ContentView {
        ...
        updateSelection(mustRead = false, fromPointer = false) {
          ...
          let selectionNotFocus =
            !focused && hasSelection(this.dom, this.view.observer.selectionRange) && !(activeElt && this.dom.contains(activeElt));
    ...
    */
      ...
      class ViewState {
        ...
        computeVisibleRanges() {
          ...
          let changed =
            ranges.length != this.visibleRanges.length || this.visibleRanges.some((r, i) => r.from != ranges[i].from || r.to != ranges[i].to);
