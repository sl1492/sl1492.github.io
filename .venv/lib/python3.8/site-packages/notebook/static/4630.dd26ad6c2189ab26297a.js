(self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] = self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] || []).push([
  [4630],
  {
    /***/ 7608: /***/ (__unused_webpack_module, exports) => {
      "use strict";
    ...
    /***/ 23617: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      "use strict";
      ...
      var svg = parser("image/svg+xml"); // CONCATENATED MODULE: ../node_modules/d3-fetch/src/index.js
      ...
      /* harmony default export */ const Tableau10 = colors("4e79a7f28e2ce1575976b7b259a14fedc949af7aa1ff9da79c755fbab0ab"); // CONCATENATED MODULE: ../node_modules/d3-scale-chromatic/src/index.js
      ...
      var defaultLocale = __webpack_require__(8964); // CONCATENATED MODULE: ../node_modules/d3-time-format/src/index.js
      ...
      (function (global, factory) {
        ...
        function createDOMPurify() {
          ...
          DOMPurify.isSupported =
            typeof entries === "function" && typeof getParentNode === "function" && implementation && implementation.createHTMLDocument !== undefined;
              ...
              if (
                ...
                (_isBasicCustomElement(lcTag) &&
                  ...
                  ((CUSTOM_ELEMENT_HANDLING.attributeNameCheck instanceof RegExp && regExpTest(CUSTOM_ELEMENT_HANDLING.attributeNameCheck, lcName)) ||
                    (CUSTOM_ELEMENT_HANDLING.attributeNameCheck instanceof Function && CUSTOM_ELEMENT_HANDLING.attributeNameCheck(lcName)))) || // Alternative, second condition checks if it's an `is`-attribute, AND
                // the value passes whatever the user has configured for CUSTOM_ELEMENT_HANDLING.tagNameCheck
                (lcName === "is" &&
                  CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements &&
                  ((CUSTOM_ELEMENT_HANDLING.tagNameCheck instanceof RegExp && regExpTest(CUSTOM_ELEMENT_HANDLING.tagNameCheck, value)) ||
    ...
    /***/ 54758: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      "use strict";
      ...
      var constants = __webpack_require__(62187); // CONCATENATED MODULE: ../node_modules/khroma/dist/channels/type.js
      /* IMPORT */
      ...
      /* EXPORT */
      /* harmony default export */ const type = Type; // CONCATENATED MODULE: ../node_modules/khroma/dist/channels/index.js
      ...
      class Channels {
        ...
        _ensureHSL() {
          ...
          const { h, s, l } = data;
          if (h === undefined)
            data.h = utils /* default */.Z.channel
              .rgb2hsl(data, "h");
          if (s === undefined)
            data.s = utils /* default */.Z.channel
              .rgb2hsl(data, "s");
          if (l === undefined)
            data.l = utils /* default */.Z.channel
              .rgb2hsl(data, "l");
        }
        _ensureRGB() {
          const data = this.data;
          const { r, g, b } = data;
          if (r === undefined)
            data.r = utils /* default */.Z.channel
              .hsl2rgb(data, "r");
          if (g === undefined)
            data.g = utils /* default */.Z.channel
              .hsl2rgb(data, "g");
          if (b === undefined)
            data.b = utils /* default */.Z.channel
              .hsl2rgb(data, "b");
        }
        /* GETTERS */
        get r() {
          const data = this.data;
          const r = data.r;
          if (!this.type.is(constants /* TYPE */.w.HSL) && r !== undefined) return r;
          this._ensureHSL();
          return utils /* default */.Z.channel
            .hsl2rgb(data, "r");
        }
        get g() {
          const data = this.data;
          const g = data.g;
          if (!this.type.is(constants /* TYPE */.w.HSL) && g !== undefined) return g;
          this._ensureHSL();
          return utils /* default */.Z.channel
            .hsl2rgb(data, "g");
        }
        get b() {
          const data = this.data;
          const b = data.b;
          if (!this.type.is(constants /* TYPE */.w.HSL) && b !== undefined) return b;
          this._ensureHSL();
          return utils /* default */.Z.channel
            .hsl2rgb(data, "b");
        }
        get h() {
          const data = this.data;
          const h = data.h;
          if (!this.type.is(constants /* TYPE */.w.RGB) && h !== undefined) return h;
          this._ensureRGB();
          return utils /* default */.Z.channel
            .rgb2hsl(data, "h");
        }
        get s() {
          const data = this.data;
          const s = data.s;
          if (!this.type.is(constants /* TYPE */.w.RGB) && s !== undefined) return s;
          this._ensureRGB();
          return utils /* default */.Z.channel
            .rgb2hsl(data, "s");
        }
        get l() {
          const data = this.data;
          const l = data.l;
          if (!this.type.is(constants /* TYPE */.w.RGB) && l !== undefined) return l;
          this._ensureRGB();
          return utils /* default */.Z.channel
            .rgb2hsl(data, "l");
        }
      ...
      /* EXPORT */
      /* harmony default export */ const channels = Channels; // CONCATENATED MODULE: ../node_modules/khroma/dist/channels/reusable.js
    ...
    /***/ 42528: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      "use strict";
      ...
      // EXTERNAL MODULE: ../node_modules/khroma/dist/constants.js
      var constants = __webpack_require__(62187); // CONCATENATED MODULE: ../node_modules/khroma/dist/color/hex.js
      /* IMPORT */
      ...
      const Hex = {
        ...
        stringify: (channels) => {
          ...
          if (a < 1) {
            // #RRGGBBAA
            return `#${constants /* DEC2HEX */.Q[Math.round(r)]}${constants /* DEC2HEX */.Q[Math.round(g)]}${
              constants /* DEC2HEX */.Q[Math.round(b)]
            }${constants /* DEC2HEX */.Q[Math.round(a * 255)]}`;
          } else {
            // #RRGGBB
            return `#${constants /* DEC2HEX */.Q[Math.round(r)]}${constants /* DEC2HEX */.Q[Math.round(g)]}${
              constants /* DEC2HEX */.Q[Math.round(b)]
      ...
      // EXTERNAL MODULE: ../node_modules/khroma/dist/utils/index.js + 3 modules
      var utils = __webpack_require__(90267); // CONCATENATED MODULE: ../node_modules/khroma/dist/color/hsl.js
      /* IMPORT */
      ...
      const HSL = {
        ...
        _hue2deg: (hue) => {
          ...
          if (match) {
            ...
            switch (unit) {
              case "grad":
                return utils /* default */.Z.channel.clamp
                  .h(parseFloat(number) * 0.9);
              case "rad":
                return utils /* default */.Z.channel.clamp
                  .h((parseFloat(number) * 180) / Math.PI);
              case "turn":
                return utils /* default */.Z.channel.clamp
                  .h(parseFloat(number) * 360);
            }
          }
          return utils /* default */.Z.channel.clamp
            .h(parseFloat(hue));
        ...
        parse: (color) => {
          ...
          return reusable /* default */.Z.set(
            {
              h: HSL._hue2deg(h),
              s: utils /* default */.Z.channel.clamp
                .s(parseFloat(s)),
              l: utils /* default */.Z.channel.clamp
                .l(parseFloat(l)),
              a: a
                ? utils /* default */.Z.channel.clamp
                    .a(isAlphaPercentage ? parseFloat(a) / 100 : parseFloat(a))
                : 1,
            },
            color
          );
        ...
        stringify: (channels) => {
          ...
          if (a < 1) {
            // HSLA
            return `hsla(${utils /* default */.Z.lang
              .round(h)}, ${utils /* default */.Z.lang
              .round(s)}%, ${utils /* default */.Z.lang
              .round(l)}%, ${a})`;
          } else {
            // HSL
            return `hsl(${utils /* default */.Z.lang
              .round(h)}, ${utils /* default */.Z.lang
              .round(s)}%, ${utils /* default */.Z.lang
              .round(l)}%)`;
          }
      ...
      /* EXPORT */
      /* harmony default export */ const hsl = HSL; // CONCATENATED MODULE: ../node_modules/khroma/dist/color/keyword.js
      ...
      /* EXPORT */
      /* harmony default export */ const keyword = Keyword; // CONCATENATED MODULE: ../node_modules/khroma/dist/color/rgb.js
      ...
      const RGB = {
        ...
        parse: (color) => {
          ...
          return reusable /* default */.Z.set(
            {
              r: utils /* default */.Z.channel.clamp
                .r(isRedPercentage ? parseFloat(r) * 2.55 : parseFloat(r)),
              g: utils /* default */.Z.channel.clamp
                .g(isGreenPercentage ? parseFloat(g) * 2.55 : parseFloat(g)),
              b: utils /* default */.Z.channel.clamp
                .b(isBluePercentage ? parseFloat(b) * 2.55 : parseFloat(b)),
              a: a
                ? utils /* default */.Z.channel.clamp
                    .a(isAlphaPercentage ? parseFloat(a) / 100 : parseFloat(a))
                : 1,
        ...
        stringify: (channels) => {
          ...
          if (a < 1) {
            // RGBA
            return `rgba(${utils /* default */.Z.lang
              .round(r)}, ${utils /* default */.Z.lang
              .round(g)}, ${utils /* default */.Z.lang
              .round(b)}, ${utils /* default */.Z.lang
              .round(a)})`;
          } else {
            // RGB
            return `rgb(${utils /* default */.Z.lang
              .round(r)}, ${utils /* default */.Z.lang
              .round(g)}, ${utils /* default */.Z.lang
              .round(b)})`;
          }
      ...
      /* EXPORT */
      /* harmony default export */ const rgb = RGB; // CONCATENATED MODULE: ../node_modules/khroma/dist/color/index.js
    ...
    /***/ 62187: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      "use strict";
      ...
      const DEC2HEX = {};
      for (let i = 0; i <= 255; i++)
        DEC2HEX[i] = _utils_index_js__WEBPACK_IMPORTED_MODULE_0__ /* ["default"] */.Z.unit
          .dec2hex(i); // Populating dynamically, striking a balance between code size and performance
      const TYPE = {
        ALL: 0,
        RGB: 1,
        HSL: 2,
    ...
    /***/ 60680: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      "use strict";
      /* harmony export */ __webpack_require__.d(__webpack_exports__, {
    ...
    /***/ 95323: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      "use strict";
      /* harmony export */ __webpack_require__.d(__webpack_exports__, {
        /* harmony export */ Z: () => __WEBPACK_DEFAULT_EXPORT__,
        /* harmony export */
    ...
    /***/ 57838: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      "use strict";
      /* harmony export */ __webpack_require__.d(__webpack_exports__, {
        /* harmony export */ Z: () => __WEBPACK_DEFAULT_EXPORT__,
        /* harmony export */
    ...
    /***/ 28186: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      "use strict";
      ...
      var dist_color = __webpack_require__(42528); // CONCATENATED MODULE: ../node_modules/khroma/dist/methods/luminance.js
      /* IMPORT */
      ...
      const luminance = (color) => {
        ...
        const luminance =
          ...
          0.0722 *
            utils /* default */.Z.channel
              .toLinear(b);
        return utils /* default */.Z.lang
          .round(luminance);
      };
      /* EXPORT */
      /* harmony default export */ const methods_luminance = luminance; // CONCATENATED MODULE: ../node_modules/khroma/dist/methods/is_light.js

      /* IMPORT */

      /* MAIN */
      const isLight = (color) => {
        return methods_luminance(color) >= 0.5;
      };
      /* EXPORT */
      /* harmony default export */ const is_light = isLight; // CONCATENATED MODULE: ../node_modules/khroma/dist/methods/is_dark.js
    ...
    /***/ 28482: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      "use strict";
      /* harmony export */ __webpack_require__.d(__webpack_exports__, {
        /* harmony export */ Z: () => __WEBPACK_DEFAULT_EXPORT__,
        /* harmony export */
    ...
    /***/ 14728: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      "use strict";
      /* harmony export */ __webpack_require__.d(__webpack_exports__, {
        /* harmony export */ Z: () => __WEBPACK_DEFAULT_EXPORT__,
        /* harmony export */
      ...
      const rgba = (r, g, b = 0, a = 1) => {
        if (typeof r !== "number") return (0, _change_js__WEBPACK_IMPORTED_MODULE_0__ /* ["default"] */.Z)(r, { a: g });
        const channels = _channels_reusable_js__WEBPACK_IMPORTED_MODULE_1__ /* ["default"] */.Z.set({
          r: _utils_index_js__WEBPACK_IMPORTED_MODULE_2__ /* ["default"] */.Z.channel.clamp
            .r(r),
          g: _utils_index_js__WEBPACK_IMPORTED_MODULE_2__ /* ["default"] */.Z.channel.clamp
            .g(g),
          b: _utils_index_js__WEBPACK_IMPORTED_MODULE_2__ /* ["default"] */.Z.channel.clamp
            .b(b),
          a: _utils_index_js__WEBPACK_IMPORTED_MODULE_2__ /* ["default"] */.Z.channel.clamp
            .a(a),
        });
    ...
    /***/ 90267: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      "use strict";
      ...
      /* EXPORT */
      /* harmony default export */ const channel = Channel; // CONCATENATED MODULE: ../node_modules/khroma/dist/utils/lang.js
      ...
      /* EXPORT */
      /* harmony default export */ const lang = Lang; // CONCATENATED MODULE: ../node_modules/khroma/dist/utils/unit.js
      ...
      /* EXPORT */
      /* harmony default export */ const unit = Unit; // CONCATENATED MODULE: ../node_modules/khroma/dist/utils/index.js
    ...
    /***/ 91138: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      "use strict";
      ...
      var eq = __webpack_require__(35050); // CONCATENATED MODULE: ../node_modules/lodash-es/_assocIndexOf.js
      /**
    ...
    /***/ 81700: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      "use strict";
      /* harmony export */ __webpack_require__.d(__webpack_exports__, {
        /* harmony export */ Z: () => __WEBPACK_DEFAULT_EXPORT__,
        /* harmony export */
    ...
    /***/ 24395: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      "use strict";
      ...
      var _getNative = __webpack_require__(26266); // CONCATENATED MODULE: ../node_modules/lodash-es/_nativeCreate.js
      /* Built-in method references that are verified to be native. */
      ...
      var _Map = __webpack_require__(81700); // CONCATENATED MODULE: ../node_modules/lodash-es/_mapCacheClear.js
      /**
    ...
    /***/ 16889: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      "use strict";
      /* harmony export */ __webpack_require__.d(__webpack_exports__, {
        /* harmony export */ Z: () => __WEBPACK_DEFAULT_EXPORT__,
        /* harmony export */
    ...
    /***/ 82948: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      "use strict";
      ...
      // EXTERNAL MODULE: ../node_modules/lodash-es/_ListCache.js + 6 modules
      var _ListCache = __webpack_require__(91138); // CONCATENATED MODULE: ../node_modules/lodash-es/_stackClear.js
      /**
      ...
      var _MapCache = __webpack_require__(24395); // CONCATENATED MODULE: ../node_modules/lodash-es/_stackSet.js
    ...
    /***/ 91642: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      "use strict";
      /* harmony export */ __webpack_require__.d(__webpack_exports__, {
        /* harmony export */ Z: () => __WEBPACK_DEFAULT_EXPORT__,
        /* harmony export */
    ...
    /***/ 41049: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      "use strict";
      /* harmony export */ __webpack_require__.d(__webpack_exports__, {
        /* harmony export */ Z: () => __WEBPACK_DEFAULT_EXPORT__,
        /* harmony export */
    ...
    /***/ 40709: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      "use strict";
      ...
      var isTypedArray = __webpack_require__(14923); // CONCATENATED MODULE: ../node_modules/lodash-es/_arrayLikeKeys.js
      /** Used for built-in method references. */
      var objectProto = Object.prototype;
    ...
    /***/ 15561: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      "use strict";
      /* harmony export */ __webpack_require__.d(__webpack_exports__, {
        /* harmony export */ Z: () => __WEBPACK_DEFAULT_EXPORT__,
        /* harmony export */
      ...
      function assignValue(object, key, value) {
        ...
        if (
          !(hasOwnProperty.call(object, key) && (0, _eq_js__WEBPACK_IMPORTED_MODULE_0__ /* ["default"] */.Z)(objValue, value)) ||
    ...
    /***/ 93586: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      "use strict";
      /* harmony export */ __webpack_require__.d(__webpack_exports__, {
        /* harmony export */ Z: () => __WEBPACK_DEFAULT_EXPORT__,
        /* harmony export */
    ...
    /***/ 49399: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      "use strict";
    ...
    /***/ 77070: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      "use strict";
      ...
      var _Symbol = __webpack_require__(91642); // CONCATENATED MODULE: ../node_modules/lodash-es/_getRawTag.js
      /** Used for built-in method references. */
      var objectProto = Object.prototype;
    ...
    /***/ 45934: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      "use strict";
      ...
      var _overArg = __webpack_require__(4883); // CONCATENATED MODULE: ../node_modules/lodash-es/_nativeKeys.js
      /* Built-in method references for those with the same name as other `lodash` methods. */
      var nativeKeys = (0, _overArg /* default */.Z)(Object.keys, Object);

      /* harmony default export */ const _nativeKeys = nativeKeys; // CONCATENATED MODULE: ../node_modules/lodash-es/_baseKeys.js
    ...
    /***/ 20274: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      "use strict";
      /* harmony export */ __webpack_require__.d(__webpack_exports__, {
        /* harmony export */ Z: () => __WEBPACK_DEFAULT_EXPORT__,
        /* harmony export */
    ...
    /***/ 52049: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      "use strict";
      /* harmony export */ __webpack_require__.d(__webpack_exports__, {
        /* harmony export */ Z: () => __WEBPACK_DEFAULT_EXPORT__,
        /* harmony export */
      ...
      function cloneArrayBuffer(arrayBuffer) {
        ...
        new _Uint8Array_js__WEBPACK_IMPORTED_MODULE_0__ /* ["default"] */.Z(result).set(
          new _Uint8Array_js__WEBPACK_IMPORTED_MODULE_0__ /* ["default"] */.Z(arrayBuffer)
        );
        return result;
      }
    ...
    /***/ 64405: /***/ (module, __webpack_exports__, __webpack_require__) => {
      "use strict";
      /* harmony export */ __webpack_require__.d(__webpack_exports__, {
        /* harmony export */ Z: () => __WEBPACK_DEFAULT_EXPORT__,
        /* harmony export */
    ...
    /***/ 61601: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      "use strict";
      /* harmony export */ __webpack_require__.d(__webpack_exports__, {
        /* harmony export */ Z: () => __WEBPACK_DEFAULT_EXPORT__,
        /* harmony export */
    ...
    /***/ 93580: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      "use strict";
      /* harmony export */ __webpack_require__.d(__webpack_exports__, {
        /* harmony export */ Z: () => __WEBPACK_DEFAULT_EXPORT__,
        /* harmony export */
    ...
    /***/ 47313: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      "use strict";
      /* harmony export */ __webpack_require__.d(__webpack_exports__, {
        /* harmony export */ Z: () => __WEBPACK_DEFAULT_EXPORT__,
        /* harmony export */
    ...
    /***/ 30253: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      "use strict";
      /* harmony export */ __webpack_require__.d(__webpack_exports__, {
        /* harmony export */ Z: () => __WEBPACK_DEFAULT_EXPORT__,
        /* harmony export */
    ...
    /***/ 89268: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      "use strict";
      /* harmony export */ __webpack_require__.d(__webpack_exports__, {
        /* harmony export */ Z: () => __WEBPACK_DEFAULT_EXPORT__,
        /* harmony export */
    ...
    /***/ 26266: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      "use strict";
      ...
      var _root = __webpack_require__(94311); // CONCATENATED MODULE: ../node_modules/lodash-es/_coreJsData.js
      ...
      var _toSource = __webpack_require__(62392); // CONCATENATED MODULE: ../node_modules/lodash-es/_baseIsNative.js
      /**
    ...
    /***/ 72784: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      "use strict";
      /* harmony export */ __webpack_require__.d(__webpack_exports__, {
        /* harmony export */ Z: () => __WEBPACK_DEFAULT_EXPORT__,
        /* harmony export */
    ...
    /***/ 41182: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      "use strict";
      ...
      // EXTERNAL MODULE: ../node_modules/lodash-es/_root.js
      var _root = __webpack_require__(94311); // CONCATENATED MODULE: ../node_modules/lodash-es/_DataView.js
      /* Built-in method references that are verified to be native. */
      ...
      // EXTERNAL MODULE: ../node_modules/lodash-es/_Map.js
      var _Map = __webpack_require__(81700); // CONCATENATED MODULE: ../node_modules/lodash-es/_Promise.js
      /* Built-in method references that are verified to be native. */
      ...
      var _Set = __webpack_require__(16889); // CONCATENATED MODULE: ../node_modules/lodash-es/_WeakMap.js
      /* Built-in method references that are verified to be native. */
      ...
      // EXTERNAL MODULE: ../node_modules/lodash-es/_toSource.js
      var _toSource = __webpack_require__(62392); // CONCATENATED MODULE: ../node_modules/lodash-es/_getTag.js
      /** `Object#toString` result references. */
    ...
    /***/ 95764: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      "use strict";
      ...
      // EXTERNAL MODULE: ../node_modules/lodash-es/isObject.js
      var isObject = __webpack_require__(60417); // CONCATENATED MODULE: ../node_modules/lodash-es/_baseCreate.js
      /** Built-in value references. */
      ...
      // EXTERNAL MODULE: ../node_modules/lodash-es/_isPrototype.js
      var _isPrototype = __webpack_require__(89418); // CONCATENATED MODULE: ../node_modules/lodash-es/_initCloneObject.js
      /**
    ...
    /***/ 47952: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      "use strict";
      /* harmony export */ __webpack_require__.d(__webpack_exports__, {
        /* harmony export */ Z: () => __WEBPACK_DEFAULT_EXPORT__,
        /* harmony export */
    ...
    /***/ 89418: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      "use strict";
      /* harmony export */ __webpack_require__.d(__webpack_exports__, {
        /* harmony export */ Z: () => __WEBPACK_DEFAULT_EXPORT__,
        /* harmony export */
    ...
    /***/ 53594: /***/ (module, __webpack_exports__, __webpack_require__) => {
      "use strict";
      /* harmony export */ __webpack_require__.d(__webpack_exports__, {
        /* harmony export */ Z: () => __WEBPACK_DEFAULT_EXPORT__,
        /* harmony export */
    ...
    /***/ 4883: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      "use strict";
      /* harmony export */ __webpack_require__.d(__webpack_exports__, {
        /* harmony export */ Z: () => __WEBPACK_DEFAULT_EXPORT__,
        /* harmony export */
    ...
    /***/ 15829: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      "use strict";
    ...
    /***/ 94311: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      "use strict";
      /* harmony export */ __webpack_require__.d(__webpack_exports__, {
        /* harmony export */ Z: () => __WEBPACK_DEFAULT_EXPORT__,
        /* harmony export */
    ...
    /***/ 71649: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      "use strict";
      ...
      var identity = __webpack_require__(64056); // CONCATENATED MODULE: ../node_modules/lodash-es/_baseSetToString.js
      /**
    ...
    /***/ 62392: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      "use strict";
      /* harmony export */ __webpack_require__.d(__webpack_exports__, {
        /* harmony export */ Z: () => __WEBPACK_DEFAULT_EXPORT__,
        /* harmony export */
    ...
    /***/ 78795: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      "use strict";
      /* harmony export */ __webpack_require__.d(__webpack_exports__, {
        /* harmony export */ Z: () => __WEBPACK_DEFAULT_EXPORT__,
        /* harmony export */
    ...
    /***/ 35050: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      "use strict";
      /* harmony export */ __webpack_require__.d(__webpack_exports__, {
        /* harmony export */ Z: () => __WEBPACK_DEFAULT_EXPORT__,
        /* harmony export */
    ...
    /***/ 64056: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      "use strict";
      /* harmony export */ __webpack_require__.d(__webpack_exports__, {
        /* harmony export */ Z: () => __WEBPACK_DEFAULT_EXPORT__,
        /* harmony export */
    ...
    /***/ 9028: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      "use strict";
      ...
      var isObjectLike = __webpack_require__(9615); // CONCATENATED MODULE: ../node_modules/lodash-es/_baseIsArguments.js
      /** `Object#toString` result references. */
    ...
    /***/ 64058: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      "use strict";
      /* harmony export */ __webpack_require__.d(__webpack_exports__, {
        /* harmony export */ Z: () => __WEBPACK_DEFAULT_EXPORT__,
        /* harmony export */
    ...
    /***/ 69959: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      "use strict";
      /* harmony export */ __webpack_require__.d(__webpack_exports__, {
        /* harmony export */ Z: () => __WEBPACK_DEFAULT_EXPORT__,
        /* harmony export */
    ...
    /***/ 60492: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      "use strict";
      /* harmony export */ __webpack_require__.d(__webpack_exports__, {
        /* harmony export */ Z: () => __WEBPACK_DEFAULT_EXPORT__,
        /* harmony export */
      ...
      function isArrayLikeObject(value) {
        return (
          ...
          (0, _isArrayLike_js__WEBPACK_IMPORTED_MODULE_1__ /* ["default"] */.Z)(value)
        );
      }
    ...
    /***/ 23230: /***/ (module, __webpack_exports__, __webpack_require__) => {
      "use strict";
      ...
      // EXTERNAL MODULE: ../node_modules/lodash-es/_root.js
      var _root = __webpack_require__(94311); // CONCATENATED MODULE: ../node_modules/lodash-es/stubFalse.js
      /**
    ...
    /***/ 66400: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      "use strict";
      /* harmony export */ __webpack_require__.d(__webpack_exports__, {
        /* harmony export */ Z: () => __WEBPACK_DEFAULT_EXPORT__,
        /* harmony export */
      ...
      function isEmpty(value) {
        ...
        if (
          (0, _isArrayLike_js__WEBPACK_IMPORTED_MODULE_0__ /* ["default"] */.Z)(value) &&
          ((0, _isArray_js__WEBPACK_IMPORTED_MODULE_1__ /* ["default"] */.Z)(value) ||
            typeof value == "string" ||
            typeof value.splice == "function" ||
            (0, _isBuffer_js__WEBPACK_IMPORTED_MODULE_2__ /* ["default"] */.Z)(value) ||
            (0, _isTypedArray_js__WEBPACK_IMPORTED_MODULE_3__ /* ["default"] */.Z)(value) ||
            (0, _isArguments_js__WEBPACK_IMPORTED_MODULE_4__ /* ["default"] */.Z)(value))
        ) {
          return !value.length;
        }
    ...
    /***/ 48489: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      "use strict";
      /* harmony export */ __webpack_require__.d(__webpack_exports__, {
        /* harmony export */ Z: () => __WEBPACK_DEFAULT_EXPORT__,
        /* harmony export */
    ...
    /***/ 30918: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      "use strict";
      /* harmony export */ __webpack_require__.d(__webpack_exports__, {
        /* harmony export */ Z: () => __WEBPACK_DEFAULT_EXPORT__,
        /* harmony export */
    ...
    /***/ 60417: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      "use strict";
      /* harmony export */ __webpack_require__.d(__webpack_exports__, {
        /* harmony export */ Z: () => __WEBPACK_DEFAULT_EXPORT__,
        /* harmony export */
    ...
    /***/ 53541: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      "use strict";
      /* harmony export */ __webpack_require__.d(__webpack_exports__, {
        /* harmony export */ Z: () => __WEBPACK_DEFAULT_EXPORT__,
        /* harmony export */
      ...
      function isPlainObject(value) {
        if (
          !(0, _isObjectLike_js__WEBPACK_IMPORTED_MODULE_0__ /* ["default"] */.Z)(value) ||
          (0, _baseGetTag_js__WEBPACK_IMPORTED_MODULE_1__ /* ["default"] */.Z)(value) != objectTag
        ) {
          return false;
        }
    ...
    /***/ 14923: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      "use strict";
      ...
      // EXTERNAL MODULE: ../node_modules/lodash-es/isObjectLike.js
      var isObjectLike = __webpack_require__(9615); // CONCATENATED MODULE: ../node_modules/lodash-es/_baseIsTypedArray.js
      /** `Object#toString` result references. */
      var argsTag = "[object Arguments]",
      ...
      var _nodeUtil = __webpack_require__(53594); // CONCATENATED MODULE: ../node_modules/lodash-es/isTypedArray.js
    ...
    /***/ 48441: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      "use strict";
      ...
      var isObject = __webpack_require__(60417);
      // EXTERNAL MODULE: ../node_modules/lodash-es/_isPrototype.js
      var _isPrototype = __webpack_require__(89418); // CONCATENATED MODULE: ../node_modules/lodash-es/_nativeKeysIn.js
      /**
      ...
      var isArrayLike = __webpack_require__(69959); // CONCATENATED MODULE: ../node_modules/lodash-es/keysIn.js
      /**
    ...
    /***/ 86861: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      "use strict";
      /* harmony export */ __webpack_require__.d(__webpack_exports__, {
        /* harmony export */ Z: () => __WEBPACK_DEFAULT_EXPORT__,
        /* harmony export */
    ...
    /***/ 18802: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      "use strict";
      ...
      // EXTERNAL MODULE: ../node_modules/lodash-es/eq.js
      var eq = __webpack_require__(35050); // CONCATENATED MODULE: ../node_modules/lodash-es/_assignMergeValue.js
      /**
      ...
      // EXTERNAL MODULE: ../node_modules/lodash-es/isTypedArray.js + 1 modules
      var isTypedArray = __webpack_require__(14923); // CONCATENATED MODULE: ../node_modules/lodash-es/_safeGet.js
      /**
      ...
      var keysIn = __webpack_require__(48441); // CONCATENATED MODULE: ../node_modules/lodash-es/toPlainObject.js
      /**
      ...
      var _isIterateeCall = __webpack_require__(47952); // CONCATENATED MODULE: ../node_modules/lodash-es/_createAssigner.js
      /**
    ...
    /***/ 24028: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      "use strict";
      ...
      var change = __webpack_require__(95323); // CONCATENATED MODULE: ../node_modules/khroma/dist/methods/adjust.js
      /* IMPORT */
      ...
      var rgba = __webpack_require__(14728); // CONCATENATED MODULE: ../node_modules/khroma/dist/methods/mix.js
      /* IMPORT */
      ...
      const mix = (color1, color2, weight = 50) => {
        ...
        const weight1combined =
          weightNormalized * alphaDelta === -1 ? weightNormalized : (weightNormalized + alphaDelta) / (1 + weightNormalized * alphaDelta);
      ...
      /* EXPORT */
      /* harmony default export */ const methods_mix = mix; // CONCATENATED MODULE: ../node_modules/khroma/dist/methods/invert.js
      ...
      var merge = __webpack_require__(18802); // CONCATENATED MODULE: ../node_modules/stylis/src/Enum.js
      var MS = "-ms-";
      var MOZ = "-moz-";
      var WEBKIT = "-webkit-";
      ...
      var LAYER = "@layer"; // CONCATENATED MODULE: ../node_modules/stylis/src/Utility.js
      ...
      function hash(value, length) {
        return charat(value, 0) ^ 45
          ? (((((((length << 2) ^ charat(value, 0)) << 2) ^ charat(value, 1)) << 2) ^ charat(value, 2)) << 2) ^ charat(value, 3)
          : 0;
      }
                      ...
                      switch (atrule === 99 && charat(characters, 3) === 110 ? 100 : atrule) {
                        ...
                        case 115:
                          parse(
                            ...
                            rule &&
                              Utility_append(
                                ruleset(value, reference, reference, 0, 0, rules, points, type, rules, (props = []), length, children),
                                children
                              ),
                            rules,
                            children,
      ...
      var isEmpty = __webpack_require__(66400); // CONCATENATED MODULE: ../node_modules/mermaid/dist/mermaid-04fb0060.js
      const LEVELS = {
        trace: 0,
        debug: 1,
        info: 2,
      ...
      const sanitizeText$2 = (text, config2) => {
        ...
        if (config2.dompurifyConfig) {
          ...
          text = purify_default()
            .sanitize(sanitizeMore(text, config2), {
              FORBID_TAGS: ["style"],
            })
            .toString();
        }
      ...
      let Theme$4 = class Theme {
        ...
        updateColors() {
          ...
          this.edgeLabelBackground =
            this.edgeLabelBackground || (this.darkMode ? (0, darken /* default */.Z)(this.secondaryColor, 30) : this.secondaryColor);
          ...
          this.quadrantPointFill =
            this.quadrantPointFill || (0, is_dark /* default */.Z)(this.quadrant1Fill)
              ? (0, lighten /* default */.Z)(this.quadrant1Fill)
              : (0, darken /* default */.Z)(this.quadrant1Fill);
          ...
          this.relationLabelBackground =
            this.relationLabelBackground || (this.darkMode ? (0, darken /* default */.Z)(this.secondaryColor, 30) : this.secondaryColor);
...
`,
      ...
      const calculateTextDimensions = (0, memoize /* default */.Z)(
        (text, config2) => {
          ...
          const index =
            ...
            (dims[0].height > dims[1].height && dims[0].width > dims[1].width && dims[0].lineHeight > dims[1].lineHeight)
              ? 0
              : 1;
          return dims[index];
        },
      ...
      const detector$j = (txt, config2) => {
        var _a, _b;
        if (
          ((_a = config2 == null ? void 0 : config2.flowchart) == null ? void 0 : _a.defaultRenderer) === "dagre-wrapper" ||
          ((_b = config2 == null ? void 0 : config2.flowchart) == null ? void 0 : _b.defaultRenderer) === "elk"
        ) {
          return false;
        }
      ...
      const loader$k = async () => {
        const { diagram: diagram2 } = await Promise.all(
          /* import() */ [
            __webpack_require__.e(7259),
            __webpack_require__.e(4780),
            __webpack_require__.e(8443),
            __webpack_require__.e(6281),
            __webpack_require__.e(1261),
            __webpack_require__.e(6417),
          ]
        ).then(__webpack_require__.bind(__webpack_require__, 66417));
      ...
      const detector$i = (txt, config2) => {
        var _a, _b, _c;
        if (
          ((_a = config2 == null ? void 0 : config2.flowchart) == null ? void 0 : _a.defaultRenderer) === "dagre-d3" ||
          ((_b = config2 == null ? void 0 : config2.flowchart) == null ? void 0 : _b.defaultRenderer) === "elk"
        ) {
          return false;
        }
        if (
          /^\s*graph/.test(txt) &&
          ((_c = config2 == null ? void 0 : config2.flowchart) == null ? void 0 : _c.defaultRenderer) === "dagre-wrapper"
        ) {
          return true;
        }
      ...
      const loader$j = async () => {
        const { diagram: diagram2 } = await Promise.all(
          /* import() */ [
            ...
            __webpack_require__.e(6281),
            __webpack_require__.e(1261),
            __webpack_require__.e(7153),
          ]
        ).then(__webpack_require__.bind(__webpack_require__, 57153));
      ...
      const loader$i = async () => {
        const { diagram: diagram2 } = await Promise.all(/* import() */ [__webpack_require__.e(7259), __webpack_require__.e(2692)]).then(
          __webpack_require__.bind(__webpack_require__, 22692)
        );
      ...
      const loader$c = async () => {
        const { diagram: diagram2 } = await Promise.all(/* import() */ [__webpack_require__.e(4780), __webpack_require__.e(9866)]).then(
          __webpack_require__.bind(__webpack_require__, 59866)
        );
      ...
      const loader$b = async () => {
        const { diagram: diagram2 } = await Promise.all(/* import() */ [__webpack_require__.e(7259), __webpack_require__.e(7097)]).then(
          __webpack_require__.bind(__webpack_require__, 87097)
        );
      ...
      const loader$9 = async () => {
        const { diagram: diagram2 } = await Promise.all(
          /* import() */ [__webpack_require__.e(7259), __webpack_require__.e(7010), __webpack_require__.e(1388)]
        ).then(__webpack_require__.bind(__webpack_require__, 91388));
      ...
      const detector$7 = (txt, config2) => {
        ...
        if (
          ...
          ((_a = config2 == null ? void 0 : config2.class) == null ? void 0 : _a.defaultRenderer) === "dagre-wrapper"
        ) {
          return true;
        }
      ...
      const loader$8 = async () => {
        const { diagram: diagram2 } = await Promise.all(
          /* import() */ [
            ...
            __webpack_require__.e(8443),
            __webpack_require__.e(6281),
            __webpack_require__.e(7010),
            __webpack_require__.e(1846),
          ]
        ).then(__webpack_require__.bind(__webpack_require__, 11846));
      ...
      const loader$7 = async () => {
        const { diagram: diagram2 } = await Promise.all(
          /* import() */ [__webpack_require__.e(7259), __webpack_require__.e(5343), __webpack_require__.e(6640)]
        ).then(__webpack_require__.bind(__webpack_require__, 6640));
      ...
      const detector$5 = (txt, config2) => {
        ...
        if (
          ...
          ((_a = config2 == null ? void 0 : config2.state) == null ? void 0 : _a.defaultRenderer) === "dagre-wrapper"
        ) {
          return true;
        }
        return false;
      ...
      const loader$6 = async () => {
        const { diagram: diagram2 } = await Promise.all(
          /* import() */ [
            ...
            __webpack_require__.e(8443),
            __webpack_require__.e(6281),
            __webpack_require__.e(5343),
            __webpack_require__.e(3154),
          ]
        ).then(__webpack_require__.bind(__webpack_require__, 43154));
...
`;
      ...
      const commonDb = /* @__PURE__ */ Object.freeze(
      ...
      const registerDiagram = (id2, diagram2, detector2) => {
        ...
        (_a = diagram2.injectUtils) == null
          ? void 0
          : _a.call(diagram2, log, setLogLevel, getConfig, sanitizeText, setupGraphViewbox, getCommonDb(), () => {});
      };
      ...
      const loader$4 = async () => {
        const { diagram: diagram2 } = await Promise.all(
          /* import() */ [__webpack_require__.e(4780), __webpack_require__.e(8443), __webpack_require__.e(1261), __webpack_require__.e(2324)]
        ).then(__webpack_require__.bind(__webpack_require__, 62324));
      ...
      const loader$2 = async () => {
        const { diagram: diagram2 } = await Promise.all(/* import() */ [__webpack_require__.e(4780), __webpack_require__.e(1495)]).then(
          __webpack_require__.bind(__webpack_require__, 1495)
        );
      ...
      var json = failsafe.extend({
        implicit: [_null, bool, mermaid_04fb0060_int, mermaid_04fb0060_float],
      });
      var core = json;
      ...
      var _default = core.extend({
        implicit: [timestamp, mermaid_04fb0060_merge],
      ...
      function composeNode(state2, parentIndent, nodeContext, allowToSeek, allowCompact) {
        ...
        if (indentStatus === 1 || CONTEXT_BLOCK_OUT === nodeContext) {
          ...
          if (indentStatus === 1) {
            if (
              (allowBlockCollections && (readBlockSequence(state2, blockIndent) || readBlockMapping(state2, blockIndent, flowIndent))) ||
...
:root { --mermaid-alt-font-family: ${config2.altFontFamily}}`;
      ...
      const putIntoIFrame = (svgCode = "", svgElement) => {
        var _a, _b;
        const height = ((_b = (_a = svgElement == null ? void 0 : svgElement.viewBox) == null ? void 0 : _a.baseVal) == null ? void 0 : _b.height)
  ...
  ${IFRAME_NOT_SUPPORTED_MSG}
      ...
      const runThrowsErrors = async function (
        ...
        for (const element of Array.from(nodesToProcess)) {
          ...
          txt = (0, esm /* dedent */.Z)(utils.entityDecode(txt))
            .trim()
            .replace(/<br\s*\/?>/gi, "<br/>");
    ...
    /***/ 84630: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      "use strict";
      ...
      /* harmony import */ var dompurify__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/ __webpack_require__.n(
        dompurify__WEBPACK_IMPORTED_MODULE_3__
      );

      /***/
    },

    /***/ 11464: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      "use strict";
      /* harmony export */ __webpack_require__.d(__webpack_exports__, {
