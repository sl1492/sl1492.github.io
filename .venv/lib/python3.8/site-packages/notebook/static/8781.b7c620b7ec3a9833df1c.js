(self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] = self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] || []).push([
  [8781],
  {
    ...
    /***/ 60880: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
       ...
       */
      async function main() {
        const mimeExtensionsMods = [__webpack_require__(91555), __webpack_require__(21599), __webpack_require__(31708), __webpack_require__(68552)];
        ...
        let baseMods = [
          ...
          __webpack_require__(53019)["default"].filter(({ id }) => ["@jupyterlab/documentsearch-extension:plugin"].includes(id)),
          ...
          __webpack_require__(91122)["default"].filter(({ id }) => ["@jupyterlab/fileeditor-extension:plugin"].includes(id)),

          __webpack_require__(66106)["default"].filter(({ id }) => ["@jupyterlab/help-extension:resources"].includes(id)),
          __webpack_require__(64778),
          __webpack_require__(12300),
          __webpack_require__(21495),

          __webpack_require__(69010)["default"].filter(({ id }) => ["@jupyterlab/mainmenu-extension:plugin"].includes(id)),
        ...
        switch (page) {
          ...
          case "/tree": {
            baseMods = baseMods.concat([
              ...
              __webpack_require__(78352)["default"].filter(({ id }) => ["@jupyterlab/running-extension:plugin"].includes(id)),
