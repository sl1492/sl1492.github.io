...
*/
    ...
    /***/ 90425: /***/ (module, __unused_webpack_exports, __webpack_require__) => {
      /*!
Copyright 2019 Ron Buckton
 ...
 */
    ...
    /***/ 32913: /***/ (module, __unused_webpack_exports, __webpack_require__) => {
      /*!
Copyright 2019 Ron Buckton
...
*/
    ...
    /***/ 5565: /***/ (module, __unused_webpack_exports, __webpack_require__) => {
      /*!
Copyright 2019 Ron Buckton
 ...
 */
    ...
    /***/ 47921: /***/ (module, __unused_webpack_exports, __webpack_require__) => {
      /**
       * The MIT License (MIT)
        ...
        transform: function transform(regexp) {
          ...
          transformToApply.forEach(function (transformName) {
            if (!compatTransforms.hasOwnProperty(transformName)) {
              throw new Error(
                "Unknown compat-transform: " + transformName + ". " + "Available transforms are: " + Object.keys(compatTransforms).join(", ")
              );
            }
    ...
    /***/ 24845: /***/ (module, __unused_webpack_exports, __webpack_require__) => {
      /**
       * The MIT License (MIT)
       * Copyright (c) 2017-present Dmitry Soshnikov <dmitry.soshnikov@gmail.com>
       */
            ...
            for (
              ...
              try {
                restSets: for (
                  ...
                  try {
                    for (
                      var _iterator5 = Object.keys(handledStates)[Symbol.iterator](), _step5;
    ...
    /***/ 24210: /***/ (module, __unused_webpack_exports, __webpack_require__) => {
      /**
       * The MIT License (MIT)
       * Copyright (c) 2017-present Dmitry Soshnikov <dmitry.soshnikov@gmail.com>
       */
        ...
        _createClass(DFA, [
          ...
          },
          {
            ...
            value: function getTransitionTable() {
              ...
              var updateAcceptingStates = function updateAcceptingStates(states) {
                ...
                try {
                  for (
                    var _iterator = nfaAcceptingStates[Symbol.iterator](), _step;
                    !(_iteratorNormalCompletion = (_step = _iterator.next()).done);
                    _iteratorNormalCompletion = true
                  ) {
                  ...
                  for (
                    ...
                    try {
                      for (
                        ...
                        try {
                          for (
                            var _iterator4 = nfaStatesOnSymbol[Symbol.iterator](), _step4;
                            !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done);
                            _iteratorNormalCompletion4 = true
                          ) {
          ...
          },
          {
            ...
            value: function _remapStateNumbers(calculatedDFATable) {
              ...
              try {
                for (
                  var _iterator5 = this._originalAcceptingStateNumbers[Symbol.iterator](), _step5;
                  !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done);
                  _iteratorNormalCompletion5 = true
                ) {
    ...
    /***/ 76186: /***/ (module, __unused_webpack_exports, __webpack_require__) => {
      /**
       * The MIT License (MIT)
       * Copyright (c) 2017-present Dmitry Soshnikov <dmitry.soshnikov@gmail.com>
       */
    ...
    /***/ 32651: /***/ (module, __unused_webpack_exports, __webpack_require__) => {
      /**
       * The MIT License (MIT)
       * Copyright (c) 2017-present Dmitry Soshnikov <dmitry.soshnikov@gmail.com>
       */
    ...
    /***/ 22388: /***/ (module, __unused_webpack_exports, __webpack_require__) => {
      /**
       * The MIT License (MIT)
       * Copyright (c) 2017-present Dmitry Soshnikov <dmitry.soshnikov@gmail.com>
       */
    ...
    /***/ 78679: /***/ (module, __unused_webpack_exports, __webpack_require__) => {
      /**
       * The MIT License (MIT)
       * Copyright (c) 2017-present Dmitry Soshnikov <dmitry.soshnikov@gmail.com>
       */
        ...
        _createClass(NFAState, [
          {
            ...
            value: function matches(string) {
              ...
              if (string.length === 0) {
                ...
                try {
                  for (
                    var _iterator = this.getTransitionsOnSymbol(EPSILON)[Symbol.iterator](), _step;
                    !(_iteratorNormalCompletion = (_step = _iterator.next()).done);
                    _iteratorNormalCompletion = true
                  ) {
              ...
              try {
                for (
                  var _iterator3 = this.getTransitionsOnSymbol(EPSILON)[Symbol.iterator](), _step3;
                  !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done);
                  _iteratorNormalCompletion3 = true
                ) {
            ...
            value: function getEpsilonClosure() {
              ...
              if (!this._epsilonClosure) {
                (function () {
                  ...
                  try {
                    for (
                      var _iterator4 = epsilonTransitions[Symbol.iterator](), _step4;
                      !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done);
                      _iteratorNormalCompletion4 = true
                    ) {
    ...
    /***/ 54149: /***/ (module, __unused_webpack_exports, __webpack_require__) => {
      /**
       * The MIT License (MIT)
       * Copyright (c) 2017-present Dmitry Soshnikov <dmitry.soshnikov@gmail.com>
       */
          ...
          },
          {
            ...
            value: function getAcceptingStateNumbers() {
              if (!this._acceptingStateNumbers) {
                ...
                try {
                  for (
                    var _iterator = this.getAcceptingStates()[Symbol.iterator](), _step;
                    !(_iteratorNormalCompletion = (_step = _iterator.next()).done);
                    _iteratorNormalCompletion = true
                  ) {
                ...
                var visitState = function visitState(state) {
                  ...
                  try {
                    for (
                      ...
                      try {
                        for (
                          var _iterator3 = symbolTransitions[Symbol.iterator](), _step3;
                          !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done);
                          _iteratorNormalCompletion3 = true
                        ) {
    ...
    /***/ 33186: /***/ (module, __unused_webpack_exports, __webpack_require__) => {
      /**
       * The MIT License (MIT)
       * Copyright (c) 2017-present Dmitry Soshnikov <dmitry.soshnikov@gmail.com>
       */
    ...
    /***/ 77698: /***/ (module) => {
      ...
      function rewriteWordRanges(path, hasIFlag, hasUFlag) {
        ...
        if (
          numberPath &&
          ((lowerCasePath && upperCasePath) || (hasIFlag && (lowerCasePath || upperCasePath))) &&
          underscorePath &&
      ...
      var whitespaceRangeTests = [
        ...
        _toConsumableArray(
          [0x00a0, 0x1680, 0x2028, 0x2029, 0x202f, 0x205f, 0x3000, 0xfeff].map(function (codePoint) {
            return function (node) {
    ...
    /***/ 53540: /***/ (module) => {
      ...
      function isSimpleRange(classRange) {
        ...
        return (
          (from.codePoint >= DIGIT_0_CP && from.codePoint <= DIGIT_9_CP && to.codePoint >= DIGIT_0_CP && to.codePoint <= DIGIT_9_CP) ||
          (from.codePoint >= UPPER_A_CP && from.codePoint <= UPPER_Z_CP && to.codePoint >= UPPER_A_CP && to.codePoint <= UPPER_Z_CP) ||
          (from.codePoint >= LOWER_A_CP && from.codePoint <= LOWER_Z_CP && to.codePoint >= LOWER_A_CP && to.codePoint <= LOWER_Z_CP)
        );
      }
    ...
    /***/ 92879: /***/ (module, __unused_webpack_exports, __webpack_require__) => {
      /**
       * The MIT License (MIT)
       * Copyright (c) 2017-present Dmitry Soshnikov <dmitry.soshnikov@gmail.com>
       */
    ...
    /***/ 52340: /***/ (module, __unused_webpack_exports, __webpack_require__) => {
      /**
       * The MIT License (MIT)
       * Copyright (c) 2017-present Dmitry Soshnikov <dmitry.soshnikov@gmail.com>
       */
    ...
    /***/ 44035: /***/ (module, __unused_webpack_exports, __webpack_require__) => {
      /**
       * The MIT License (MIT)
       * Copyright (c) 2017-present Dmitry Soshnikov <dmitry.soshnikov@gmail.com>
       */
    ...
    /***/ 19495: /***/ (module, __unused_webpack_exports, __webpack_require__) => {
      /**
      ...
      function decodeUnicodeGroupName(name) {
        return name.replace(
          new RegExp(uidRe, "g"),
          function (_, leadSurrogate, trailSurrogate, leadSurrogateOnly, trailSurrogateOnly, nonSurrogate, codePoint) {
            if (leadSurrogate) {
    ...
    /***/ 46418: /***/ (module, __unused_webpack_exports, __webpack_require__) => {
      /**
       * The MIT License (MIT)
       * Copyright (c) 2017-present Dmitry Soshnikov <dmitry.soshnikov@gmail.com>
       */
    ...
    /***/ 42113: /***/ (module, __unused_webpack_exports, __webpack_require__) => {
      /**
       * The MIT License (MIT)
       * Copyright (c) 2017-present Dmitry Soshnikov <dmitry.soshnikov@gmail.com>
       */
    ...
    /***/ 34862: /***/ (module, __unused_webpack_exports, __webpack_require__) => {
      /**
       * The MIT License (MIT)
       * Copyright (c) 2017-present Dmitry Soshnikov <dmitry.soshnikov@gmail.com>
       */
    ...
    /***/ 3661: /***/ (module, __unused_webpack_exports, __webpack_require__) => {
      /**
       * The MIT License (MIT)
       * Copyright (c) 2017-present Dmitry Soshnikov <dmitry.soshnikov@gmail.com>
       */
