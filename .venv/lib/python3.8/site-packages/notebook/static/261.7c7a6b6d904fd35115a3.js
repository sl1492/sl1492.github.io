...
(self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] = self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] || []).push([
  [261],
  {
    /***/ 80261: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      ...
      const merge = function (otherBranch, custom_id, override_type, custom_tag) {
        otherBranch = _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_4__.e.sanitizeText(
          otherBranch,
          (0, _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_4__.c)()
        );
        custom_id = _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_4__.e.sanitizeText(
          custom_id,
          (0, _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_4__.c)()
        );
      ...
      const cherryPick = function (sourceId, targetId, tag, parentCommitId) {
        ...
        sourceId = _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_4__.e.sanitizeText(
          sourceId,
          (0, _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_4__.c)()
        );
        targetId = _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_4__.e.sanitizeText(
          targetId,
          (0, _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_4__.c)()
        );
        tag = _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_4__.e.sanitizeText(tag, (0, _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_4__.c)());
        parentCommitId = _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_4__.e.sanitizeText(
          parentCommitId,
          (0, _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_4__.c)()
        );
      ...
      const checkout = function (branch2) {
        branch2 = _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_4__.e.sanitizeText(
          branch2,
          (0, _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_4__.c)()
        );
          ...
          if (modifyGraph) {
            ...
            if (commitSymbolType === commitType.HIGHLIGHT) {
              ...
              gBullets
                ...
                .attr("height", 12)
                .attr("width", 12)
                .attr("class", `commit ${commit2.id} commit${branchPos[commit2.branch].index % THEME_COLOR_LIMIT} ${typeClass}-inner`);
              ...
              if (commitSymbolType === commitType.REVERSE) {
                ...
                cross
                  ...
                  .attr("class", `commit ${typeClass} ${commit2.id} commit${branchPos[commit2.branch].index % THEME_COLOR_LIMIT}`);
              }
            }
          }
          if (dir === "TB") {
