...
(self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] = self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] || []).push([
  [2871],
  {
    /***/ 72871: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      ...
      function mkPython(parserConf) {
        ...
        function pushPyScope(stream, state) {
          ...
          state.scopes.push({ offset: top(state).offset + stream.indentUnit, type: "py", align: null });
        }

        function pushBracketScope(stream, state, type) {
          var align = stream.match(/^[\s\[\{\(]*(?:#|$)/, false) ? null : stream.column() + 1;
          state.scopes.push({ offset: state.indent + (hangingIndent || stream.indentUnit), type: type, align: align });
        }
        ...
        return {
          ...
          indent: function (state, textAfter, cx) {
            ...
            var scope = top(state);
            var closing =
              scope.type == textAfter.charAt(0) || (scope.type == "py" && !state.dedent && /^(else:|elif |except |finally:)/.test(textAfter));
