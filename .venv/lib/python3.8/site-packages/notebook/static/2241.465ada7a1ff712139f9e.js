...
(self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] = self["webpackChunk_JUPYTERLAB_CORE_OUTPUT"] || []).push([
  [2241],
  {
    /***/ 32241: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      ...
      const parseBoxData = function (str) {
        ...
        return {
          ...
          text:
            title !== void 0
              ? (0, _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_4__.d)(
                  title.replace(/^:?(?:no)?wrap:/, ""),
                  (0, _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_4__.c)()
                )
              : void 0,
      ...
      const addLinks = function (actorId, text) {
        ...
        try {
          let sanitizedText = (0, _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_4__.d)(
            text.text,
            (0, _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_4__.c)()
          );
...
`;
      ...
      const drawActorTypeParticipant = function (elem, actor, conf2, isFooter) {
        ...
        _drawTextCandidateFunc(conf2)(actor.description, g, rect.x, rect.y, rect.width, rect.height, { class: "actor" }, conf2);
      ...
      const drawActorTypeActor = function (elem, actor, conf2, isFooter) {
        ...
        actor.height = bounds2.height;
        _drawTextCandidateFunc(conf2)(actor.description, actElem, rect.x, rect.y + 35, rect.width, rect.height, { class: "actor" }, conf2);
        return actor.height;
      };
            ...
            line = diagram2
              ...
              .attr(
                ...
                `M  ${startx},${lineStartY} H ${
                  startx + _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_4__.e.getMax(conf.width / 2, textWidth / 2)
      ...
      const draw = function (_text, id, _version, diagObj) {
        ...
        const diagram2 =
          securityLevel === "sandbox" ? root.select(`[id="${id}"]`) : (0, d3__WEBPACK_IMPORTED_MODULE_0__ /* .select */.Ys)(`[id="${id}"]`);
        ...
        messages.forEach(function (msg) {
          if (actors[msg.to] && actors[msg.from]) {
            ...
            const wrappedMessage = msg.wrap
              ? _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_4__.u.wrapLabel(msg.message, conf.width - 2 * conf.wrapPadding, textFont)
              : msg.message;
      ...
      function calculateActorMargins(actors, actorToMessageWidth, boxes) {
        ...
        Object.keys(actors).forEach((prop) => {
          ...
          actor.width = actor.wrap
            ? conf.width
            : _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_4__.e.getMax(conf.width, actDims.width + 2 * conf.wrapPadding);
      ...
      const buildNoteModel = function (msg, actors, diagObj) {
        ...
        const noteModel = {
          width: shouldWrap
            ? conf.width
            : _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_4__.e.getMax(conf.width, textDimensions.width + 2 * conf.noteMargin),
          height: 0,
        ...
        if (msg.placement === diagObj.db.PLACEMENT.RIGHTOF) {
          noteModel.width = shouldWrap
            ? _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_4__.e.getMax(conf.width, textDimensions.width)
            : _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_4__.e.getMax(
          ...
          textDimensions = _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_4__.u.calculateTextDimensions(
            shouldWrap
              ? _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_4__.u.wrapLabel(
                  msg.message,
          ...
          noteModel.startx =
            startx < stopx ? startx + actors[msg.from].width / 2 - conf.actorMargin / 2 : stopx + actors[msg.to].width / 2 - conf.actorMargin / 2;
        }
        if (shouldWrap) {
        ...
        messages.forEach(function (msg) {
          ...
          if (isNote) {
            ...
            stack.forEach((stk) => {
              ...
              current.width =
                _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_4__.e.getMax(current.width, Math.abs(current.from - current.to)) - conf.labelBoxWidth;
            });
          } else {
            ...
            if (msgModel.startx && msgModel.stopx && stack.length > 0) {
              stack.forEach((stk) => {
                ...
                if (msgModel.startx === msgModel.stopx) {
                  ...
                  current.width =
                    _mermaid_04fb0060_js__WEBPACK_IMPORTED_MODULE_4__.e.getMax(current.width, Math.abs(current.to - current.from)) -
                    conf.labelBoxWidth;
                } else {
    ...
    /***/ 26476: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      /* harmony export */ __webpack_require__.d(__webpack_exports__, {
