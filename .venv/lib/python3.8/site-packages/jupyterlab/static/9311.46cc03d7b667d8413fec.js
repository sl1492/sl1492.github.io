...
(self["webpackChunk_jupyterlab_application_top"] = self["webpackChunk_jupyterlab_application_top"] || []).push([
  [9311],
  {
    79311: (e, t, n) => {
      ...
      for (let bt = 1, Lt; (Lt = f[bt]); bt++) {
        Q[bt] = o.NodeType.define({
          id: bt,
          name: Lt,
          props: bt >= f.Escape ? [] : [[o.NodeProp.group, bt in p ? ["Block", "BlockContext"] : ["Block", "LeafBlock"]]],
          top: Lt == "Document",
        });
      }
      const Z = [];
      ...
      const Je = Ke(Ue);
      const We = Ue.configure([Xe, $e, ze, _e, { props: [i.foldNodeProp.add({ Table: (e, t) => ({ from: t.doc.lineAt(e.from).to, to: e.to }) })] }]);
      const Ye = Ke(We);
      function et(e, t) {
        return (n) => {
          if (n && e) {
      ...
      const lt = ({ state: e, dispatch: t }) => {
        ...
        let l = null,
          o = e.changeByRange((t) => {
            if (!t.empty || !Ye.isActiveAt(e, t.from)) return (l = { range: t });
            let i = t.from,
              o = s.lineAt(i);
      ...
      function pt(e = {}) {
        let { codeLanguages: t, defaultCodeLanguage: n, addKeymap: l = true, base: { parser: o } = Je, completeHTMLTags: a = true } = e;
        ...
        let c = t || u ? et(t, u) : undefined;
        h.push(xe({ codeParser: c, htmlParser: dt.language.parser }));
        if (l) f.push(r.Prec.high(s.keymap.of(ct)));
        let d = Ke(o.configure(h));
        if (a) f.push(d.data.of({ autocomplete: gt }));
