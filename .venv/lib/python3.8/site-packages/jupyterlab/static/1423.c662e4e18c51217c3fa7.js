(self["webpackChunk_jupyterlab_application_top"] = self["webpackChunk_jupyterlab_application_top"] || []).push([
  [1423, 5606],
  {
    75128: (t, e, s) => {
      "use strict";
      s.d(e, { Ar: () => d, Bc: () => Kt, Gw: () => It, _5: () => h, et: () => u, wm: () => Ut });
      var i = s(71674);
      var n = s.n(i);
      var o = s(22819);
      var r = s.n(o);
      ...
      class E {
        constructor(t, e, s) {
          ...
          this.range = R(n.length, o, r.maxRenderedOptions);
        ...
        update(t) {
          ...
          if (s != i) {
            ...
            if (!i.open || i.open.options != n) {
              this.range = R(n.length, o, t.state.facet(T).maxRenderedOptions);
        ...
        updateSel() {
          ...
          if ((e.selected > -1 && e.selected < this.range.from) || e.selected >= this.range.to) {
            this.range = R(e.options.length, e.selected, this.view.state.facet(T).maxRenderedOptions);
      ...
      class z {
        ...
        update(t) {
          ...
          for (let r of t.effects) if (r.is(_)) o = o && o.setSelected(r.value, this.id);
      ...
      function W(t, e) {
        if (t.isUserEvent("input.complete")) {
          ...
          if (s && e.activateOnCompletion(s)) return "input";
        }
      ...
      function Q(t, e) {
        ...
        let i = t.state.field(K).active.find((t) => t.source == e.source);
      ...
      const X = D(K, Q);
      function Y(t, e = "option") {
        return (s) => {
          let i = s.state.field(K, false);
          ...
          s.dispatch({ effects: _.of(a) });
          return true;
        };
      }
      const J = (t) => {
        let e = t.state.field(K, false);
        if (
          t.state.readOnly ||
          !e ||
          !e.open ||
      ...
      const nt = o.ViewPlugin.fromClass(
        class {
          constructor(t) {
            ...
            this.composing = 0;
            for (let e of t.state.field(K).active) if (e.state == 1) this.startQuery(e);
          }
          update(t) {
            let e = t.state.field(K);
            let s = t.state.facet(T);
            if (!t.selectionSet && !t.docChanged && t.startState.field(K) == e) return;
            let i = t.transactions.some((t) => (t.selection || t.docChanged) && !W(t, s));
            for (let l = 0; l < this.running.length; l++) {
              let e = this.running[l];
              if (i || (e.updates.length + t.transactions.length > st && Date.now() - e.time > it)) {
            ...
            if (this.composing != 0)
              for (let o of t.transactions) {
                if (W(o, s) == "input") this.composing = 2;
          ...
          accept() {
            ...
            for (let i = 0; i < this.running.length; i++) {
              ...
              let o = this.view.state.field(K).active.find((t) => t.source == n.active.source);
              if (o && o.state == 1) {
                if (n.done == null) {
        ...
        },
        {
          eventHandlers: {
            blur(t) {
              let e = this.view.state.field(K, false);
      ...
      function bt(t) {
        ...
        return (t, s, n, o) => {
          ...
          if (l.some((t) => t.field > 0)) {
            ...
            if (t.state.field(gt, false) === undefined) s.push(i.StateEffect.appendConfig.of([gt, At, Ot, lt]));
          }
      ...
      const Ot = o.EditorView.domEventHandlers({
        mousedown(t, e) {
      ...
      const _t = ({ state: t, dispatch: e }) => {
        ...
        let o = null,
          r = t.changeByRange((e) => {
            if (e.empty) {
              let s = Jt(t.doc, e.head);
              for (let o of n) {
                if (o == s && Yt(t.doc, e.head) == Vt((0, i.codePointAt)(o, 0)))
      ...
      function oe(t = {}) {
        return [rt, K, T.of(t), nt, le, lt];
      }
      const re = [
        { key: "Ctrl-Space", run: Z },
        { key: "Escape", run: tt },
        { key: "ArrowDown", run: Y(true) },
        { key: "ArrowUp", run: Y(false) },
        { key: "PageDown", run: Y(true, "page") },
        { key: "PageUp", run: Y(false, "page") },
        { key: "Enter", run: J },
      ];
      const le = i.Prec.highest(o.keymap.computeN([T], (t) => (t.facet(T).defaultKeymap ? [re] : [])));
      function ae(t) {
        let e = t.field(K, false);
        return e && e.active.some((t) => t.state == 1) ? "pending" : e && e.active.some((t) => t.state != 0) ? "active" : null;
      }
      const he = new WeakMap();
      function ce(t) {
        var e;
        let s = (e = t.field(K, false)) === null || e === void 0 ? void 0 : e.open;
    ...
    27421: (t, e, s) => {
      ...
      class R extends i.Parser {
        ...
        configure(t) {
          let e = Object.assign(Object.create(R.prototype), this);
