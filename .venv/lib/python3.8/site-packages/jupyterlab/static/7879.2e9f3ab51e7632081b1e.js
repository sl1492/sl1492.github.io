  ...
  [7879],
  {
    ...
    37879: (t, e, n) => {
      ...
      function yL(t, e, n, i, r) {
        let s = typeof t === "string" ? SN(t, (r || this).context) : t;
        const a = Hc(e, n);
        let o = s.domain(),
          u = o[0],
          l = (0, p.se)(o),
        ...
        if (!(l - u)) {
          s = (
            s.interpolator ? Yl("sequential")().interpolator(s.interpolator()) : Yl("linear")().interpolate(s.interpolate()).range(s.range())
          ).domain([(u = 0), (l = 1)]);
        } else {
          c = ac(s, u, l);
        }
        if (s.ticks) {
          o = s.ticks(+i || 15);
          if (u !== o[0]) o.unshift(u);
          if (l !== (0, p.se)(o)) o.push(l);
        }
        o.forEach((t) => a.stop(c(t), s(t)));
        return a;
      }
      function vL(t, e, n) {
        const i = SN(t, (n || this).context);
