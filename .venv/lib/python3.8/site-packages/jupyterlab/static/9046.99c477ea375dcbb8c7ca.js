(self["webpackChunk_jupyterlab_application_top"] = self["webpackChunk_jupyterlab_application_top"] || []).push([
  [9046, 5606],
  {
    ...
    89046: (t, e, n) => {
      ...
      const H =
        !P("no-colors") && (!U || M.stdout.isTTY || $) && (!U || P("color") || $ || B("COLORTERM") !== null || (B("TERM") || "").includes("color"));
      ...
      const xn = (t) => (t.arr[t.pos] + (t.arr[t.pos + 1] << 8) + (t.arr[t.pos + 2] << 16) + (t.arr[t.pos + 3] << 24)) >>> 0;
      const In = (t) => {
        let e = 0;
        let n = 1;
      ...
      const Qn = typeof window === "undefined" ? null : (typeof window.performance !== "undefined" && window.performance) || null;
      ...
      class Pr {
        ...
        group(t, e = false) {
          eventloop.enqueue(() => {
            ...
            const r = dom.element("div", [pair.create("style", `${Vr};padding-left:${this.depth * 10}px`)], [n, s, dom.text(" ")].concat(Rr(t)));
        ...
        print(t) {
          eventloop.enqueue(() => {
            dom.append(this.ccontainer, [dom.element("div", [pair.create("style", `${Vr};padding-left:${this.depth * 10}px`)], Rr(t))]);
          });
        }
        printError(t) {
      ...
      const oc = (t, e) => {
        if (t.constructor === xl) {
          ...
          return new ch($i(s, r + e), null, $i(s, r + e - 1), null, n.rightOrigin, n.parent, n.parentSub, n.content.splice(e));
        }
      };
      ...
      const Cc = (t, e) => {
        ...
        const n = t._searchMarker.length === 0 ? null : t._searchMarker.reduce((t, n) => (i.tn(e - t.index) < i.tn(e - n.index) ? t : n));
        let s = t._start;
        let r = 0;
        if (n !== null) {
          s = n.p;
      ...
      const rl = (t, e, n, s) => {
        while (
          n.right !== null &&
          (n.right.deleted === true || (n.right.content.constructor === jl && tl(s.get(n.right.content.key), n.right.content.value)))
        ) {
          if (!n.right.deleted) {
      ...
      const ol = (t, e) => {
        while (true) {
          if (t.right === null) {
            break;
          } else if (t.right.deleted || (t.right.content.constructor === jl && tl(e[t.right.content.key] || null, t.right.content.value)));
          else {
            break;
          }
          t.forward();
      ...
      const hl = (t, e, n, s, r) => {
        ...
        ol(n, r);
        const c = cl(t, e, n, r);
        t: while (n.right !== null && (s > 0 || (c.size > 0 && (n.right.deleted || n.right.content.constructor === jl)))) {
          if (!n.right.deleted) {
        ...
        if (s > 0) {
          ...
          n.right = new ch($i(o, Do(i.store, o)), n.left, n.left && n.left.lastId, n.right, n.right && n.right.id, e, null, new Hl(r));
          n.right.integrate(t, 0);
          n.forward();
        }
        rl(t, e, n, c);
      ...
      const ih = (t, e, n) => {
        ...
        const i = new ch($i(s, r + n), e, $i(s, r + n - 1), e.right, e.rightOrigin, e.parent, e.parentSub, e.content.splice(n));
        if (e.deleted) {
          i.markDeleted();
        }
        if (e.keep) {
      ...
      class ch extends Al {
        ...
        write(t, e) {
          ...
          const i = (this.content.getRef() & Ft) | (n === null ? 0 : ut) | (s === null ? 0 : at) | (r === null ? 0 : ht);
          t.writeInfo(i);
          if (n !== null) {
            t.writeLeftID(n);
          }
