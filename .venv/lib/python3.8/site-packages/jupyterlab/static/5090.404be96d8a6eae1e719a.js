...
(self["webpackChunk_jupyterlab_application_top"] = self["webpackChunk_jupyterlab_application_top"] || []).push([
  [5090],
  {
    ...
    49054: (t, n, e) => {
      ...
      var c = a ? function () {} : Element.prototype.matches || Element.prototype.msMatchesSelector || Element.prototype.webkitMatchesSelector;
      var i =
      ...
      var l = function t(n, e) {
        if (n.tabIndex < 0) {
          if ((e || /^(AUDIO|VIDEO|DETAILS)$/.test(n.tagName) || n.isContentEditable) && isNaN(parseInt(n.getAttribute("tabindex"), 10))) {
            return 0;
          }
        }
        return n.tabIndex;
      ...
      var A = function t(n, e) {
        ...
        var o;
        if (e.getShadowRoot) {
          o = u([n], e.includeContainer, { filter: E.bind(null, e), flatten: false, getShadowRoot: e.getShadowRoot, shadowRootFilter: k });
        } else {
