/*! For license information please see 700.cb8755208323f2d892e7.js.LICENSE.txt */
(self["webpackChunk_jupyterlab_application_top"] = self["webpackChunk_jupyterlab_application_top"] || []).push([
  [700],
  {
    ...
    1056: (t, e, r) => {
      ...
      function m(t, e) {
        ...
        function A(u) {
          var f = i == null ? (e.ticks ? e.ticks.apply(e, r) : e.domain()) : i,
            A = n == null ? (e.tickFormat ? e.tickFormat.apply(e, r) : o) : n,
            T = Math.max(m, 0) + C,
            _ = e.range(),
            w = +_[0] + b,
            S = +_[_.length - 1] + b,
            B = (e.bandwidth ? p : d)(e.copy(), b),
            F = u.selection ? u.selection() : u,
            L = F.selectAll(".domain").data([null]),
            E = F.selectAll(".tick").data(f, e).order(),
            M = E.exit(),
          ...
          if (u !== F) {
            ...
            M = M.transition(u)
              ...
              .attr("transform", function (t) {
                return isFinite((t = B(t))) ? k(t + b) : this.getAttribute("transform");
              });
            O.attr("opacity", h).attr("transform", function (t) {
              var e = this.parentNode.__axis;
              return k((e && isFinite((e = e(t))) ? e : B(t)) + b);
            });
          }
          M.remove();
          L.attr(
            ...
            t === c || t === a
              ? y
                ? "M" + v * y + "," + w + "H" + b + "V" + S + "H" + v * y
                : "M" + b + "," + w + "V" + S
              : y
                ? "M" + w + "," + v * y + "V" + b + "H" + S + "V" + v * y
                : "M" + w + "," + b + "H" + S
          );
        ...
        A.ticks = function () {
          return (r = Array.from(arguments)), A;
        };
        A.tickArguments = function (t) {
          return arguments.length ? ((r = t == null ? [] : Array.from(t)), A) : r.slice();
        };
        A.tickValues = function (t) {
          return arguments.length ? ((i = t == null ? null : Array.from(t)), A) : i && i.slice();
        };
        A.tickFormat = function (t) {
          return arguments.length ? ((n = t), A) : n;
        };
        A.tickSize = function (t) {
          return arguments.length ? ((m = y = +t), A) : m;
        };
      ...
      function I(t) {
        return this.select(t == null ? O : M(typeof t === "function" ? t : L(t)));
      }
      ...
      function N(t) {
        return this.selectAll(t == null ? q : D(typeof t === "function" ? t : L(t)));
      }
      function j(t) {
      ...
      function P() {
        return new ye(this._enter || this._groups.map($), this._parents);
      }
      function R(t, e) {
      ...
      function X() {
        return new ye(this._exit || this._groups.map($), this._parents);
      }
      function Z(t, e, r) {
        var i = this.enter(),
          n = this,
      ...
      function wt(t, e) {
        return arguments.length > 1 ? this.each((e == null ? At : typeof e === "function" ? _t : Tt)(t, e)) : this.node()[t];
      }
      function St(t) {
      ...
      function It(t, e) {
        return function () {
          (e.apply(this, arguments) ? Lt : Et)(this, t);
        };
      }
      function zt(t, e) {
        var r = St(t + "");
        ...
        return this.each((typeof e === "function" ? It : e ? Mt : Ot)(r, e));
      }
      function qt() {
        this.textContent = "";
      }
      ...
      function jt(t) {
        return arguments.length ? this.each(t == null ? qt : (typeof t === "function" ? Nt : Dt)(t)) : this.node().textContent;
      }
      function $t() {
        this.innerHTML = "";
      }
      ...
      function Wt(t) {
        return arguments.length ? this.each(t == null ? $t : (typeof t === "function" ? Rt : Pt)(t)) : this.node().innerHTML;
      }
      function Ht() {
      ...
      function Qt(t, e) {
        var r = typeof t === "function" ? t : Zt(t),
          i = e == null ? Jt : typeof e === "function" ? e : k(e);
        return this.select(function () {
      ...
      var Te = (0, xe.A)("start", "end", "cancel", "interrupt");
      var _e = [];
      var we = 0;
      var Se = 1;
      var Be = 2;
      ...
      function Ie(t, e) {
        var r = qe(t, e);
        if (r.state > we) throw new Error("too late; already scheduled");
        return r;
      }
      function ze(t, e) {
        var r = qe(t, e);
        if (r.state > Fe) throw new Error("too late; already running");
        return r;
      }
      function qe(t, e) {
      ...
      function De(t, e, r) {
        ...
        function s(o) {
          var c, h, u, f;
          if (r.state !== Se) return l();
          for (c in i) {
            f = i[c];
            if (f.name !== r.name) continue;
            if (f.state === Fe) return Ae(s);
            if (f.state === Le) {
              f.state = Me;
              f.timer.stop();
        ...
        function a(e) {
          var i = e < r.duration ? r.ease.call(null, e / r.duration) : (r.timer.restart(l), (r.state = Ee), 1),
            o = -1,
            s = n.length;
          while (++o < s) {
            n[o].call(t, i);
      ...
      function We(t, e) {
        ...
        return this.each((e == null ? Pe : Re)(r, t, e));
      }
      function He(t, e, r) {
        var i = t._id;
        t.each(function () {
      ...
      function Xe(t, e) {
        var r;
        return (typeof e === "number" ? Ye.A : e instanceof Ue.Ay ? Ge.Ay : (r = (0, Ue.Ay)(e)) ? ((e = r), Ge.Ay) : Ve.A)(t, e);
      }
      function Ze(t) {
        return function () {
          this.removeAttribute(t);
      ...
      function rr(t, e) {
        var r = ct(t),
          i = r === "transform" ? $e.I : Xe;
        return this.attrTween(
          t,
          typeof e === "function"
            ? (r.local ? er : tr)(r, i, He(this, "attr." + t, e))
            : e == null
              ? (r.local ? Ke : Ze)(r)
              : (r.local ? Qe : Je)(r, i, e)
        );
      ...
      function Cr(t) {
        ...
        return new Gr(i, this._parents, this._name, this._id);
      }
      function br(t) {
      ...
      function Tr() {
        return this.on("end.remove", Ar(this._id));
      }
      function _r(t) {
        var e = this._name,
          r = this._id;
        ...
        for (var i = this._groups, n = i.length, o = new Array(n), s = 0; s < n; ++s) {
          for (var a = i[s], l = a.length, c = (o[s] = new Array(l)), h, u, f = 0; f < l; ++f) {
            if ((h = a[f]) && (u = t.call(h, h.__data__, f, a))) {
              ...
              c[f] = u;
              Oe(c[f], e, r, f, c, qe(h, r));
            }
          }
        }
        return new Gr(o, this._parents, e, r);
      }
      function wr(t) {
        var e = this._name,
          r = this._id;
        ...
        return new Gr(o, s, e, r);
      }
      var Sr = ve.prototype.constructor;
      function Br() {
      ...
      function Ir(t, e, r) {
        var i = (t += "") === "transform" ? $e.T : Xe;
        return e == null
          ? this.styleTween(t, Fr(t, i)).on("end.style." + t, Lr(t))
          : typeof e === "function"
            ? this.styleTween(t, Mr(t, i, He(this, "style." + t, e))).each(Or(this._id, t))
            : this.styleTween(t, Er(t, i, e), r).on("end.style." + t, null);
      }
      function zr(t, e, r) {
        return function (i) {
      ...
      function $r(t) {
        return this.tween("text", typeof t === "function" ? jr(He(this, "text", t)) : Nr(t == null ? "" : t + ""));
      }
      function Pr(t) {
        return function (e) {
      ...
      function Hr() {
        ...
        for (var i = this._groups, n = i.length, o = 0; o < n; ++o) {
          for (var s = i[o], a = s.length, l, c = 0; c < a; ++c) {
            if ((l = s[c])) {
              var h = qe(l, e);
              Oe(l, t, r, c, s, { time: h.time + h.delay + h.duration, delay: 0, duration: h.duration, ease: h.ease });
            }
          }
        }
        return new Gr(i, this._parents, t, r);
      }
      function Ur() {
        var t,
          e,
      ...
      var ti = { time: null, delay: 0, duration: 250, ease: Qr };
      function ei(t, e) {
        var r;
      ...
      function ri(t) {
        ...
        if (t instanceof Gr) {
          ...
          (e = Xr()), ((r = ti).time = (0, ke.tB)()), (t = t == null ? null : t + "");
        }
        for (var i = this._groups, n = i.length, o = 0; o < n; ++o) {
          for (var s = i[o], a = s.length, l, c = 0; c < a; ++c) {
            if ((l = s[c])) {
              Oe(l, t, e, c, s, r || ei(l, e));
            }
          }
        }
        return new Gr(i, this._parents, t, e);
      }
      ve.prototype.interrupt = je;
      ...
      function Li(t) {
        ...
        function f(e) {
          ...
          interrupt(i);
          var I = h(i, arguments, true).beforestart();
          if (o === "overlay") {
            if (p) F = true;
            const r = [O[0], O[1] || O[0]];
            f.selection = p = [
              [(m = t === di ? g : ci(r[0][0], r[1][0])), (b = t === fi ? C : ci(r[0][1], r[1][1]))],
              [(k = t === di ? x : li(r[0][0], r[1][0])), (_ = t === fi ? T : li(r[0][1], r[1][1]))],
            ];
            if (O.length > 1) j(e);
          } else {
            m = p[0][0];
          ...
          A = k;
          w = _;
          var z = select(i).attr("pointer-events", "none");
          var q = z.selectAll(".overlay").attr("cursor", gi[o]);
          if (e.touches) {
            I.moved = N;
            I.ended = $;
          } else {
            var D = select(e.view).on("mousemove.brush", N, true).on("mouseup.brush", $, true);
            if (n) D.on("keydown.brush", P, true).on("keyup.brush", R, true);
            dragDisable(e.view);
          }
          c.call(i);
          I.start(e, s.name);
          function N(t) {
            for (const e of t.changedTouches || [t]) {
              for (const t of O) if (t.identifier === e.identifier) t.cur = pointer(e, i);
            }
            if (L && !E && !M && O.length === 1) {
              const t = O[0];
              if (ai(t.cur[0] - t[0]) > ai(t.cur[1] - t[1])) M = true;
              else E = true;
            }
            for (const e of O) if (e.cur) (e[0] = e.cur[0]), (e[1] = e.cur[1]);
            F = true;
            noevent(t);
            j(t);
          }
          function j(t) {
            ...
            switch (s) {
              case ni:
              case ii: {
                if (l) (S = li(g - m, ci(x - k, S))), (y = m + S), (A = k + S);
                if (u) (B = li(C - b, ci(T - _, B))), (v = b + B), (w = _ + B);
                break;
              }
              case oi: {
                if (O[1]) {
                  if (l) (y = li(g, ci(x, O[0][0]))), (A = li(g, ci(x, O[1][0]))), (l = 1);
                  if (u) (v = li(C, ci(T, O[0][1]))), (w = li(C, ci(T, O[1][1]))), (u = 1);
                } else {
                  if (l < 0) (S = li(g - m, ci(x - m, S))), (y = m + S), (A = k);
                  else if (l > 0) (S = li(g - k, ci(x - k, S))), (y = m), (A = k + S);
                  if (u < 0) (B = li(C - b, ci(T - b, B))), (v = b + B), (w = _);
                  else if (u > 0) (B = li(C - _, ci(T - _, B))), (v = b), (w = _ + B);
                }
                break;
              }
              case si: {
                if (l) (y = li(g, ci(x, m - S * l))), (A = li(g, ci(x, k + S * l)));
                if (u) (v = li(C, ci(T, b - B * u))), (w = li(C, ci(T, _ + B * u)));
                break;
              }
            }
            if (A < y) {
            ...
            if (E) (y = p[0][0]), (A = p[1][0]);
            if (M) (v = p[0][1]), (w = p[1][1]);
            if (p[0][0] !== y || p[0][1] !== v || p[1][0] !== A || p[1][1] !== w) {
              f.selection = [
                [y, v],
                [A, w],
              ];
          ...
          function $(t) {
            ...
            if (f.selection) p = f.selection;
            if (_i(p)) (f.selection = null), c.call(i);
            I.end(t, s.name);
          }
          function P(t) {
            switch (t.keyCode) {
              ...
              case 18: {
                if (s === oi) {
                  if (l) (k = A - S * l), (m = y + S * l);
                  if (u) (_ = w - B * u), (b = v + B * u);
                  s = si;
                  j(t);
                }
                break;
      ...
      function Mi(t, e) {
        return fetch(t, e).then(Ei);
      }
      function Oi(t) {
        return (e, r) => Mi(e, r).then((e) => new DOMParser().parseFromString(e, t));
      }
      const Ii = Oi("application/xml");
      var zi = Oi("text/html");
      var qi = Oi("image/svg+xml");
      var Di = r(67360);
      var Ni = r(18312);
      var ji = r(25758);
      var $i = r(16527);
      function Pi() {
        var t = (0, $i.A)().unknown(undefined),
          e = t.domain,
          r = t.range,
          i = 0,
          n = 1,
        ...
        t.copy = function () {
          return Pi(e(), [i, n]).round(a).paddingInner(l).paddingOuter(c).align(h);
        };
        return ji.C.apply(u(), arguments);
      }
      function Ri(t) {
        var e = t.copy;
      ...
      function Wi() {
        return Ri(Pi.apply(null, arguments).paddingInner(1));
      }
      var Hi = r(20481);
      var Ui = r(74725);
      var Yi = r(58177);
      const Gi = (0, Yi.A)("4e79a7f28e2ce1575976b7b259a14fedc949af7aa1ff9da79c755fbab0ab");
      function Vi(t) {
        return typeof t === "string" ? new ye([[document.querySelector(t)]], [document.documentElement]) : new ye([[t]], me);
      }
      function Xi(t) {
        return typeof t === "string" ? new ye([document.querySelectorAll(t)], [document.documentElement]) : new ye([T(t)], me);
      }
      var Zi = r(16681);
      var Ki = r(58679);
      var Ji = r(12736);
      ...
      function nn() {
        ...
        function s(s) {
          var a,
            ...
            g = Math.min(rn.FA, Math.max(-rn.FA, n.apply(this, arguments) - p)),
            m,
        ...
        s.value = function (e) {
          return arguments.length ? ((t = typeof e === "function" ? e : (0, Qi.A)(+e)), s) : t;
        };
        ...
        s.startAngle = function (t) {
          return arguments.length ? ((i = typeof t === "function" ? t : (0, Qi.A)(+t)), s) : i;
        };
        s.endAngle = function (t) {
          return arguments.length ? ((n = typeof t === "function" ? t : (0, Qi.A)(+t)), s) : n;
        };
        s.padAngle = function (t) {
          return arguments.length ? ((o = typeof t === "function" ? t : (0, Qi.A)(+t)), s) : o;
        };
        return s;
      }
      var on = r(60075);
      ...
      var In = new On(1, 0, 0);
      zn.prototype = On.prototype;
      function zn(t) {
        while (!t.__zoom) if (!(t = t.parentNode)) return In;
        return t.__zoom;
      }
      function qn(t) {
      ...
      function Rn() {
        var t = qn,
          ...
          m = 10;
        function y(t) {
          t.property("__zoom", Nn)
            .on("wheel.zoom", T, { passive: false })
            .on("mousedown.zoom", _)
            .on("dblclick.zoom", w)
            .filter(n)
        ...
        function k(t, e, r) {
          return (!r && t.__zooming) || new A(t, e);
        }
        function A(t, r) {
          this.that = t;
          this.args = r;
    ...
    74353: function (t) {
      !(function (e, r) {
        ...
        var w = (function () {
            function m(t) {
              (this.$L = A(t.locale, null, !0)), this.parse(t), (this.$x = this.$x || t.x || {}), (this[x] = !0);
            }
            var y = m.prototype;
            return (
              (y.parse = function (t) {
                    ...
                    (function (t) {
                      switch (t) {
                        ...
                        case "d":
                          return String(e.$W);
                        case "dd":
                          return u(r.weekdaysMin, e.$W, l, 2);
                        case "ddd":
                          return u(r.weekdaysShort, e.$W, l, 3);
                        case "dddd":
                          return l[e.$W];
                        case "H":
                          return String(o);
              ...
              (y.diff = function (i, f, d) {
                var p,
                  ...
                  m = _.p(f),
                  y = T(i),
                  C = (y.utcOffset() - this.utcOffset()) * e,
                  b = this - y,
                  v = function () {
                    return _.m(g, y);
                  };
    ...
    42838: function (t) {
      (function (e, r) {
        ...
        const u = k(Array.prototype.pop);
        const f = k(Array.prototype.push);
        const d = k(String.prototype.toLowerCase);
        const p = k(String.prototype.toString);
        const g = k(String.prototype.match);
        const m = k(String.prototype.replace);
        const y = k(String.prototype.indexOf);
        const C = k(String.prototype.trim);
        const b = k(Object.prototype.hasOwnProperty);
        const v = k(RegExp.prototype.test);
        const x = A(TypeError);
        function k(t) {
          return function (e) {
        ...
        const N = o(["xlink:href", "xml:id", "xlink:title", "xml:space", "xmlns:xlink"]);
        const j = s(/\{\{[\w\W]*|[\w\W]*\}\}/gm);
        const $ = s(/<%[\w\W]*|[\w\W]*%>/gm);
        const P = s(/\${[\w\W]*}/gm);
        const R = s(/^data-[\-\w.\u00B7-\uFFFF]/);
        const W = s(/^aria-[\-\w]+$/);
        const H = s(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|sms|cid|xmpp):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i);
        const U = s(/^(?:\w+script|data):/i);
        const Y = s(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g);
        const G = s(/^html$/i);
        const V = s(/^[a-z][.\w]*(-[.\w]+)+$/i);
        var X = Object.freeze({
        ...
        function Q() {
          let e = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : K();
          const r = (t) => Q(t);
          r.version = "3.1.6";
          r.removed = [];
          if (!e || !e.document || e.document.nodeType !== Z.document) {
            r.isSupported = false;
            return r;
          }
          let { document: i } = e;
          const n = i;
          const s = n.currentScript;
          const {
            DocumentFragment: l,
          ...
          const W = A.prototype;
          const U = S(W, "cloneNode");
          const Y = S(W, "remove");
          const V = S(W, "nextSibling");
          const tt = S(W, "childNodes");
          const et = S(W, "parentNode");
          if (typeof c === "function") {
            const t = i.createElement("template");
            if (t.content && t.content.ownerDocument) {
              i = t.content.ownerDocument;
            }
          }
          let rt;
          let it = "";
          const { implementation: nt, createNodeIterator: ot, createDocumentFragment: st, getElementsByTagName: at } = i;
          const { importNode: lt } = n;
          let ct = {};
          r.isSupported = typeof t === "function" && typeof et === "function" && nt && nt.createHTMLDocument !== undefined;
          const {
            MUSTACHE_EXPR: ht,
            ERB_EXPR: ut,
            TMPLIT_EXPR: ft,
          ...
          let { IS_ALLOWED_URI: Ct } = X;
          let bt = null;
          const vt = T({}, [...B, ...F, ...L, ...M, ...I]);
          let xt = null;
          const kt = T({}, [...z, ...q, ...D, ...N]);
          let At = Object.seal(
            a(null, {
          ...
          let Yt = null;
          const Gt = T({}, ["audio", "video", "img", "source", "image", "track"]);
          let Vt = null;
          const Xt = T({}, [
            "alt",
            "class",
          ...
          const Zt = "http://www.w3.org/1998/Math/MathML";
          const Kt = "http://www.w3.org/2000/svg";
          const Jt = "http://www.w3.org/1999/xhtml";
          let Qt = Jt;
          let te = false;
          let ee = null;
          const re = T({}, [Zt, Kt, Jt], p);
          let ie = null;
          const ne = ["application/xhtml+xml", "text/html"];
          const oe = "text/html";
          let se = null;
          let ae = null;
          const le = i.createElement("form");
          ...
          const he = function t() {
            ...
            e = w(e);
            ie = ne.indexOf(e.PARSER_MEDIA_TYPE) === -1 ? oe : e.PARSER_MEDIA_TYPE;
            se = ie === "application/xhtml+xml" ? p : d;
            bt = b(e, "ALLOWED_TAGS") ? T({}, e.ALLOWED_TAGS, se) : vt;
            xt = b(e, "ALLOWED_ATTR") ? T({}, e.ALLOWED_ATTR, se) : kt;
            ee = b(e, "ALLOWED_NAMESPACES") ? T({}, e.ALLOWED_NAMESPACES, p) : re;
            Vt = b(e, "ADD_URI_SAFE_ATTR") ? T(w(Xt), e.ADD_URI_SAFE_ATTR, se) : Xt;
            Yt = b(e, "ADD_DATA_URI_TAGS") ? T(w(Gt), e.ADD_DATA_URI_TAGS, se) : Gt;
            Ht = b(e, "FORBID_CONTENTS") ? T({}, e.FORBID_CONTENTS, se) : Ut;
            Tt = b(e, "FORBID_TAGS") ? T({}, e.FORBID_TAGS, se) : {};
            _t = b(e, "FORBID_ATTR") ? T({}, e.FORBID_ATTR, se) : {};
            Wt = b(e, "USE_PROFILES") ? e.USE_PROFILES : false;
            wt = e.ALLOW_ARIA_ATTR !== false;
            St = e.ALLOW_DATA_ATTR !== false;
            Bt = e.ALLOW_UNKNOWN_PROTOCOLS || false;
            Ft = e.ALLOW_SELF_CLOSE_IN_ATTR !== false;
            Lt = e.SAFE_FOR_TEMPLATES || false;
            Et = e.SAFE_FOR_XML !== false;
            Mt = e.WHOLE_DOCUMENT || false;
            zt = e.RETURN_DOM || false;
            qt = e.RETURN_DOM_FRAGMENT || false;
            Dt = e.RETURN_TRUSTED_TYPE || false;
            It = e.FORCE_BODY || false;
            Nt = e.SANITIZE_DOM !== false;
            jt = e.SANITIZE_NAMED_PROPS || false;
            Pt = e.KEEP_CONTENT !== false;
            Rt = e.IN_PLACE || false;
            Ct = e.ALLOWED_URI_REGEXP || H;
            Qt = e.NAMESPACE || Jt;
            At = e.CUSTOM_ELEMENT_HANDLING || {};
            if (e.CUSTOM_ELEMENT_HANDLING && ce(e.CUSTOM_ELEMENT_HANDLING.tagNameCheck)) {
              At.tagNameCheck = e.CUSTOM_ELEMENT_HANDLING.tagNameCheck;
            }
            if (e.CUSTOM_ELEMENT_HANDLING && ce(e.CUSTOM_ELEMENT_HANDLING.attributeNameCheck)) {
              At.attributeNameCheck = e.CUSTOM_ELEMENT_HANDLING.attributeNameCheck;
            }
            if (e.CUSTOM_ELEMENT_HANDLING && typeof e.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements === "boolean") {
              At.allowCustomizedBuiltInElements = e.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements;
            }
            if (Lt) {
              St = false;
            }
            ...
            if (e.ADD_URI_SAFE_ATTR) {
              T(Vt, e.ADD_URI_SAFE_ATTR, se);
            }
            if (e.FORBID_CONTENTS) {
              if (Ht === Ut) {
                Ht = w(Ht);
              }
              T(Ht, e.FORBID_CONTENTS, se);
            }
            if (Pt) {
              bt["#text"] = true;
            }
            ...
            if (e.TRUSTED_TYPES_POLICY) {
              ...
              rt = e.TRUSTED_TYPES_POLICY;
              it = rt.createHTML("");
            } else {
              if (rt === undefined) {
                rt = J(R, s);
              }
              if (rt !== null && typeof it === "string") {
                it = rt.createHTML("");
              }
            }
            if (o) {
          ...
          const ue = T({}, ["mi", "mo", "mn", "ms", "mtext"]);
          const fe = T({}, ["foreignobject", "annotation-xml"]);
          const de = T({}, ["title", "style", "font", "a", "script"]);
          const pe = T({}, [...F, ...L, ...E]);
          const ge = T({}, [...M, ...O]);
          const me = function t(e) {
            let r = et(e);
            if (!r || !r.tagName) {
              r = { namespaceURI: Qt, tagName: "template" };
            }
            const i = d(e.tagName);
            const n = d(r.tagName);
            if (!ee[e.namespaceURI]) {
              return false;
            }
            if (e.namespaceURI === Kt) {
              if (r.namespaceURI === Jt) {
                return i === "svg";
              }
              if (r.namespaceURI === Zt) {
                return i === "svg" && (n === "annotation-xml" || ue[n]);
              }
              return Boolean(pe[i]);
            }
            if (e.namespaceURI === Zt) {
              if (r.namespaceURI === Jt) {
                return i === "math";
              }
              if (r.namespaceURI === Kt) {
                return i === "math" && fe[n];
              }
              return Boolean(ge[i]);
            }
            if (e.namespaceURI === Jt) {
              if (r.namespaceURI === Kt && !fe[n]) {
                return false;
              }
              if (r.namespaceURI === Zt && !ue[n]) {
                return false;
              }
              return !ge[i] && (de[i] || !pe[i]);
            }
          ...
          const be = function t(e) {
            ...
            if (ie === "application/xhtml+xml" && Qt === Jt) {
              e = '<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>' + e + "</body></html>";
            }
            const o = rt ? rt.createHTML(e) : e;
            if (Qt === Jt) {
              try {
                r = new P().parseFromString(o, ie);
              } catch (a) {}
            }
            if (!r || !r.documentElement) {
              r = nt.createDocument(Qt, "template", null);
              try {
                r.documentElement.innerHTML = te ? it : o;
              } catch (a) {}
            }
            const s = r.body || r.documentElement;
            if (e && n) {
              s.insertBefore(i.createTextNode(n), s.childNodes[0] || null);
            }
            if (Qt === Jt) {
              return at.call(r, Mt ? "html" : "body")[0];
            }
            return Mt ? r.documentElement : s;
          };
          ...
          const Te = function t(e) {
            let i = null;
            Ae("beforeSanitizeElements", e, null);
            if (xe(e)) {
              ye(e);
              return true;
            }
            const n = se(e.nodeName);
            Ae("uponSanitizeElement", e, { tagName: n, allowedTags: bt });
            if (e.hasChildNodes() && !ke(e.firstElementChild) && v(/<[/\w]/g, e.innerHTML) && v(/<[/\w]/g, e.textContent)) {
              ye(e);
              return true;
            }
            ...
            if (Et && e.nodeType === Z.comment && v(/<[/\w]/g, e.data)) {
              ye(e);
              return true;
            }
            if (!bt[n] || Tt[n]) {
              if (!Tt[n] && we(n)) {
                if (At.tagNameCheck instanceof RegExp && v(At.tagNameCheck, n)) {
                  return false;
                }
                if (At.tagNameCheck instanceof Function && At.tagNameCheck(n)) {
                  return false;
                }
              }
              if (Pt && !Ht[n]) {
                const t = et(e) || e.parentNode;
                const r = tt(e) || e.childNodes;
                if (r && t) {
                  const i = r.length;
                  for (let n = i - 1; n >= 0; --n) {
                    const i = U(r[n], true);
            ...
            if (e instanceof A && !me(e)) {
              ye(e);
              return true;
            }
            if ((n === "noscript" || n === "noembed" || n === "noframes") && v(/<\/no(script|embed|frames)/i, e.innerHTML)) {
              ye(e);
              return true;
            }
            if (Lt && e.nodeType === Z.text) {
              i = e.textContent;
              h([ht, ut, ft], (t) => {
                i = m(i, t, " ");
              });
          ...
          const _e = function t(e, r, n) {
            if (Nt && (r === "id" || r === "name") && (n in i || n in le)) {
              return false;
            }
            if (St && !_t[r] && v(dt, r));
            else if (wt && v(pt, r));
              ...
              if (
                (we(e) &&
                  ((At.tagNameCheck instanceof RegExp && v(At.tagNameCheck, e)) || (At.tagNameCheck instanceof Function && At.tagNameCheck(e))) &&
                  ((At.attributeNameCheck instanceof RegExp && v(At.attributeNameCheck, r)) ||
                    (At.attributeNameCheck instanceof Function && At.attributeNameCheck(r)))) ||
                (r === "is" &&
                  At.allowCustomizedBuiltInElements &&
                  ((At.tagNameCheck instanceof RegExp && v(At.tagNameCheck, n)) || (At.tagNameCheck instanceof Function && At.tagNameCheck(n))))
              );
              else {
                return false;
              }
            ...
            else if ((r === "src" || r === "xlink:href" || r === "href") && e !== "script" && y(n, "data:") === 0 && Yt[e]);
            else if (Bt && !v(gt, m(n, mt, "")));
            else if (n) {
              return false;
            } else;
            return true;
          ...
          const we = function t(e) {
            return e !== "annotation-xml" && g(e, yt);
          };
          const Se = function t(e) {
            ...
            const n = { attrName: "", attrValue: "", keepAttr: true, allowedAttributes: xt };
            let o = i.length;
            while (o--) {
              const t = i[o];
              const { name: a, namespaceURI: l, value: c } = t;
              const f = se(a);
              let d = a === "value" ? c : C(c);
              n.attrName = f;
              n.attrValue = d;
              ...
              Ae("uponSanitizeAttribute", e, n);
              d = n.attrValue;
              if (Et && v(/((--!?|])>)|<\/(style|title)/i, d)) {
                Ce(a, e);
                continue;
              }
              if (n.forceKeepAttr) {
              ...
              if (rt && typeof R === "object" && typeof R.getAttributeType === "function") {
                if (l);
                else {
                  switch (R.getAttributeType(p, f)) {
                    case "TrustedHTML": {
                      d = rt.createHTML(d);
                      break;
                    }
                    case "TrustedScriptURL": {
                      d = rt.createScriptURL(d);
                      break;
                    }
                  }
                }
          ...
          const Be = function t(e) {
            let r = null;
            const i = ve(e);
            Ae("beforeSanitizeShadowDOM", e, null);
            while ((r = i.nextNode())) {
              Ae("uponSanitizeShadowNode", r, null);
              if (Te(r)) {
                continue;
              }
              if (r.content instanceof l) {
                t(r.content);
              }
              Se(r);
            }
          ...
          r.sanitize = function (t) {
            ...
            if (Rt) {
              ...
              i = be("\x3c!----\x3e");
              o = i.ownerDocument.importNode(t, true);
              if (o.nodeType === Z.element && o.nodeName === "BODY") {
                i = o;
              ...
              if (!zt && !Lt && !Mt && t.indexOf("<") === -1) {
                return rt && Dt ? rt.createHTML(t) : t;
              }
              i = be(t);
              if (!i) {
                return zt ? null : Dt ? it : "";
              }
            }
            if (i && It) {
              ye(i.firstChild);
            ...
            if (zt) {
              ...
              if (xt.shadowroot || xt.shadowrootmode) {
                a = lt.call(n, a, true);
              }
              return a;
            }
            let u = Mt ? i.outerHTML : i.innerHTML;
            if (
              Mt &&
              bt["!doctype"] &&
              i.ownerDocument &&
              ...
              v(G, i.ownerDocument.doctype.name)
            ) {
            ...
            return rt && Dt ? rt.createHTML(u) : u;
          };
    ...
    25e3: (t, e, r) => {
      ...
      class a {
        ...
        _ensureHSL() {
          ...
          if (n === undefined) t.l = i.A.channel.rgb2hsl(t, "l");
        }
        _ensureRGB() {
          const t = this.data;
          const { r: e, g: r, b: n } = t;
          ...
          if (n === undefined) t.b = i.A.channel.hsl2rgb(t, "b");
        }
        get r() {
          const t = this.data;
          const e = t.r;
          if (!this.type.is(n.Z.HSL) && e !== undefined) return e;
          this._ensureHSL();
        ...
        get h() {
          const t = this.data;
          const e = t.h;
          if (!this.type.is(n.Z.RGB) && e !== undefined) return e;
          this._ensureRGB();
    ...
    63221: (t, e, r) => {
      ...
      const o = {
        ...
        stringify: (t) => {
          ...
          if (o < 1) {
            return `#${n.Y[Math.round(e)]}${n.Y[Math.round(r)]}${n.Y[Math.round(i)]}${n.Y[Math.round(o * 255)]}`;
          } else {
            return `#${n.Y[Math.round(e)]}${n.Y[Math.round(r)]}${n.Y[Math.round(i)]}`;
          }
        },
      };
      const s = o;
      ...
      const l = {
        ...
        _hue2deg: (t) => {
          ...
          if (e) {
            ...
            switch (r) {
              case "grad":
                return a.A.channel.clamp.h(parseFloat(t) * 0.9);
              case "rad":
                return a.A.channel.clamp.h((parseFloat(t) * 180) / Math.PI);
              case "turn":
                return a.A.channel.clamp.h(parseFloat(t) * 360);
            }
          }
          return a.A.channel.clamp.h(parseFloat(t));
        },
        parse: (t) => {
          ...
          return i.A.set(
            {
              h: l._hue2deg(n),
              s: a.A.channel.clamp.s(parseFloat(o)),
              l: a.A.channel.clamp.l(parseFloat(s)),
              a: c ? a.A.channel.clamp.a(h ? parseFloat(c) / 100 : parseFloat(c)) : 1,
            },
            t
          );
        },
        stringify: (t) => {
          ...
          if (n < 1) {
            return `hsla(${a.A.lang.round(e)}, ${a.A.lang.round(r)}%, ${a.A.lang.round(i)}%, ${n})`;
          } else {
            return `hsl(${a.A.lang.round(e)}, ${a.A.lang.round(r)}%, ${a.A.lang.round(i)}%)`;
          }
        },
      };
      const c = l;
      ...
      const f = {
        ...
        parse: (t) => {
          ...
          return i.A.set(
            {
              r: a.A.channel.clamp.r(o ? parseFloat(n) * 2.55 : parseFloat(n)),
              g: a.A.channel.clamp.g(l ? parseFloat(s) * 2.55 : parseFloat(s)),
              b: a.A.channel.clamp.b(h ? parseFloat(c) * 2.55 : parseFloat(c)),
              a: u ? a.A.channel.clamp.a(d ? parseFloat(u) / 100 : parseFloat(u)) : 1,
            },
            t
          );
        },
        stringify: (t) => {
          ...
          if (n < 1) {
            return `rgba(${a.A.lang.round(e)}, ${a.A.lang.round(r)}, ${a.A.lang.round(i)}, ${a.A.lang.round(n)})`;
          } else {
            return `rgb(${a.A.lang.round(e)}, ${a.A.lang.round(r)}, ${a.A.lang.round(i)})`;
          }
        },
      };
      const d = f;
      const p = {
        ...
        stringify: (t) => {
          ...
          if (t.type.is(n.Z.HSL) || t.data.r === undefined) {
    ...
    59773: (t, e, r) => {
      ...
      var i = r(57991);
      const n = {};
      for (let s = 0; s <= 255; s++) n[s] = i.A.unit.dec2hex(s);
    ...
    42198: (t, e, r) => {
      ...
      const o = (t, e, r) => {
        const o = n.A.parse(t);
        const s = o[e];
        const a = i.A.channel.clamp[e](s + r);
        if (s !== a) o[e] = a;
        return n.A.stringify(o);
      };
      const s = o;
    },
    69745: (t, e, r) => {
    ...
    63170: (t, e, r) => {
      ...
      var n = r(63221);
      const o = (t) => {
        const { r: e, g: r, b: o } = n.A.parse(t);
        const s = 0.2126 * i.A.channel.toLinear(e) + 0.7152 * i.A.channel.toLinear(r) + 0.0722 * i.A.channel.toLinear(o);
        return i.A.lang.round(s);
      };
      const s = o;
      const a = (t) => s(t) >= 0.5;
      const l = a;
    ...
    3635: (t, e, r) => {
      ...
      var s = r(69745);
      const a = (t, e, r = 0, a = 1) => {
        if (typeof t !== "number") return (0, s.A)(t, { a: e });
        const l = n.A.set({ r: i.A.channel.clamp.r(t), g: i.A.channel.clamp.g(e), b: i.A.channel.clamp.b(r), a: i.A.channel.clamp.a(a) });
        return o.A.stringify(l);
      };
      const l = a;
    },
    57991: (t, e, r) => {
    ...
    9883: (t, e, r) => {
      ...
      function w() {
        this.size = 0;
        this.__data__ = { hash: new A(), map: new (_.A || T.A)(), string: new A() };
      }
      const S = w;
      function B(t) {
        var e = typeof t;
      ...
      function L(t, e) {
        var r = t.__data__;
        return F(e) ? r[typeof e == "string" ? "string" : "hash"] : r.map;
      }
      const E = L;
      function M(t) {
    ...
    16542: (t, e, r) => {
      ...
      function a(t, e, r) {
        var o = t[e];
        if (!(s.call(t, e) && (0, n.A)(o, r)) || (r === undefined && !(e in t))) {
          (0, i.A)(t, e, r);
        }
      }
      const l = a;
    ...
    64128: (t, e, r) => {
      ...
      var s = n.toString;
      var a = i.A ? i.A.toStringTag : undefined;
      function l(t) {
        var e = o.call(t, a),
          r = t[a];
        try {
    ...
    30568: (t, e, r) => {
      ...
      var i = r(690);
      var n = r(24630);
      var o = (0, n.A)(Object.keys, Object);
      const s = o;
    ...
    86848: (t, e, r) => {
      ...
      r.d(e, { A: () => o });
      var i = r(24630);
      var n = (0, i.A)(Object.getPrototypeOf, Object);
      const o = n;
    },
    88753: (t, e, r) => {
      "use strict";
      ...
      var i = r(39023);
      var n = r(24606);
      var o = (0, i.A)(n.A, "DataView");
      const s = o;
      var a = r(51482);
      var l = (0, i.A)(n.A, "Promise");
      const c = l;
      var h = r(88224);
      var u = (0, i.A)(n.A, "WeakMap");
      const f = u;
      var d = r(64128);
      var p = r(62210);
      var g = "[object Map]",
    ...
    92768: (t, e, r) => {
      ...
      var l = r(690);
      function c(t) {
        return typeof t.constructor == "function" && !(0, l.A)(t) ? s((0, a.A)(t)) : {};
      }
      const h = c;
    },
    78912: (t, e, r) => {
    ...
    31943: (t, e, r) => {
      ...
      function a(t, e, r) {
        ...
        var a = typeof e;
        if (a == "number" ? (0, n.A)(r) && (0, o.A)(e, r.length) : a == "string" && e in r) {
          return (0, i.A)(r[e], t);
        }
        return false;
      }
    ...
    24606: (t, e, r) => {
      ...
      var o = i.A || n || Function("return this")();
      const s = o;
    },
    4596: (t, e, r) => {
      "use strict";
      ...
      var s = !n.A
        ? o.A
        : function (t, e) {
            return (0, n.A)(t, "toString", { configurable: true, enumerable: false, value: (0, i.A)(e), writable: true });
          };
      const a = s;
      var l = 800,
        c = 16;
    ...
    71528: (t, e, r) => {
      ...
      var u = a(
        ...
        ? a
        : function (t) {
            return (0, n.A)(t) && c.call(t, "callee") && !h.call(t, "callee");
          };
      const f = u;
    },
    39990: (t, e, r) => {
    ...
    21585: (t, e, r) => {
      ...
      var n = r(43627);
      function o(t) {
        return t != null && (0, n.A)(t.length) && !(0, i.A)(t);
      }
      const s = o;
    },
    10654: (t, e, r) => {
    ...
    74650: (t, e, r) => {
      ...
      function g(t) {
        ...
        if ((0, a.A)(t) && ((0, s.A)(t) || typeof t == "string" || typeof t.splice == "function" || (0, l.A)(t) || (0, h.A)(t) || (0, o.A)(t))) {
          return !t.length;
        }
        var e = (0, n.A)(t);
        if (e == u || e == f) {
    ...
    82818: (t, e, r) => {
      ...
      var L = {};
      L[x] = L[k] = L[A] = L[T] = L[_] = L[w] = L[S] = L[B] = L[F] = true;
      L[s] = L[a] = L[b] = L[l] = L[v] = L[c] = L[h] = L[u] = L[f] = L[d] = L[p] = L[g] = L[m] = L[y] = L[C] = false;
      function E(t) {
        return (0, o.A)(t) && (0, n.A)(t.length) && !!L[(0, i.A)(t)];
      }
      const M = E;
      var O = r(26132);
      var I = r(89986);
      var z = I.A && I.A.isTypedArray;
      var q = z ? (0, O.A)(z) : M;
      const D = q;
    },
    13839: (t, e, r) => {
      ...
      var f = r(21585);
      function d(t) {
        return (0, f.A)(t) ? (0, i.A)(t, true) : u(t);
      }
      const p = d;
    },
    307: (t, e, r) => {
    ...
    23156: (t, e, r) => {
      ...
      var o = r(24461);
      function s(t, e, r) {
        if ((r !== undefined && !(0, o.A)(t[e], r)) || (r === undefined && !(e in t))) {
          (0, n.A)(t, e, r);
        }
      }
      const a = s;
      ...
      function S(t, e, r, i, n, o, s) {
        ...
        var T = o ? o(l, x, r + "", t, e, s) : undefined;
        var _ = T === undefined;
        if (_) {
          var S = (0, p.A)(x),
            B = !S && (0, m.A)(x),
          ...
          } else if ((0, b.A)(x) || (0, d.A)(x)) {
            T = l;
            if ((0, d.A)(l)) {
              T = w(l);
            } else if (!(0, C.A)(l) || (0, y.A)(l)) {
              T = (0, f.A)(x);
            }
          } else {
            _ = false;
    ...
    76235: (t, e, r) => {
      ...
      var p = r(3635);
      const g = (t, e, r = 50) => {
        const { r: i, g: n, b: o, a: s } = h.A.parse(t);
        const { r: a, g: l, b: c, a: u } = h.A.parse(e);
        const f = r / 100;
        const d = f * 2 - 1;
        const g = s - u;
      ...
      function ot(t, e, r, i) {
        ...
        return Q((r = nt(t.children, i))) ? (t.return = t.value + "{" + r + "}") : "";
      }
      var st = 1;
      var at = 1;
      var lt = 0;
      ...
      function kt(t) {
        return (st = at = 1), (lt = Q((ut = t))), (ct = 0), [];
      }
      function At(t) {
        return (ut = ""), t;
      }
      function Tt(t) {
        return G(vt(ct - 1, Ft(t === 91 ? t + 2 : t === 40 ? t + 1 : t)));
      }
      function _t(t) {
        return At(St(kt(t)));
      }
      ...
      function Mt(t) {
        return At(Ot("", null, null, null, [""], (t = kt(t)), 0, [0], t));
      }
      function Ot(t, e, r, i, n, o, s, a, l) {
        var c = 0;
        var h = 0;
        var u = s;
        var f = 0;
          ...
          switch (((p = C), (C = yt()))) {
            ...
            case 0:
              switch (C) {
                ...
                case 59 + h:
                  if (y == -1) A = X(A, /\f/g, "");
                  if (d > 0 && Q(A) - u) et(d > 32 ? qt(A + ";", i, r, u - 1, l) : qt(X(A, " ", "") + ";", i, r, u - 2, l), l);
                  break;
                case 59:
                  A += ";";
                default:
                  et((k = It(A, e, r, c, h, n, a, b, (v = []), (x = []), u, o)), o);
                  if (C === 123)
                    if (h === 0) Ot(A, e, k, k, v, o, u, a, x);
                    else
                      switch (f === 99 && K(A, 3) === 110 ? 100 : f) {
                        case 100:
                        case 108:
                        case 109:
                        case 115:
                          Ot(t, k, k, i && et(It(t, k, k, 0, 0, n, a, b, n, (v = []), u, x), x), n, x, u, a, i ? v : x);
                          break;
                        default:
                          Ot(A, k, k, k, [""], x, 0, a, x);
                      }
              }
              (c = h = d = 0), (g = y = 1), (b = A = ""), (u = s);
              break;
            case 58:
              (u = 1 + Q(A)), (d = p);
            default:
      ...
      function It(t, e, r, i, n, o, s, a, l, c, h, u) {
        var f = n - 1;
        var d = n === 0 ? o : [""];
        var p = tt(d);
        for (var g = 0, m = 0, y = 0; g < i; ++g)
          for (var C = 0, b = J(t, f + 1, (f = W((m = s[g])))), v = t; C < p; ++C)
            if ((v = G(m > 0 ? d[C] + " " + b : X(b, /&\f/g, d[C])))) l[y++] = v;
        return ft(t, e, r, n === 0 ? B : a, l, c, h, u);
      }
      function zt(t, e, r, i) {
        return ft(t, e, r, S, H(gt()), J(t, 2, -2), 0, i);
      }
      function qt(t, e, r, i, n) {
        return ft(t, e, r, F, J(t, 0, i), J(t, i + 1, -1), i, n);
      }
      var Dt = r(74650);
      const Nt = { trace: 0, debug: 1, info: 2, warn: 3, error: 4, fatal: 5 };
      const jt = { trace: (...t) => {}, debug: (...t) => {}, info: (...t) => {}, warn: (...t) => {}, error: (...t) => {}, fatal: (...t) => {} };
      const $t = function (t = "fatal") {
        let e = Nt.fatal;
        if (typeof t === "string") {
          t = t.toLowerCase();
          if (t in Nt) {
        ...
        jt.fatal = () => {};
        if (e <= Nt.fatal) {
          jt.fatal = console.error ? console.error.bind(console, Pt("FATAL"), "color: orange") : console.log.bind(console, "[35m", Pt("FATAL"));
        }
        if (e <= Nt.error) {
          jt.error = console.error ? console.error.bind(console, Pt("ERROR"), "color: orange") : console.log.bind(console, "[31m", Pt("ERROR"));
        }
        if (e <= Nt.warn) {
          jt.warn = console.warn ? console.warn.bind(console, Pt("WARN"), "color: orange") : console.log.bind(console, `[33m`, Pt("WARN"));
        }
        if (e <= Nt.info) {
          jt.info = console.info ? console.info.bind(console, Pt("INFO"), "color: lightblue") : console.log.bind(console, "[34m", Pt("INFO"));
        }
        if (e <= Nt.debug) {
          jt.debug = console.debug ? console.debug.bind(console, Pt("DEBUG"), "color: lightgreen") : console.log.bind(console, "[32m", Pt("DEBUG"));
        }
        if (e <= Nt.trace) {
          jt.trace = console.debug ? console.debug.bind(console, Pt("TRACE"), "color: lightgreen") : console.log.bind(console, "[32m", Pt("TRACE"));
        }
      };
      const Pt = (t) => {
      ...
      const Yt = (t, e) => {
        ...
        if (e.dompurifyConfig) {
          t = c().sanitize(Ut(t, e), e.dompurifyConfig).toString();
        } else {
          t = c()
            .sanitize(Ut(t, e), { FORBID_TAGS: ["style"] })
            .toString();
        }
        return t;
      };
      ...
      const Vt = (t) => Rt.test(t);
      const Xt = (t) => t.split(Rt);
      const Zt = (t) => t.replace(/#br#/g, "<br/>");
      const Kt = (t) => t.replace(Rt, "#br#");
      const Jt = (t) => {
        let e = "";
        if (t) {
      ...
      const Qt = (t) => (t === false || ["false", "null", "0"].includes(String(t).trim().toLowerCase()) ? false : true);
      const te = function (...t) {
      ...
      let he = class t {
        ...
        updateColors() {
          ...
          this.edgeLabelBackground = this.edgeLabelBackground || (this.darkMode ? (0, b.A)(this.secondaryColor, 30) : this.secondaryColor);
          ...
          this.activationBorderColor = this.activationBorderColor || (0, b.A)(this.secondaryColor, 10);
          ...
          this.activeTaskBkgColor = this.activeTaskBkgColor || (0, v.A)(this.primaryColor, 23);
          ...
          if (this.darkMode) {
            for (let t = 0; t < this.THEME_COLOR_LIMIT; t++) {
              this["cScale" + t] = (0, b.A)(this["cScale" + t], 75);
            }
          } else {
            for (let t = 0; t < this.THEME_COLOR_LIMIT; t++) {
              this["cScale" + t] = (0, b.A)(this["cScale" + t], 25);
            }
          }
          ...
          for (let f = 0; f < this.THEME_COLOR_LIMIT; f++) {
            if (this.darkMode) {
              this["cScalePeer" + f] = this["cScalePeer" + f] || (0, v.A)(this["cScale" + f], 10);
            } else {
              this["cScalePeer" + f] = this["cScalePeer" + f] || (0, b.A)(this["cScale" + f], 10);
            }
          }
          ...
          this.quadrantPointFill =
            this.quadrantPointFill || (0, x.A)(this.quadrant1Fill) ? (0, v.A)(this.quadrant1Fill) : (0, b.A)(this.quadrant1Fill);
          ...
          this.relationLabelBackground = this.relationLabelBackground || (this.darkMode ? (0, b.A)(this.secondaryColor, 30) : this.secondaryColor);
          ...
          if (this.darkMode) {
            this.git0 = (0, v.A)(this.git0, 25);
            this.git1 = (0, v.A)(this.git1, 25);
            this.git2 = (0, v.A)(this.git2, 25);
            this.git3 = (0, v.A)(this.git3, 25);
            this.git4 = (0, v.A)(this.git4, 25);
            this.git5 = (0, v.A)(this.git5, 25);
            this.git6 = (0, v.A)(this.git6, 25);
            this.git7 = (0, v.A)(this.git7, 25);
          } else {
            this.git0 = (0, b.A)(this.git0, 25);
            this.git1 = (0, b.A)(this.git1, 25);
            this.git2 = (0, b.A)(this.git2, 25);
            this.git3 = (0, b.A)(this.git3, 25);
            this.git4 = (0, b.A)(this.git4, 25);
            this.git5 = (0, b.A)(this.git5, 25);
            this.git6 = (0, b.A)(this.git6, 25);
            this.git7 = (0, b.A)(this.git7, 25);
          }
      ...
      let fe = class t {
        constructor() {
          ...
          this.secondaryColor = (0, v.A)(this.primaryColor, 16);
          ...
          this.darkTextColor = (0, v.A)(C("#323D47"), 10);
          this.lineColor = "calculated";
          this.border1 = "#81B1DB";
          this.border2 = (0, p.A)(255, 255, 255, 0.25);
          ...
          this.sectionBkgColor = (0, b.A)("#EAE8D9", 30);
          this.altSectionBkgColor = "calculated";
          this.sectionBkgColor2 = "#EAE8D9";
          this.excludeBkgColor = (0, b.A)(this.sectionBkgColor, 10);
          this.taskBorderColor = (0, p.A)(255, 255, 255, 70);
          this.taskBkgColor = "calculated";
          this.taskTextColor = "calculated";
          this.taskTextLightColor = "calculated";
          this.taskTextOutsideColor = "calculated";
          this.taskTextClickableColor = "#003163";
          this.activeTaskBorderColor = (0, p.A)(255, 255, 255, 50);
        ...
        updateColors() {
          var t, e, r, i, n, o, s, a, l, c, h;
          this.secondBkg = (0, v.A)(this.mainBkg, 16);
          ...
          this.edgeLabelBackground = (0, v.A)(this.labelBackground, 25);
          ...
          this.taskBkgColor = (0, v.A)(this.mainBkg, 23);
          ...
          for (let u = 0; u < this.THEME_COLOR_LIMIT; u++) {
            this["cScalePeer" + u] = this["cScalePeer" + u] || (0, v.A)(this["cScale" + u], 10);
          }
          for (let u = 0; u < 5; u++) {
          ...
          this.relationLabelBackground = this.relationLabelBackground || (this.darkMode ? (0, b.A)(this.secondaryColor, 30) : this.secondaryColor);
          this.relationLabelColor = this.relationLabelColor || this.actorTextColor;
          this.git0 = (0, v.A)(this.secondaryColor, 20);
          this.git1 = (0, v.A)(this.pie2 || this.secondaryColor, 20);
          this.git2 = (0, v.A)(this.pie3 || this.tertiaryColor, 20);
          this.git3 = (0, v.A)(this.pie4 || d(this.primaryColor, { h: -30 }), 20);
          this.git4 = (0, v.A)(this.pie5 || d(this.primaryColor, { h: -60 }), 20);
          this.git5 = (0, v.A)(this.pie6 || d(this.primaryColor, { h: -90 }), 10);
          this.git6 = (0, v.A)(this.pie7 || d(this.primaryColor, { h: 60 }), 10);
          this.git7 = (0, v.A)(this.pie8 || d(this.primaryColor, { h: 120 }), 20);
          this.gitInv0 = this.gitInv0 || C(this.git0);
          this.gitInv1 = this.gitInv1 || C(this.git1);
          this.gitInv2 = this.gitInv2 || C(this.git2);
          this.gitInv3 = this.gitInv3 || C(this.git3);
          ...
          this.commitLabelBackground = this.commitLabelBackground || this.secondaryColor;
          this.commitLabelFontSize = this.commitLabelFontSize || "10px";
          this.attributeBackgroundColorOdd = this.attributeBackgroundColorOdd || (0, v.A)(this.background, 12);
          this.attributeBackgroundColorEven = this.attributeBackgroundColorEven || (0, v.A)(this.background, 2);
        }
        calculate(t) {
          if (typeof t !== "object") {
            this.updateColors();
      ...
      let pe = class t {
        constructor() {
          ...
          this.sectionBkgColor = (0, p.A)(102, 102, 255, 0.49);
        ...
        updateColors() {
          ...
          this.cScale10 = this.cScale10 || d(this.primaryColor, { h: 300 });
          this.cScale11 = this.cScale11 || d(this.primaryColor, { h: 330 });
          this["cScalePeer1"] = this["cScalePeer1"] || (0, b.A)(this.secondaryColor, 45);
          this["cScalePeer2"] = this["cScalePeer2"] || (0, b.A)(this.tertiaryColor, 40);
          for (let u = 0; u < this.THEME_COLOR_LIMIT; u++) {
            this["cScale" + u] = (0, b.A)(this["cScale" + u], 10);
            this["cScalePeer" + u] = this["cScalePeer" + u] || (0, b.A)(this["cScale" + u], 25);
          }
          for (let u = 0; u < this.THEME_COLOR_LIMIT; u++) {
          ...
          this.actorBorder = (0, v.A)(this.border1, 23);
          this.actorBkg = this.mainBkg;
          this.labelBoxBkgColor = this.actorBkg;
          ...
          this.gitInv0 = this.gitInv0 || (0, b.A)(C(this.git0), 25);
          this.gitInv1 = this.gitInv1 || C(this.git1);
          this.gitInv2 = this.gitInv2 || C(this.git2);
          this.gitInv3 = this.gitInv3 || C(this.git3);
          this.gitInv4 = this.gitInv4 || C(this.git4);
      ...
      let me = class t {
        constructor() {
          ...
          this.fontFamily = '"trebuchet ms", verdana, arial, sans-serif';
          this.fontSize = "16px";
          this.tertiaryColor = (0, v.A)("#cde498", 10);
          this.primaryBorderColor = ae(this.primaryColor, this.darkMode);
          this.secondaryBorderColor = ae(this.secondaryColor, this.darkMode);
          this.tertiaryBorderColor = ae(this.tertiaryColor, this.darkMode);
          this.primaryTextColor = C(this.primaryColor);
        ...
        updateColors() {
          var t, e, r, i, n, o, s, a, l, c, h;
          this.actorBorder = (0, b.A)(this.mainBkg, 20);
          this.actorBkg = this.mainBkg;
          this.labelBoxBkgColor = this.actorBkg;
          this.labelTextColor = this.actorTextColor;
          this.loopTextColor = this.actorTextColor;
      ...
      class Ce {
        constructor() {
          ...
          this.secondaryColor = (0, v.A)(this.contrast, 55);
        ...
        updateColors() {
          var t, e, r, i, n, o, s, a, l, c, h;
          this.secondBkg = (0, v.A)(this.contrast, 55);
          ...
          for (let u = 0; u < this.THEME_COLOR_LIMIT; u++) {
            if (this.darkMode) {
              ...
              this["cScalePeer" + u] = this["cScalePeer" + u] || (0, b.A)(this["cScale" + u], 10);
            }
          }
          this.scaleLabelColor = this.scaleLabelColor || (this.darkMode ? "black" : this.labelTextColor);
          ...
          this.sectionBkgColor = (0, v.A)(this.contrast, 30);
          this.sectionBkgColor2 = (0, v.A)(this.contrast, 30);
          this.taskBorderColor = (0, b.A)(this.contrast, 10);
          ...
          this.activeTaskBorderColor = this.taskBorderColor;
          this.activeTaskBkgColor = this.mainBkg;
          this.gridColor = (0, v.A)(this.border1, 30);
          this.doneTaskBkgColor = this.done;
          this.doneTaskBorderColor = this.lineColor;
          this.critBkgColor = this.critical;
          this.critBorderColor = (0, b.A)(this.critBkgColor, 10);
          ...
          this.relationLabelBackground = this.relationLabelBackground || this.edgeLabelBackground;
          this.relationLabelColor = this.relationLabelColor || this.actorTextColor;
          this.git0 = (0, b.A)(this.pie1, 25) || this.primaryColor;
      ...
      const Te = new Set(Ae(ke, ""));
      const _e = ke;
      const we = (t) => {
        jt.debug("sanitizeDirective called with", t);
        ...
        for (const e of Object.keys(t)) {
          jt.debug("Checking key", e);
          if (e.startsWith("__") || e.includes("proto") || e.includes("constr") || !Te.has(e) || t[e] == null) {
            jt.debug("sanitize deleting key: ", e);
            delete t[e];
            continue;
          }
          if (typeof t[e] === "object") {
            jt.debug("sanitizing object", e);
            we(t[e]);
            continue;
          }
          ...
          for (const i of r) {
            if (e.includes(i)) {
              jt.debug("sanitizing css option", e);
              t[e] = Se(t[e]);
            }
          }
        }
      ...
      const Oe = function (t, e) {
        t = t.replace(Be, "").replace(Fe, "").replace(Le, "\n");
        for (const [r, { detector: i }] of Object.entries(Me)) {
          const n = i(t, e);
          if (n) {
            return r;
          }
        }
        throw new Ee(`No diagram type detected matching given configuration for text: ${t}`);
      };
      const Ie = (...t) => {
      ...
      const ze = (t, e, r) => {
        if (Me[t]) {
          jt.error(`Detector with key ${t} already exists`);
        } else {
          Me[t] = { detector: e, loader: r };
        }
        jt.debug(`Detector with key ${t} added${r ? " with loader" : ""}`);
      };
      const qe = (t) => Me[t].loader;
      const De = (t, e, { depth: r = 2, clobber: i = false } = {}) => {
        const n = { depth: r, clobber: i };
        if (Array.isArray(e) && !Array.isArray(t)) {
          e.forEach((e) => De(t, e, n));
          return t;
        ...
        if (e !== void 0 && typeof t === "object" && typeof e === "object") {
          Object.keys(e).forEach((n) => {
            if (typeof e[n] === "object" && (t[n] === void 0 || typeof t[n] === "object")) {
              ...
              t[n] = De(t[n], e[n], { depth: r - 1, clobber: i });
      ...
      const $e = {
        curveBasis: a.qrM,
        curveBasisClosed: a.Yu4,
        curveBasisOpen: a.IA3,
        curveBumpX: a.Wi0,
        curveBumpY: a.PGM,
        curveBundle: a.OEq,
        curveCardinalClosed: a.olC,
        curveCardinalOpen: a.IrU,
        curveCardinal: a.y8u,
        curveCatmullRomClosed: a.Q7f,
        curveCatmullRomOpen: a.cVp,
        curveCatmullRom: a.oDi,
        curveLinear: a.lUB,
        curveLinearClosed: a.Lx9,
        curveMonotoneX: a.nVG,
        curveMonotoneY: a.uxU,
        curveNatural: a.Xf2,
        curveStep: a.GZz,
        curveStepAfter: a.UPb,
        curveStepBefore: a.dyv,
      };
      const Pe = /\s*(?:(\w+)(?=:):|(\w+))\s*(?:(\w+)|((?:(?!}%{2}).|\r?\n)*))?\s*(?:}%{2})?/gi;
      const Re = function (t, e) {
        const r = We(t, /(?:init\b)|(?:initialize\b)/);
        let i = {};
        if (Array.isArray(r)) {
      ...
      const We = function (t, e = null) {
        try {
          const r = new RegExp(`[%]{2}(?![{]${Pe.source})(?=[}][%]{2}).*\n`, "ig");
          t = t.trim().replace(r, "").replace(/'/gm, '"');
          jt.debug(`Detecting diagram directive${e !== null ? " type:" + e : ""} based on the text:${t}`);
          let i;
          const n = [];
          while ((i = Fe.exec(t)) !== null) {
            if (i.index === Fe.lastIndex) {
              Fe.lastIndex++;
            }
          ...
          jt.error(`ERROR: ${r.message} - Unable to parse directive type: '${e}' based on the text: '${t}'`);
      ...
      const Ve = (t, ...e) => {
        ...
        for (let s = 0; s < i; s++) {
          o = o[r[s]];
          if (!o) {
            jt.error(`Function name: ${t} not found in window`);
            return;
          }
        }
        o[n](...e);
        ...
        for (const n of t) {
          if (r) {
            ...
            if (t < i) {
              ...
              if (e > 0 && e < 1) {
                return { x: Je((1 - e) * r.x + e * n.x, 5), y: Je((1 - e) * r.y + e * n.y, 5) };
              }
            }
          }
          r = n;
      ...
      const tr = (t, e, r) => {
        jt.info(`our points ${JSON.stringify(e)}`);
        if (e[0] !== r) {
          e = e.reverse();
        }
        const i = 25;
      ...
      const Lr = (t, e) => {
        ...
        if (i.theme && i.theme in ve) {
          const t = Ne({}, Sr);
          const e = Ne(t.themeVariables || {}, i.themeVariables);
      ...
      const Er = (t) => {
        ...
        if (t.theme && ve[t.theme]) {
          wr.themeVariables = ve[t.theme].getThemeVariables(t.themeVariables);
        }
        Lr(wr, Br);
        return wr;
      };
      ...
      const Dr = (t) => {
        ...
        ["secure", ...(wr.secure ?? [])].forEach((e) => {
          if (Object.hasOwn(t, e)) {
            jt.debug(`Denied attempt to modify a secure key ${e}`, t[e]);
            delete t[e];
          }
        });
      ...
      const Wr = (t) => {
        ...
        if (t.lazyLoadedDiagrams || t.loadExternalDiagramsAtStartup) {
          Rr("LAZY_LOAD_DEPRECATED");
        }
      };
      const Hr = "c4";
      const Ur = (t) => /^\s*C4Context|C4Container|C4Component|C4Dynamic|C4Deployment/.test(t);
      const Yr = async () => {
        const { diagram: t } = await r.e(3330).then(r.bind(r, 43330));
        return { id: Hr, diagram: t };
      };
      const Gr = { id: Hr, detector: Ur, loader: Yr };
      const Vr = Gr;
      const Xr = "flowchart";
      const Zr = (t, e) => {
        var r, i;
      ...
      const Kr = async () => {
        const { diagram: t } = await Promise.all([r.e(29), r.e(8258), r.e(8768), r.e(1017), r.e(4050), r.e(7403)]).then(r.bind(r, 87403));
        return { id: Xr, diagram: t };
      };
      const Jr = { id: Xr, detector: Zr, loader: Kr };
      const Qr = Jr;
      ...
      const ri = async () => {
        const { diagram: t } = await Promise.all([r.e(29), r.e(8258), r.e(8768), r.e(1017), r.e(4050), r.e(7642)]).then(r.bind(r, 7642));
      ...
      const ai = async () => {
        const { diagram: t } = await Promise.all([r.e(29), r.e(9908)]).then(r.bind(r, 9908));
      ...
      const fi = async () => {
        const { diagram: t } = await r.e(6483).then(r.bind(r, 86483));
      ...
      const yi = async () => {
        const { diagram: t } = await r.e(5890).then(r.bind(r, 55890));
      ...
      const ki = async () => {
        const { diagram: t } = await r.e(8).then(r.bind(r, 80008));
        return { id: vi, diagram: t };
      };
      const Ai = { id: vi, detector: xi, loader: ki };
      const Ti = "pie";
      const _i = (t) => /^\s*pie/.test(t);
      const wi = async () => {
        const { diagram: t } = await r.e(9635).then(r.bind(r, 19635));
        return { id: Ti, diagram: t };
      };
      const Si = { id: Ti, detector: _i, loader: wi };
      const Bi = "quadrantChart";
      const Fi = (t) => /^\s*quadrantChart/.test(t);
      const Li = async () => {
        const { diagram: t } = await r.e(5846).then(r.bind(r, 85846));
        return { id: Bi, diagram: t };
      };
      const Ei = { id: Bi, detector: Fi, loader: Li };
      const Mi = Ei;
      const Oi = "xychart";
      const Ii = (t) => /^\s*xychart-beta/.test(t);
      const zi = async () => {
        const { diagram: t } = await Promise.all([r.e(8258), r.e(2624)]).then(r.bind(r, 12624));
        return { id: Oi, diagram: t };
      };
      const qi = { id: Oi, detector: Ii, loader: zi };
      const Di = qi;
      const Ni = "requirement";
      const ji = (t) => /^\s*requirement(Diagram)?/.test(t);
      const $i = async () => {
        const { diagram: t } = await Promise.all([r.e(29), r.e(1162)]).then(r.bind(r, 81162));
        return { id: Ni, diagram: t };
      };
      const Pi = { id: Ni, detector: ji, loader: $i };
      const Ri = Pi;
      const Wi = "sequence";
      const Hi = (t) => /^\s*sequenceDiagram/.test(t);
      const Ui = async () => {
        const { diagram: t } = await r.e(2337).then(r.bind(r, 52337));
        return { id: Wi, diagram: t };
      };
      const Yi = { id: Wi, detector: Hi, loader: Ui };
      const Gi = Yi;
      const Vi = "class";
      const Xi = (t, e) => {
        var r;
      ...
      const Zi = async () => {
        const { diagram: t } = await Promise.all([r.e(29), r.e(1786), r.e(5246)]).then(r.bind(r, 65246));
        return { id: Vi, diagram: t };
      };
      const Ki = { id: Vi, detector: Xi, loader: Zi };
      const Ji = Ki;
      const Qi = "classDiagram";
      const tn = (t, e) => {
        var r;
      ...
      const en = async () => {
        const { diagram: t } = await Promise.all([r.e(29), r.e(8258), r.e(8768), r.e(1017), r.e(1786), r.e(3788)]).then(r.bind(r, 63788));
        return { id: Qi, diagram: t };
      };
      const rn = { id: Qi, detector: tn, loader: en };
      const nn = rn;
      const on = "state";
      const sn = (t, e) => {
        var r;
      ...
      const an = async () => {
        const { diagram: t } = await Promise.all([r.e(29), r.e(3489), r.e(8896)]).then(r.bind(r, 8896));
      ...
      const fn = async () => {
        const { diagram: t } = await Promise.all([r.e(29), r.e(8258), r.e(8768), r.e(1017), r.e(3489), r.e(5446)]).then(r.bind(r, 95446));
      ...
      const yn = async () => {
        const { diagram: t } = await r.e(3415).then(r.bind(r, 53415));
      ...
      const An = function (t, e, r, i) {
        const n = e.node().getBBox();
        const o = n.width;
        const s = n.height;
        jt.info(`SVG bounds: ${o}x${s}`, n);
        let a = 0;
        let l = 0;
        jt.info(`Graph bounds: ${a}x${l}`, t);
        a = o + r * 2;
        l = s + r * 2;
        jt.info(`Calculated bounds: ${a}x${l}`);
        kn(e, l, a, i);
      ...
      const Xn = (t, e, r) => {
        ...
        wn(t, e.styles);
        (i = e.injectUtils) == null ? void 0 : i.call(e, $n, Pn, Rn, Un, Yn, Gn(), () => {});
      };
      const Zn = (t) => {
        if (t in Vn) {
          return Vn[t];
      ...
      const Qn = (t, e, r) => {
        jt.debug("renering svg for syntax error\n");
        const i = Jn(e);
      ...
      const so = async () => {
        const { diagram: t } = await Promise.all([r.e(8258), r.e(8768), r.e(4050), r.e(7114)]).then(r.bind(r, 27114));
      ...
      const uo = async () => {
        const { diagram: t } = await r.e(4701).then(r.bind(r, 94701));
      ...
      const yo = async () => {
        const { diagram: t } = await Promise.all([r.e(8258), r.e(2965)]).then(r.bind(r, 2965));
      ...
      const ko = async () => {
        const { diagram: t } = await r.e(3538).then(r.bind(r, 13538));
        return { id: vo, diagram: t };
      };
      const Ao = { id: vo, detector: xo, loader: ko };
      const To = Ao;
      let _o = false;
      const wo = () => {
        if (_o) {
        ...
        _o = true;
        Xn("error", io, (t) => t.toLowerCase().trim() === "error");
        Xn(
          "---",
          {
            db: { clear: () => {} },
        ...
        Ie(Vr, nn, Ji, ci, bi, Ai, Si, Ri, Gi, lo, ni, Qr, bo, po, pi, pn, cn, bn, Mi, To, Di);
      };
      class So {
        constructor(t, e = {}) {
          this.text = t;
          ...
          const i = Zn(this.type);
          jt.debug("Type " + this.type);
          this.db = i.db;
      ...
      const Bo = async (t, e = {}) => {
        ...
        try {
          ...
          const t = qe(r);
          if (!t) {
            throw new Ee(`Diagram ${r} not found.`);
          }
      ...
      const Mo = "graphics-document document";
      function Oo(t, e) {
        t.attr("role", Mo);
        if (e !== "") {
      ...
      var Yo = Po;
      var Go = jo;
      var Vo = { isNothing: Ro, isObject: Wo, toArray: Ho, repeat: Uo, isNegativeZero: Yo, extend: Go };
      function Xo(t, e) {
        var r = "",
      ...
      Zo.prototype.toString = function t(e) {
        return this.name + ": " + Xo(this, e);
      };
      var Ko = Zo;
      function Jo(t, e, r, i, n) {
        var o = "";
        var s = "";
      ...
      function ts(t, e) {
        ...
        for (l = 1; l <= e.linesBefore; l++) {
          if (s - l < 0) break;
          c = Jo(t.buffer, i[s - l], n[s - l], t.position - (i[s] - i[s - l]), u);
          a = Vo.repeat(" ", e.indent) + Qo((t.line - l + 1).toString(), h) + " | " + c.str + "\n" + a;
        }
        c = Jo(t.buffer, i[s], n[s], t.position, u);
        a += Vo.repeat(" ", e.indent) + Qo((t.line + 1).toString(), h) + " | " + c.str + "\n";
        ...
        if (n === "0") {
          ...
          if (n === "x") {
            ...
            for (; r < e; r++) {
              n = t[r];
              if (n === "_") continue;
              if (!As(t.charCodeAt(r))) return false;
              i = true;
            }
            return i && n !== "_";
          }
      ...
      var Fs = new ss("tag:yaml.org,2002:int", {
        kind: "scalar",
        resolve: ws,
        construct: Ss,
        predicate: Bs,
      ...
      function Is(t, e) {
        ...
        r = t.toString(10);
        return Os.test(r) ? r.replace("e", ".e") : r;
      }
      function zs(t) {
        return Object.prototype.toString.call(t) === "[object Number]" && (t % 1 !== 0 || Vo.isNegativeZero(t));
      }
      ...
      var Ds = ps.extend({ implicit: [Cs, ks, Fs, qs] });
      var Ns = Ds;
      var js = new RegExp("^([0-9][0-9][0-9][0-9])-([0-9][0-9])-([0-9][0-9])$");
      var $s = new RegExp(
      ...
      var Hs = new ss("tag:yaml.org,2002:timestamp", { kind: "scalar", resolve: Ps, construct: Rs, instanceOf: Date, represent: Ws });
      function Us(t) {
        return t === "<<" || t === null;
      }
      var Ys = new ss("tag:yaml.org,2002:merge", { kind: "scalar", resolve: Us });
      var Gs = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=\n\r";
      function Vs(t) {
        if (t === null) return false;
        var e,
          r,
      ...
      var Js = new ss("tag:yaml.org,2002:binary", { kind: "scalar", resolve: Vs, construct: Xs, predicate: Ks, represent: Zs });
      ...
      var fa = Ns.extend({ implicit: [Hs, Ys], explicit: [Js, ia, aa, ua] });
      ...
      var Da = new Array(256);
      for (var Na = 0; Na < 256; Na++) {
        qa[Na] = Ia(Na) ? 1 : 0;
        Da[Na] = Ia(Na);
      }
      function ja(t, e) {
      ...
      var Wa = {
        YAML: function t(e, r, i) {
          var n, o, s;
          if (e.version !== null) {
            Pa(e, "duplication of %YAML directive");
          }
          if (i.length !== 1) {
            Pa(e, "YAML directive accepts exactly one argument");
          }
          n = /^([0-9]+)\.([0-9]+)$/.exec(i[0]);
          if (n === null) {
            Pa(e, "ill-formed argument of the YAML directive");
          }
          o = parseInt(n[1], 10);
          s = parseInt(n[2], 10);
          if (o !== 1) {
            Pa(e, "unacceptable YAML version of the document");
          }
          e.version = i[0];
          e.checkLineBreaks = s < 2;
          if (s !== 1 && s !== 2) {
            Ra(e, "unsupported YAML version of the document");
          }
        },
        TAG: function t(e, r, i) {
          var n, o;
          if (i.length !== 2) {
            Pa(e, "TAG directive accepts exactly two arguments");
          }
          n = i[0];
          o = i[1];
          if (!Ta.test(n)) {
            Pa(e, "ill-formed tag handle (first argument) of the TAG directive");
          }
          if (da.call(e.tagMap, n)) {
            Pa(e, 'there is a previously declared suffix for "' + n + '" tag handle');
          }
          if (!_a.test(o)) {
            Pa(e, "ill-formed tag prefix (second argument) of the TAG directive");
          }
          try {
            o = decodeURIComponent(o);
          } catch (s) {
            Pa(e, "tag prefix is malformed: " + o);
          }
          e.tagMap[n] = o;
        },
      };
          ...
          if (i) {
            for (n = 0, o = a.length; n < o; n += 1) {
              ...
              if (!(s === 9 || (32 <= s && s <= 1114111))) {
                Pa(t, "expected valid JSON character");
              }
            }
          } else if (xa.test(a)) {
            Pa(t, "the stream contains non-printable characters");
          }
          t.result += a;
        }
      }
      function Ua(t, e, r, i) {
        var n, o, s, a;
        if (!Vo.isObject(r)) {
          Pa(t, "cannot merge mappings; the provided source object is unacceptable");
        }
        n = Object.keys(r);
        ...
        if (Array.isArray(n)) {
          ...
          for (c = 0, h = n.length; c < h; c += 1) {
            if (Array.isArray(n[c])) {
              Pa(t, "nested arrays are not supported inside keys");
            }
            if (typeof n === "object" && wa(n[c]) === "[object Object]") {
              n[c] = "[object Object]";
            }
          }
        }
        if (typeof n === "object" && wa(n) === "[object Object]") {
          n = "[object Object]";
        }
        n = String(n);
        if (e === null) {
      ...
      function Ka(t, e, r) {
        ...
        while (d !== 0) {
          ...
          } else if ((t.position === t.lineStart && Xa(t)) || (r && La(d))) {
            break;
          } else if (Sa(d)) {
            l = t.line;
            c = t.lineStart;
      ...
      function Ja(t, e) {
        ...
        while ((r = t.input.charCodeAt(t.position)) !== 0) {
          if (r === 39) {
            ...
            Za(t, Va(t, false, e));
            i = n = t.position;
          } else if (t.position === t.lineStart && Xa(t)) {
            Pa(t, "unexpected end of the document within a single quoted scalar");
          } else {
            t.position++;
            n = t.position;
          }
        }
        Pa(t, "unexpected end of the stream within a single quoted scalar");
      }
      function Qa(t, e) {
        var r, i, n, o, s, a;
        ...
        while ((a = t.input.charCodeAt(t.position)) !== 0) {
          if (a === 34) {
            ...
            if (Sa(a)) {
              ...
              for (; n > 0; n--) {
                ...
                if ((s = Ea(a)) >= 0) {
                  ...
                  Pa(t, "expected hexadecimal character");
                }
              }
              t.result += za(o);
              t.position++;
            } else {
              Pa(t, "unknown escape sequence");
            }
            r = i = t.position;
          } else if (Sa(a)) {
            Ha(t, r, i, true);
            ...
            Pa(t, "unexpected end of the document within a double quoted scalar");
          } else {
            t.position++;
            i = t.position;
          }
        }
        Pa(t, "unexpected end of the stream within a double quoted scalar");
      }
      function tl(t, e) {
        var r = true,
          i,
        ...
        while (C !== 0) {
          ...
          if (C === h) {
            ...
            Pa(t, "missed comma between flow collection entries");
          } else if (C === 44) {
            Pa(t, "expected the node content, but found ','");
          }
          m = g = y = null;
          u = f = false;
          if (C === 63) {
        ...
        Pa(t, "unexpected end of the stream within a flow collection");
      }
      function el(t, e) {
        var r,
          i,
        ...
        while (u !== 0) {
          ...
          if (u === 43 || u === 45) {
            if (Ca === n) {
              ...
              Pa(t, "repeat of a chomping mode identifier");
            }
          } else if ((h = Oa(u)) >= 0) {
            if (h === 0) {
              Pa(t, "bad explicit indentation width of a block scalar; it cannot be less than one");
            } else if (!s) {
              a = e + h - 1;
              s = true;
            } else {
              Pa(t, "repeat of an indentation width identifier");
            }
          } else {
            break;
          }
      ...
      function rl(t, e) {
        ...
        while (l !== 0) {
          if (t.firstTabInLine !== -1) {
            ...
            Pa(t, "tab characters must not be used in indentation");
          }
          if (l !== 45) {
            break;
          }
          ...
          if ((t.line === r || t.lineIndent > e) && l !== 0) {
            Pa(t, "bad indentation of a sequence entry");
        ...
        while (C !== 0) {
          ...
          if ((C === 63 || C === 58) && Fa(i)) {
            if (C === 63) {
              ...
              Pa(t, "incomplete explicit mapping pair; a key node is missed; or followed by a non-tabulated empty line");
            }
            t.position += 1;
            C = i;
          } else {
            ...
            if (t.line === o) {
              ...
              if (C === 58) {
                C = t.input.charCodeAt(++t.position);
                if (!Fa(C)) {
                  Pa(t, "a whitespace character is expected after the key-value separator within a block mapping");
                }
                if (m) {
                  Ya(t, u, f, d, p, null, s, a, l);
                  d = p = g = null;
                ...
                Pa(t, "can not read an implicit mapping pair; a colon is missed");
              } else {
                t.tag = c;
                t.anchor = h;
                return true;
              ...
              Pa(t, "can not read a block mapping entry; a multiline key may not be an implicit key");
            } else {
              t.tag = c;
              t.anchor = h;
              return true;
          ...
          if ((t.line === o || t.lineIndent > e) && C !== 0) {
            Pa(t, "bad indentation of a mapping entry");
          } else if (t.lineIndent < e) {
            break;
          }
        }
      ...
      function nl(t) {
        ...
        if (t.tag !== null) {
          Pa(t, "duplication of a tag property");
        }
        s = t.input.charCodeAt(++t.position);
        if (s === 60) {
          r = true;
        ...
        if (r) {
          ...
          if (t.position < t.length) {
            ...
            Pa(t, "unexpected end of the stream within a verbatim tag");
          }
        } else {
          while (s !== 0 && !Fa(s)) {
            if (s === 33) {
              if (!i) {
                ...
                if (!Ta.test(n)) {
                  Pa(t, "named tag handle cannot contain such characters");
                }
                i = true;
                e = t.position + 1;
              } else {
                Pa(t, "tag suffix cannot contain exclamation marks");
              }
            }
            s = t.input.charCodeAt(++t.position);
          }
          o = t.input.slice(e, t.position);
          if (Aa.test(o)) {
            Pa(t, "tag suffix cannot contain flow indicator characters");
          }
        }
        if (o && !_a.test(o)) {
          Pa(t, "tag name cannot contain such characters: " + o);
        }
        try {
          o = decodeURIComponent(o);
        } catch (a) {
          Pa(t, "tag name is malformed: " + o);
        }
        if (r) {
          t.tag = o;
      ...
      function ol(t) {
        ...
        if (t.anchor !== null) {
          Pa(t, "duplication of an anchor property");
        }
        r = t.input.charCodeAt(++t.position);
        e = t.position;
        while (r !== 0 && !Fa(r) && !La(r)) {
        ...
        if (t.position === e) {
          Pa(t, "name of an anchor node must contain at least one character");
        }
      ...
      function sl(t) {
        ...
        if (t.position === e) {
          Pa(t, "name of an alias node must contain at least one character");
        }
        r = t.input.slice(e, t.position);
        if (!da.call(t.anchorMap, r)) {
          Pa(t, 'unidentified alias "' + r + '"');
        }
      ...
      function al(t, e, r, i, n) {
        ...
        if (l === 1 || ya === r) {
          ...
          if (l === 1) {
            if ((a && (rl(t, m) || il(t, m, g))) || tl(t, g)) {
              ...
              if ((s && el(t, g)) || Ja(t, g) || Qa(t, g)) {
                h = true;
              } else if (sl(t)) {
                h = true;
                if (t.tag !== null || t.anchor !== null) {
                  Pa(t, "alias node should not have any properties");
                }
              } else if (Ka(t, g, pa === r)) {
                h = true;
                if (t.tag === null) {
        ...
        if (t.tag === null) {
          ...
          if (t.result !== null && t.kind !== "scalar") {
            Pa(t, 'unacceptable node kind for !<?> tag; it should be "scalar", not "' + t.kind + '"');
          }
          ...
          if (!p) {
            Pa(t, "unknown tag !<" + t.tag + ">");
          }
          if (t.result !== null && p.kind !== t.kind) {
            Pa(t, "unacceptable node kind for !<" + t.tag + '> tag; it should be "' + p.kind + '", not "' + t.kind + '"');
          }
          if (!p.resolve(t.result, t.tag)) {
            Pa(t, "cannot resolve a node with !<" + t.tag + "> explicit tag");
          } else {
      ...
      function ll(t) {
        ...
        while ((s = t.input.charCodeAt(t.position)) !== 0) {
          ...
          n = [];
          if (i.length < 1) {
            Pa(t, "directive name must not be less than one character in length");
          }
          while (s !== 0) {
            while (Ba(s)) {
              s = t.input.charCodeAt(++t.position);
          ...
          if (da.call(Wa, i)) {
            ...
            Ra(t, 'unknown document directive "' + i + '"');
          }
        }
        Va(t, true, -1);
        if (
          ...
          Pa(t, "directives end mark is expected");
        }
        al(t, t.lineIndent - 1, ya, false, true);
        Va(t, true, -1);
        if (t.checkLineBreaks && ka.test(t.input.slice(e, t.position))) {
          Ra(t, "non-ASCII line breaks are interpreted as content");
        }
        t.documents.push(t.result);
        if (t.position === t.lineStart && Xa(t)) {
        ...
        if (t.position < t.length - 1) {
          Pa(t, "end of the stream or a document separator is expected");
        } else {
          return;
        }
      }
      function cl(t, e) {
        ...
        if (i !== -1) {
          r.position = i;
          Pa(r, "null byte is not allowed in input");
        }
        r.input += "\0";
      ...
      const kl = 5e4;
      const Al = "graph TB;a[Maximum text size in diagram exceeded];style a fill:#faa";
      const Tl = "sandbox";
      const _l = "loose";
      ...
      const Fl = "100%";
      const Ll = "100%";
      const El = "border:0;margin:0;";
      const Ml = "margin:0";
      const Ol = "allow-top-navigation-by-user-activation allow-popups";
      const Il = 'The "iframe" tag is not supported by your browser.';
      const zl = ["foreignobject"];
      ...
      const $l = (t, e = {}) => {
        ...
        if (!(0, Dt.A)(e)) {
          ...
          for (const t in e) {
            ...
            if (!(0, Dt.A)(r.styles)) {
              a.forEach((t) => {
                i += jl(r.id, t, r.styles);
              });
            }
            if (!(0, Dt.A)(r.textStyles)) {
      ...
      const Pl = (t, e, r, i) => {
        const n = $l(t, r);
        const o = Sn(e, n, t.themeVariables);
        return nt(Mt(`${i}{${o}}`), ot);
      };
      const Rl = (t = "", e, r) => {
        let i = t;
      ...
      const Wl = (t = "", e) => {
        ...
        const n = ((i = (r = e == null ? void 0 : e.viewBox) == null ? void 0 : r.baseVal) == null ? void 0 : i.height)
          ...
          : Ll;
        const o = btoa('<body style="' + Ml + '">' + t + "</body>");
        return `<iframe style="width:${Fl};height:${n};${El}" src="data:text/html;base64,${o}" sandbox="${Ol}">\n  ${Il}\n</iframe>`;
      };
      const Hl = (t, e, r, i, n) => {
        ...
        const s = o.append("svg").attr("id", e).attr("width", "100%").attr("xmlns", wl);
        if (n) {
      ...
      const Gl = async function (t, e, r) {
        ...
        const y = "#" + m;
        let C = (0, a.Ltv)("body");
        const b = f.securityLevel === Tl;
        const v = f.securityLevel === _l;
        ...
        if (r !== void 0) {
          ...
          if (b) {
            const t = Ul((0, a.Ltv)(r), p);
            C = (0, a.Ltv)(t.nodes()[0].contentDocument.body);
            C.node().style.margin = 0;
          } else {
            C = (0, a.Ltv)(r);
          }
          Hl(C, t, m, `font-family: ${x}`, Sl);
        } else {
          Yl(document, t, m, p);
          if (b) {
            const t = Ul((0, a.Ltv)("body"), p);
            C = (0, a.Ltv)(t.nodes()[0].contentDocument.body);
            C.node().style.margin = 0;
          } else {
            C = (0, a.Ltv)("body");
        ...
        let A;
        try {
          k = await Xl(e, { title: u.title });
        } catch (D) {
          k = new So("error");
          A = D;
        }
        const T = C.select(y).node();
        const _ = k.type;
        const w = T.firstChild;
        const S = w.firstChild;
        const B = (n = (i = k.renderer).getClasses) == null ? void 0 : n.call(i, e, k);
        const F = Pl(f, _, B, d);
        const L = document.createElement("style");
        L.innerHTML = F;
        w.insertBefore(L, S);
        try {
          await k.renderer.draw(e, t, Tr, k);
        } catch (N) {
          eo.draw(e, t, Tr);
          throw N;
        }
        const E = C.select(`${y} svg`);
        const M = (s = (o = k.db).getAccTitle) == null ? void 0 : s.call(o);
        const O = (h = (l = k.db).getAccDescription) == null ? void 0 : h.call(l);
        Zl(_, E, M, O);
        C.select(`[id="${t}"]`).selectAll("foreignobject > *").attr("xmlns", Bl);
        let I = C.select(y).node().innerHTML;
        jt.debug("config.arrowMarkerAbsolute", f.arrowMarkerAbsolute);
        I = Rl(I, b, Qt(f.arrowMarkerAbsolute));
        if (b) {
          const t = C.select(y + " svg").node();
          I = Wl(I, t);
        } else if (!v) {
          I = c().sanitize(I, { ADD_TAGS: zl, ADD_ATTR: ql });
        }
        Eo();
        if (A) {
          throw A;
        ...
        const z = b ? g : y;
        const q = (0, a.Ltv)(z).node();
        if (q && "remove" in q) {
          q.remove();
        }
        return { svg: I, bindFunctions: k.db.bindFunctions };
      };
      function Vl(t = {}) {
        var e;
        ...
        const r = typeof t === "object" ? Er(t) : Ir();
        $t(r.logLevel);
        wo();
      }
      const Xl = (t, e = {}) => {
      ...
      jr(qr());
      const Jl = async () => {
        jt.debug(`Loading registered diagrams`);
        const t = await Promise.allSettled(
          Object.entries(Me).map(async ([t, { detector: e, loader: r }]) => {
            if (r) {
              try {
                Zn(t);
              } catch (i) {
                try {
                  ...
                  jt.error(`Failed to load external diagram with key ${t}. Removing from detectors.`);
                  delete Me[t];
                  throw n;
                }
              }
        ...
        if (e.length > 0) {
          jt.error(`Failed to load ${e.length} external diagrams`);
          for (const t of e) {
            jt.error(t);
          }
      ...
      const tc = async function (t = { querySelector: ".mermaid" }) {
        try {
          ...
          if (!t.suppressErrors) {
            jt.error("Use the suppressErrors option to suppress these errors");
            throw e;
          }
        }
      };
      const ec = async function ({ postRenderCallback: t, querySelector: e, nodes: r } = { querySelector: ".mermaid" }) {
        ...
        jt.debug(`${!t ? "No " : ""}Callback function found`);
        let o;
        if (r) {
          o = r;
        } else if (e) {
        ...
        jt.debug(`Found ${o.length} diagrams`);
        if ((n == null ? void 0 : n.startOnLoad) !== void 0) {
          jt.debug("Start On Load: " + (n == null ? void 0 : n.startOnLoad));
        ...
        for (const h of Array.from(o)) {
          jt.info("Rendering diagram: " + h.id);
          ...
          a = h.innerHTML;
          a = (0, i.T)(xr.entityDecode(a))
            .trim()
            .replace(/<br\s*\/?>/gi, "<br/>");
          const r = xr.detectInit(a);
          if (r) {
            jt.debug("Detected early reinit: ", r);
          }
          try {
      ...
      const ic = async function (t, e, r) {
        jt.warn("mermaid.init is deprecated. Please use run instead.");
        if (t) {
          rc(t);
        }
      ...
      const oc = function () {
        if (fc.startOnLoad) {
          ...
          if (t) {
            fc.run().catch((t) => jt.error("Mermaid failed to initialize", t));
          }
        }
      };
        ...
        while (ac.length > 0) {
          ...
          if (e) {
            try {
              ...
              jt.error("Error executing queue", t);
            }
          }
        }
        lc = false;
