  ...
  [5246],
  {
    65246: (t, e, a) => {
      ...
      const E = function (t, e, a, r) {
        ...
        const c = l === "sandbox" ? (0, n.Ltv)(p.nodes()[0].contentDocument.body) : (0, n.Ltv)("body");
        const g = c.select(`[id='${e}']`);
        L(g);
        const h = new d.T({ multigraph: true });
        ...
        const E = b.width + k * 2;
        const M = b.height + k * 2;
        (0, o.i)(g, M, E, s.useMaxWidth);
        const N = `${b.x - k} ${b.y - k} ${E} ${M}`;
        o.l.debug(`viewBox ${N}`);
        g.attr("viewBox", N);
      };
      const M = { draw: E };
