  ...
  [4350],
  {
    ...
    45948: (e, n, t) => {
      ...
      const i = "view",
        ...
        f = ">",
        d = /[[\]{}]/,
        p = { "*": 1, arc: 1, area: 1, group: 1, image: 1, line: 1, path: 1, rect: 1, rule: 1, shape: 1, symbol: 1, text: 1, trail: 1 };
      let g, m;
      function h(e, n, t) {
        g = n || i;
        m = t || p;
    ...
    54350: (e, n, t) => {
      ...
      const It = N(Rt);
      const Wt = { arc: 1, area: 1, group: 1, image: 1, line: 1, path: 1, rect: 1, rule: 1, shape: 1, symbol: 1, text: 1, trail: 1 };
      const Ht = ["cornerRadius", "cornerRadiusTopLeft", "cornerRadiusTopRight", "cornerRadiusBottomLeft", "cornerRadiusBottomRight"];
      var Gt =
        (undefined && undefined.__rest) ||
        function (e, n) {
          var t = {};
      ...
      function ri(e, n, t, { vgChannel: i } = {}) {
        return X(i ? si(e, n, t.style) : undefined, si(e, n, t.style), i ? t[n.type][i] : undefined, t[n.type][e], i ? t.mark[i] : t.mark[e]);
      }
      function si(e, n, t) {
        return oi(e, ti(n), t);
      }
      ...
      function fi(e) {
        return `Invalid specification ${x(
          e
      ...
      const Si = "Axes cannot be shared in concatenated or repeated views yet (https://github.com/vega/vega-lite/issues/2415).";
      function Ei(e) {
      ...
      function Us(e) {
        var n;
        if (Ns(e) && e.timeUnit) {
          return Object.assign(Object.assign({}, e), { timeUnit: (n = $s(e.timeUnit)) === null || n === void 0 ? void 0 : n.unit });
        }
        return e;
      }
      var Rs = t(78352);
      const Is = { quantitative: "quantitative", ordinal: "ordinal", temporal: "temporal", nominal: "nominal", geojson: "geojson" };
      function Ws(e) {
        return e in Is;
      }
      function Hs(e) {
      ...
      const aa = [...sa, ...oa];
      const ua = { color: 1, filled: 1, invalid: 1, order: 1, radius2: 1, theta2: 1, timeUnitBandSize: 1, timeUnitBandPosition: 1 };
      const ca = N(ua);
      const la = {
        area: ["line", "point"],
      ...
      function Aa({ scaleName: e, fieldOrDatumDef: n, fieldOrDatumDef2: t, offset: i, startSuffix: r, bandPosition: s = 0.5 }) {
        ...
        if (n === undefined && t === undefined && s.customFormatTypes) {
          if (c === "quantitative") {
            if (r && s.normalizedNumberFormatType)
              return za({ fieldOrDatumDef: e, format: s.normalizedNumberFormat, formatType: s.normalizedNumberFormatType, expr: i, config: s });
            if (s.numberFormatType) {
              return za({ fieldOrDatumDef: e, format: s.numberFormat, formatType: s.numberFormatType, expr: i, config: s });
            }
          }
      ...
      function Ta(e, n, t) {
        ...
        if (Qu(n) && t !== "time" && t !== "utc") {
          return fu(n) && ((i = $s(n === null || n === void 0 ? void 0 : n.timeUnit)) === null || i === void 0 ? void 0 : i.utc) ? "utc" : "time";
        }
        return undefined;
      }
        ...
        jc(e, (a, u) => {
          if (fu(a)) {
            ...
            if (l || d || f) {
              ...
              const h = Object.assign(Object.assign(Object.assign({}, g ? [] : { title: Nu(a, n, { allowDisabling: true }) }), p), { field: m });
              if (l) {
                let e;
                if (vt(l)) {
                  e = "argmax";
      ...
      function Sc(e, n, t, i, s) {
        ...
        return ({ partName: u, mark: c, positionPrefix: l, endPositionPrefix: f = undefined, extraEncoding: d = {} }) => {
          const p = Cc(t);
          return Ec(e, u, s, {
            mark: c,
      ...
      function qc(e, { config: n }) {
        ...
        const L = [
          ...
          ...B({
            partName: "box",
            mark: Object.assign(Object.assign({ type: "bar" }, d ? { size: d } : {}), { orient: $, invalid: p, ariaRoleDescription: "box" }),
        ...
        if (g === "min-max") {
          return Object.assign(Object.assign({}, c), { transform: ((i = c.transform) !== null && i !== void 0 ? i : []).concat(b), layer: L });
        }
      ...
      function Yc(e, { config: n }) {
        ...
        return Object.assign(Object.assign(Object.assign({}, u), { transform: t }), g.length > 1 ? { layer: g } : Object.assign({}, g[0]));
      }
      function Kc(e, n) {
        const { encoding: t } = e;
        if (Vc(t)) {
      ...
      function Vc(e) {
        return (bu(e.x) || bu(e.y)) && !bu(e.x2) && !bu(e.y2) && !bu(e.xError) && !bu(e.xError2) && !bu(e.yError) && !bu(e.yError2);
      }
      function Qc(e) {
      ...
      function Zc(e, n, t, i, r, s, o, a) {
        ...
        if (s === "raw") {
          ...
          if (t === "stderr" || t === "stdev") {
            ...
            f = [
              { fieldPrefix: "upper_", titlePrefix: Nu({ field: l, aggregate: i, type: "quantitative" }, a, { allowDisabling: false }) },
              { fieldPrefix: "lower_", titlePrefix: Nu({ field: l, aggregate: n, type: "quantitative" }, a, { allowDisabling: false }) },
              { fieldPrefix: "center_", titlePrefix: Nu({ field: l, aggregate: e, type: "quantitative" }, a, { allowDisabling: false }) },
            ];
          }
        } else {
        ...
        return { postAggregateCalculates: c, errorBarSpecificAggregate: u, tooltipSummary: f, tooltipTitleWithFieldName: d };
      }
      function el(e, n, t) {
        return `${I(e)} ${t} ${n}`;
      }
        ...
        for (const l of Nl) {
          if (e[l] !== undefined) {
            if (l === "spacing") {
              ...
              a[l] = (0, r.Et)(n)
                ? n
                : { row: (i = n.row) !== null && i !== void 0 ? i : u, column: (s = n.column) !== null && s !== void 0 ? s : u };
            } else {
              a[l] = e[l];
            }
          }
      ...
      const Gl = ["#4c78a8", "#f58518", "#e45756", "#72b7b2", "#54a24b", "#eeca3b", "#b279a2", "#ff9da6", "#9d755d", "#bab0ac"];
      ...
      const ef = [...pa, ...lc, ...ml, "background", "padding", "legend", "lineBreak", "scale", "style", "title", "view"];
      function nf(e = {}) {
      ...
      const sf = Object.assign({ view: ["continuousWidth", "continuousHeight", "discreteWidth", "discreteHeight", "step"] }, la);
      function of(e) {
        e = b(e);
        for (const n of rf) {
          delete e[n];
      ...
      function xf(e, n) {
        ...
        return { groupbyChannels: l, groupbyFields: f, fieldChannel: o, impute: a.impute === null ? false : ea(s), stackBy: d, offset: p };
      }
      var wf =
        (undefined && undefined.__rest) ||
        function (e, n) {
        ...
        run(e, n, t) {
          ...
          const p = [
            Object.assign(Object.assign({}, r ? { params: r } : {}), {
              mark: jf(
                Object.assign(
                  Object.assign({}, l.type === "area" && l.opacity === undefined && l.fillOpacity === undefined ? { opacity: 0.7 } : {}),
                  l
                )
              ),
              encoding: O(c, ["shape"]),
          ...
          if (g) {
            ...
            m = Object.assign(Object.assign({}, c), { [e]: Object.assign(Object.assign({}, c[e]), n ? { stack: n } : {}) });
          }
          m = O(m, ["y2", "x2"]);
          if (d) {
            p.push(
              Object.assign(Object.assign({}, s ? { projection: s } : {}), {
                mark: Object.assign(Object.assign({ type: "line" }, v(l, ["clip", "interpolate", "tension", "tooltip"])), d),
                encoding: m,
              })
            );
          }
          if (f) {
            p.push(
              Object.assign(Object.assign({}, s ? { projection: s } : {}), {
                mark: Object.assign(Object.assign({ type: "point", opacity: 1, filled: true }, v(l, ["clip", "tooltip"])), f),
                encoding: m,
              })
            );
          }
          return t(Object.assign(Object.assign({}, u), { layer: p }), Object.assign(Object.assign({}, n), { config: Ff(i) }));
        }
      }
      var kf =
        (undefined && undefined.__rest) ||
      ...
      class Nf {
        ...
        run(e, n, t) {
          ...
          Vr(rr(!!i.x2, !!i.y2));
          return t(Object.assign(Object.assign({}, e), { mark: (0, r.Gv)(s) ? Object.assign(Object.assign({}, s), { type: "rule" }) : "rule" }), n);
        }
      }
      var Tf =
        (undefined && undefined.__rest) ||
      ...
      class Mf extends pf {
        ...
        mapNonLayerRepeat(e, n) {
          ...
          for (const m of p) {
            for (const e of f) {
              for (const t of d) {
                ...
                const a =
                  (s.name || "") + l + "child__" + ((0, r.cy)(i) ? `${q(m)}` : (i.row ? `row_${q(e)}` : "") + (i.column ? `column_${q(t)}` : ""));
          ...
          return Object.assign(Object.assign({ data: (t = s.data) !== null && t !== void 0 ? t : o, align: "all" }, a), { columns: g, concat: u });
        }
        mapFacet(e, n) {
          const { facet: t } = e;
          if (Qa(t) && e.columns) {
        ...
        mapUnitWithParentEncodingOrProjection(e, n) {
          ...
          return this.mapUnit(Object.assign(Object.assign(Object.assign({}, e), a ? { projection: a } : {}), u ? { encoding: u } : {}), {
            config: o,
          });
        }
        mapFacetedUnit(e, n) {
          ...
          return this.mapFacet(
            Object.assign(Object.assign(Object.assign({}, g), h), {
              ...
              spec: Object.assign(
                Object.assign(
                  Object.assign(
                    Object.assign(Object.assign(Object.assign({}, u ? { width: u } : {}), l ? { height: l } : {}), f ? { view: f } : {}),
                    c ? { projection: c } : {}
                  ),
                  { mark: a, encoding: b }
                ),
      ...
      function dd(e, n) {
        ...
        if (Ou(r) && ((i = (t = r.scale) === null || t === void 0 ? void 0 : t.domain) === null || i === void 0 ? void 0 : i.selection)) {
            ...
            if (!o.views || !o.views.length) {
              ...
              for (const n of o.views) {
                if (
                  ...
                  ((0, Rs.isArray)(n) && n.map((e) => r.indexOf(e)).every((e, n, t) => e !== -1 && (n === 0 || e > t[n - 1])))
                ) {
                  s.push(o);
                }
              }
      ...
      function jd(e, n, t) {
        ...
        const a = Object.assign(Object.assign(Object.assign({ type: "pad" }, o), t ? wd(t.autosize) : {}), wd(e.autosize));
        if (a.type === "fit" && !s) {
          Vr(di);
          a.type = "pad";
        }
      ...
      function Gd(e, n) {
        ...
        for (const i of T((t = e.component.selection) !== null && t !== void 0 ? t : {})) {
          ...
          n.push({ name: t + Eg, on: [{ events: { signal: i.name + Sg }, update: `modify(${(0, r.r$)(i.name + Cg)}, ${s})` }] });
        }
        return Zd(n);
      }
      function Yd(e, n) {
        ...
        assemble() {
          ...
          for (const n of T(this.formula)) {
            ...
            e.push(
              Object.assign(
                Object.assign(
                  Object.assign(Object.assign({ field: Y(t), type: "timeunit" }, o ? { units: Os(o) } : {}), a ? { timezone: "utc" } : {}),
                  u
                ),
                { as: [i, `${i}_end`] }
              )
      ...
      const ap = {
        ...
        parse: (e, n, t) => {
          ...
          if (p) {
            n.init = p.map((e) => o.items.map((n) => ((0, r.Gv)(e) ? (e[n.channel] !== undefined ? e[n.channel] : e[n.field]) : e)));
          }
          if (!z(u)) {
        ...
        signals: (e, n, t) => {
          ...
          if (!o && c.length) {
            t.push({
              name: i + mp,
              value: {},
              on: [{ events: c.map((e) => ({ scale: e.scaleName })), update: `${c.map((e) => e.expr).join(" && ")} ? ${i + mp} : {}` }],
            });
          }
          ...
          return t.concat(
            Object.assign(
              ...
              u.length ? { on: [{ events: [{ signal: u.join(" || ") }], update: `${u.join(" && ")} ? {${l}: [${u}]} : null` }] } : {}
            )
          );
        },
        marks: (e, n, t) => {
          ...
          const h = N(m).reduce((e, n) => {
            e[n] = [
              {
                test: [s !== undefined && `${a}[0] !== ${a}[1]`, o !== undefined && `${u}[0] !== ${u}[1]`].filter((e) => e).join(" && "),
                value: m[n],
              },
              { value: null },
            ];
          ...
          return [
            { name: `${i + gp}_bg`, type: "rect", clip: true, encode: { enter: { fill: { value: d }, fillOpacity: { value: p } }, update: l } },
            ...t,
            {
              name: i + gp,
              type: "rect",
      ...
      const Op = {
        ...
        signals: (e, n, t) => {
            ...
            const n = a.items
              .map((n) => {
                ...
                return (t === null || t === void 0 ? void 0 : t.bin)
                  ? `[${u}[${(0, r.r$)(e.vgField(n.channel, {}))}], ` + `${u}[${(0, r.r$)(e.vgField(n.channel, { binSuffix: "end" }))}]]`
                  : `${u}[${(0, r.r$)(n.field)}]`;
              })
              .join(", ");
            f += `fields: ${o}, values: [${n}]`;
          ...
          const d = n.events;
          return t.concat([{ name: s + Sg, on: d ? [{ events: d, update: `${l} ? {${f}} : null`, force: true }] : [] }]);
        },
      };
      const xp = Op;
      function wp(e, n, t, i) {
      ...
      function Bp(e, n = { filled: undefined }) {
        ...
        const d =
          (r =
            (i = ii(l === true ? "color" : undefined, o, u, { vgChannel: "fill" })) !== null && i !== void 0 ? i : u.mark[l === true && "color"]) !==
            null && r !== void 0
            ? r
            : f;
        const p =
          (s = ii(l === false ? "color" : undefined, o, u, { vgChannel: "stroke" })) !== null && s !== void 0 ? s : u.mark[l === false && "color"];
      ...
      function Ip(e, n, t) {
        ...
        const { offset: g } =
          t in i || t in s ? _p({ channel: t, markDef: s, encoding: i, model: e }) : _p({ channel: u, markDef: s, encoding: i, model: e });
      ...
      function Wp({ channel: e, channelDef: n, channel2Def: t, markDef: i, config: r, scaleName: s, scale: o, stack: a, offset: u, defaultRef: c }) {
        if (bu(n) && a && e.charAt(0) === a.fieldChannel.charAt(0)) {
          return Da(n, s, { suffix: "start" }, { offset: u });
        }
        return xa({ channel: e, channelDef: t, scaleName: s, scale: o, stack: a, markDef: i, config: r, offset: u, defaultRef: c });
      }
      function Hp(e, n) {
        const t = vn(e);
        const i = bn(e);
      ...
      function Gp(e, n) {
        ...
        const g = o.orient;
        const m = (i = (t = s[c]) !== null && t !== void 0 ? t : s.size) !== null && i !== void 0 ? i : ii("size", o, r, { vgChannel: c });
      ...
      function Kp(e, n, t) {
        ...
        const O = qp(n, i, o, v);
        const x = O === "xc" || O === "yc";
        const { offset: w, offsetType: j } = _p({ channel: n, markDef: i, encoding: s, model: t, bandPosition: x ? 0.5 : 0 });
        const F = xa({
          channel: n,
          channelDef: e,
          markDef: i,
          ...
          bandPosition: x ? (j === "encoding" ? 0 : 0.5) : Tt(y) ? { signal: `(1-${y})/2` } : ga(y) ? (1 - y.band) / 2 : 0,
        });
        if (f) {
          ...
          return {
            [O]: F,
            [e]: (0, r.cy)(F) ? [F[0], Object.assign(Object.assign({}, F[1]), { offset: t })] : Object.assign(Object.assign({}, F), { offset: t }),
          };
        }
      }
      ...
      function Qp({ fieldDef: e, fieldDef2: n, channel: t, model: i }) {
        ...
        if (At(e.bin) || e.timeUnit) {
          return {
            ...
            [v]: Xp({ fieldDef: e, scaleName: f, bandPosition: Tt(w) ? { signal: `1-${w.signal}` } : 1 - w, offset: Vp(t, b, p, h, x) }),
          };
        } else if (kt(e.bin)) {
          ...
          if (fu(n)) {
            ...
            return { [O]: i, [v]: { signal: `scale("${f}", ${Du(e, { expr: "datum" })} + ${e.bin.step})`, offset: Vp(t, b, p, h, x) } };
          }
        }
        Vr(Nr(y));
        return undefined;
            ...
            if (!d.length) {
              t.unshift(
                Object.assign(Object.assign({ name: f }, a ? { init: Hd(a[s]) } : { value: null }), {
                  on: n.events
                    ? [{ events: n.events, update: `datum && item().mark.marktype !== 'group' ? ${u}[${(0, r.r$)(e.field)}] : null` }]
                    : [],
                  bind: (l = (c = o[e.field]) !== null && c !== void 0 ? c : o[e.channel]) !== null && l !== void 0 ? l : o,
                })
              );
            }
          });
      ...
      const dg = {
        ...
        modifyExpr: (e, n) => {
          ...
          const i = n.name + fg;
          return (
            `${i} ? null : ${t}, ` + (n.resolve === "global" ? `${i} ? null : true, ` : `${i} ? null : {unit: ${Ng(e)}}, `) + `${i} ? ${t} : null`
          );
        },
      };
      const pg = dg;
      ...
      const hg = {
        ...
        parse: (e, n, t) => {
          var i;
          const s = b(t);
          s.select = (0, r.Kg)(s.select) ? { type: s.select, toggle: n.toggle } : Object.assign(Object.assign({}, s.select), { toggle: n.toggle });
          Mg(n, s);
              ...
              on: [
                {
                  ...
                  update: !s
                    ? `{x: x(unit), y: y(unit)}`
                    : "{" + [c ? `x: invert(${c}, x(unit))` : "", l ? `y: invert(${l}, y(unit))` : ""].filter((e) => !!e).join(", ") + "}",
                },
              ],
            },
      ...
      function kg(e, n, t, i, r) {
        ...
        const m = a + $g;
        const h = `${a}${Fg}.${u}`;
        const b = !c ? "zoomLinear" : p === "log" ? "zoomLog" : p === "symlog" ? "zoomSymlog" : p === "pow" ? "zoomPow" : "zoomLinear";
        const y = !c
          ? ""
          : p === "pow"
      ...
      function Tg(e) {
        var n;
        return T((n = e.component.selection) !== null && n !== void 0 ? n : {}).reduce((e, n) => e || n.project.hasSelectionId, false);
      }
      function Mg(e, n) {
      ...
      function Wm(e) {
        return e === 36 || e === 95 || (e >= 65 && e <= 90) || (e >= 97 && e <= 122) || e === 92 || (e >= 128 && Nm.test(String.fromCharCode(e)));
      }
      function Hm(e) {
        return (
          e === 36 ||
      ...
      function ah() {
        ...
        return { literal: n.literal + t.literal, value: i, regex: { pattern: n.value, flags: t.value }, start: e, end: nm };
      }
      function uh(e) {
      ...
      function tb(e, n, t) {
        ...
        if (!s && !o) {
          ...
          if (a.project.items.length > 1) {
            Vr('A "field" or "encoding" must be specified when using a selection as a scale domain. ' + `Using "field": ${(0, r.r$)(o)}.`);
          }
        } else if (s && !o) {
      ...
      function ib(e, n) {
        ...
        for (const [i, r] of M((t = e.component.selection) !== null && t !== void 0 ? t : {})) {
          ...
          e.component.data.outputNodes[t] = r.materialized = new np(new Zh(n, e, { param: i }), t, Rd.Lookup, e.component.data.outputNodeRefCounts);
        }
      }
      function rb(e, n, t) {
        return U(n, (n) => {
      ...
      const mb = {
        ...
        labelOverlap: ({ axis: e, fieldOrDatumDef: n, scaleType: t }) => {
          var i;
          return (i = e.labelOverlap) !== null && i !== void 0 ? i : jb(n.type, t, fu(n) && !!n.timeUnit, fu(n) ? n.sort : undefined);
        },
        orient: ({ orient: e }) => e,
        tickCount: ({ channel: e, model: n, axis: t, fieldOrDatumDef: i, scaleType: r }) => {
          ...
          return (s = t.tickCount) !== null && s !== void 0 ? s : $b({ fieldOrDatumDef: i, scaleType: r, size: a, values: t.values });
        },
      ...
      function hb(e, n) {
        return !mo(e) && fu(n) && !At(n === null || n === void 0 ? void 0 : n.bin) && !kt(n === null || n === void 0 ? void 0 : n.bin);
      }
      function bb(e, n) {
        const t = n === "x" ? "y" : "x";
      ...
      function $b({ fieldOrDatumDef: e, scaleType: n, size: t, values: i }) {
        ...
        if (!i && !mo(n) && n !== "log") {
          if (fu(e)) {
            ...
            if (e.timeUnit && F(["month", "hours", "day", "quarter"], (r = $s(e.timeUnit)) === null || r === void 0 ? void 0 : r.unit)) {
              return undefined;
            }
          }
      ...
      function Nb(e, n) {
        ...
        const { titleAnchor: s, titleAngle: o, titleOrient: a } = Pb(["titleAnchor", "titleAngle", "titleOrient"], r.header, i, n);
        const u = Eb(n, a);
        const c = ie(o);
        return {
          name: `${n}-title`,
          ...
          title: Object.assign(
            Object.assign(
              Object.assign(Object.assign(Object.assign({ text: t }, n === "row" ? { orient: "left" } : {}), { style: "guide-title" }), Mb(c, u)),
              Tb(u, c, s)
            ),
            Gb(i, r, n, dl, ll)
          ),
      ...
      function sy(e, { fieldOrDatumDef: n, model: t, channel: i, legendCmpt: s, legendType: o }) {
        ...
        if (O.fill) {
          if (i === "fill" || (v && i === je)) {
            ...
            if (O.fill["field"]) {
              ...
              const e =
                (g = (p = ly((d = h.fill) !== null && d !== void 0 ? d : h.color)) !== null && p !== void 0 ? p : m.fill) !== null && g !== void 0
                  ? g
                  : v && m.color;
              if (e) {
                O.fill = Xt(e);
        ...
        if (i !== Ce) {
          ...
          if (e) {
            O.opacity = [Object.assign({ test: e }, Xt(F !== null && F !== void 0 ? F : 1)), Xt(b.legend.unselectedOpacity)];
          } else if (F) {
            O.opacity = Xt(F);
          }
        }
      ...
      function ay(e, { fieldOrDatumDef: n, model: t, channel: i, legendCmpt: r }) {
        ...
        if (Sa(l)) {
          ...
          if (n.type === "quantitative" && o.numberFormatType) {
            f = za({ fieldOrDatumDef: n, field: "datum.value", format: o.numberFormat, formatType: o.numberFormatType, config: o });
          } else if (n.type === "temporal" && o.timeFormatType && fu(n) && n.timeUnit === undefined) {
            f = za({ fieldOrDatumDef: n, field: "datum.value", format: o.timeFormat, formatType: o.timeFormatType, config: o });
          }
        }
      ...
      const py = {
        ...
        gradientLength: (e) => {
          ...
          return (t = (n = i.gradientLength) !== null && n !== void 0 ? n : r.gradientLength) !== null && t !== void 0 ? t : xy(e);
        },
        labelOverlap: ({ legend: e, legendConfig: n, scaleType: t }) => {
          var i, r;
          return (r = (i = e.labelOverlap) !== null && i !== void 0 ? i : n.labelOverlap) !== null && r !== void 0 ? r : jy(t);
        },
      ...
      function xy({ legendConfig: e, model: n, direction: t, orient: i, scaleType: r }) {
        const { gradientHorizontalMaxLength: s, gradientHorizontalMinLength: o, gradientVerticalMaxLength: a, gradientVerticalMinLength: u } = e;
        if (bo(r)) {
          if (t === "horizontal") {
            if (i === "top" || i === "bottom") {
      ...
      function ky(e, n) {
        ...
        for (const j of ["labels", "legend", "title", "symbols", "gradient", "entries"]) {
          ...
          if (t !== undefined && !z(t)) {
            x[j] = Object.assign(
              Object.assign(
                Object.assign({}, (O === null || O === void 0 ? void 0 : O.length) && fu(p) ? { name: `${q(p.field)}_legend_${j}` } : {}),
      ...
      function zy(e, n) {
        ...
        if (a !== undefined) {
          let e = a;
          if (
            ((r = (i = c.encode) === null || i === void 0 ? void 0 : i.labels) === null || r === void 0 ? void 0 : r.update) &&
      ...
      function Ry(e) {
        ...
        if (e.hasProjection) {
          ...
          const o = new qy(
            ...
            Object.assign(Object.assign({}, (n = Pt(e.config.projection)) !== null && n !== void 0 ? n : {}), t !== null && t !== void 0 ? t : {}),
            r,
            s
          );
          if (!o.get("type")) {
      ...
      function Yy(e, n, t, i) {
        var r, s;
        if (ec(n, t)) {
          const o = ZO(e) ? ((s = (r = e.axis(t)) !== null && r !== void 0 ? r : e.legend(t)) !== null && s !== void 0 ? s : {}) : {};
          const a = Du(n, { expr: "datum" });
          const u = Du(n, { expr: "datum", binSuffix: "end" });
          return { formulaAs: Du(n, { binSuffix: "range", forAs: true }), formula: Ra(a, u, o.format, o.formatType, i) };
        }
        return {};
      }
      function Ky(e, n) {
      ...
      function Jy(e, n, t) {
        ...
        const l = Object.assign(
          Object.assign(Object.assign({ bin: o, field: e.field, as: [i] }, u ? { signal: u } : {}), c ? { extentSignal: c } : {}),
          s ? { span: s } : {}
        );
        ...
        assemble() {
          return T(this.bins).flatMap((e) => {
            ...
            const a = Object.assign(
              Object.assign(
                Object.assign({ type: "bin", field: Y(e.field), as: t, signal: e.signal }, !St(s) ? { extent: s } : { extent: null }),
        ...
        assembleFacetHeaderData(e) {
          ...
          for (const c of _b) {
            ...
            if (o[c]) {
              ...
              const n = c === "row" ? (i ? { signal: `ceil(${e} / ${i})` } : 1) : i ? { signal: `min(${e}, ${i})` } : { signal: e };
      ...
      class cv extends ep {
        ...
        static makeExplicit(e, n, t) {
          ...
          let r = {};
          const s = n.data;
          if (!Md(s) && ((i = s === null || s === void 0 ? void 0 : s.format) === null || i === void 0 ? void 0 : i.parse)) {
            r = s.format.parse;
          }
      ...
      class zv extends ep {
        ...
        static makeFromTransform(e, n) {
          ...
          return new zv(e, { dimensionFieldDefs: [], stackField: t, groupby: i, offset: o, sort: c, facetby: [], as: l });
        }
        static makeFromEncoding(e, n) {
          const t = n.stack;
          const { encoding: i } = n;
        ...
        assemble() {
          const e = [];
          const { facetby: n, dimensionFieldDefs: t, stackField: i, stackby: r, sort: s, offset: o, impute: a, as: u } = this._stack;
          if (a) {
            for (const s of t) {
              ...
              if (o) {
                ...
                e.push({ type: "formula", expr: `${t}*${n}+${1 - t}*${i}`, as: Du(s, { binSuffix: "mid", forAs: true }) });
              }
              e.push({ type: "impute", field: i, groupby: [...r, ...n], key: Du(s, { binSuffix: "mid" }), method: "value", value: 0 });
            }
          }
      ...
      class Nv extends ep {
        ...
        assemble() {
          ...
          return Object.assign(
            Object.assign(
              Object.assign({ type: "window", params: r, as: i, ops: t, fields: n, sort: c }, l !== undefined ? { ignorePeers: l } : {}),
      ...
      function nO(e, n, t, i) {
        ...
        if (n === "unaggregated") {
        ...
        } else if (f.timeUnit && F(["time", "utc"], e) && ou(f, ZO(t) ? t.encoding[yn(i)] : undefined, t.markDef, t.config)) {
          const e = t.requestDataName(Rd.Main);
          return Sd([
          ...
          return Sd([{ data: L(l) ? t.requestDataName(Rd.Main) : t.requestDataName(Rd.Raw), field: t.vgField(i), sort: l }]);
        } else {
          return Sd([{ data: t.requestDataName(Rd.Main), field: t.vgField(i) }]);
        }
      }
      function tO(e, n) {
        ...
        return Object.assign(Object.assign({ op: t !== null && t !== void 0 ? t : n ? "sum" : Wa }, i ? { field: Y(i) } : {}), r ? { order: r } : {});
      }
      function iO(e, n) {
        var t;
              ...
              switch (d) {
                case "range": {
                  ...
                  if ((0, r.cy)(i)) {
                    ...
                    return Cd({ data: n.requestDataName(Rd.Main), field: i.field, sort: { op: "min", field: n.vgField(e) } });
                  }
                  return Cd(i);
                }
                case "scheme":
      ...
      const PO = {
        ...
        nice: ({ scaleType: e, channel: n, domain: t, domainMin: i, domainMax: r, fieldOrDatumDef: s }) => MO(e, n, t, i, r, s),
        padding: ({ channel: e, scaleType: n, fieldOrDatumDef: t, markDef: i, config: r }) => LO(e, n, r.scale, t, i, r.bar),
      ...
      function MO(e, n, t, i, s, o) {
        var a;
        if (((a = Uu(o)) === null || a === void 0 ? void 0 : a.bin) || (0, r.cy)(t) || s != null || i != null || F([no.TIME, no.UTC], e)) {
          return undefined;
        }
        ...
        constructor(e, n, t, i, r, s, o) {
          ...
          this.component = {
            data: {
              ...
              isFaceted: Ja(e) || ((t === null || t === void 0 ? void 0 : t.component.data.isFaceted) && e.data === undefined),
            },
            layoutSize: new kd(),
      ...
      class dx extends ep {
          ...
          if (fu(i) && fu(r)) {
            ...
            return new dx(
              ...
              Object.assign(
                Object.assign(
                  Object.assign(
                    Object.assign(Object.assign({ impute: s.field, key: o.field }, a ? { method: a } : {}), u !== undefined ? { value: u } : {}),
                    c ? { frame: c } : {}
                  ),
        ...
        assemble() {
          ...
          const a = Object.assign(
            Object.assign(
              Object.assign(Object.assign({ type: "impute", field: e, key: n }, t ? { keyvals: Rf(t) ? this.processSequence(t) : t } : {}), {
                method: "value",
              }),
              r ? { groupby: r } : {}
            ),
      ...
      class mx extends ep {
        ...
        assemble() {
          ...
          if (this.transform.from.fields) {
            e = Object.assign({ values: this.transform.from.fields }, this.transform.as ? { as: (0, r.YO)(this.transform.as) } : {});
          } else {
      ...
      class Ox extends ep {
        ...
        addDimensions(e) {
          var n;
          this.transform.groupby = C(((n = this.transform.groupby) !== null && n !== void 0 ? n : []).concat(e), (e) => e);
        }
        producedFields() {
          return undefined;
        }
      ...
      function Ax(e, n) {
        ...
        if (e.channelHasField(n)) {
          ...
          const d = u.header !== null ? X((t = u.header) === null || t === void 0 ? void 0 : t.labels, s.header.labels, true) : false;
          const p = F(["bottom", "right"], f) ? "footer" : "header";
          a.layoutHeaders[n] = { title: u.header !== null ? l : null, facetFieldDef: u, [p]: n === "facet" ? [] : [kx(e, n, d)] };
        }
      }
      function kx(e, n, t) {
      ...
      class Tx extends rx {
        ...
        assembleGroup(e) {
          if (this.parent && this.parent instanceof Tx) {
            return Object.assign(
              Object.assign(
                {},
                this.channelHasField("column") ? { encode: { update: { columns: { field: Du(this.facet.column, { prefix: "distinct" }) } } } } : {}
              ),
        ...
        assembleFacet() {
          ...
          return Object.assign(
            ...
            c || s.length > 0
              ? { aggregate: Object.assign(Object.assign({}, c ? { cross: c } : {}), s.length ? { fields: s, ops: o, as: a } : {}) }
              : {}
          );
        }
        facetSortFields(e) {
              ...
              Object.assign(
                Object.assign(
                  Object.assign(Object.assign({ name: this.getName("cell"), type: "group" }, r ? { title: r } : {}), s ? { style: s } : {}),
                  {
                    ...
                    sort: { field: Je.map((e) => this.facetSortFields(e)).flat(), order: Je.map((e) => this.facetSortOrder(e)).flat() },
                  }
                ),
                t.length > 0 ? { data: t } : {}
              ),
        ...
        if (t && i) {
          ...
          for (const r of [t, i]) {
            if (Ka(r.sort)) {
              ...
              e = n = new Bv(e, { joinaggregate: [{ op: i, field: t, as: Nx(r, r.sort, { forAs: true }) }], groupby: [Du(r)] });
            }
          }
          return n;
        }
      ...
      function Rx(e) {
        ...
        const y = uv(e);
        const v = av(e);
        f = (r = cv.makeWithAncestors(f, {}, Object.assign(Object.assign({}, y), v), h)) !== null && r !== void 0 ? r : f;
        if (ZO(e)) {
          f = lx.parseAll(f, e);
          f = fx.parseAll(f, e);
        }
      ...
      function Kx(e, n, t) {
        ...
        if (Sa(c)) {
          return Object.assign({ text: za({ fieldOrDatumDef: o, field: "datum.value", format: u, formatType: c, config: s }) }, t);
          ...
          if (du(o) === "quantitative") {
            if (xu(o) && o.stack === "normalize" && s.normalizedNumberFormatType) {
              ...
              return Object.assign(
                { text: za({ fieldOrDatumDef: o, field: "datum.value", format: s.numberFormat, formatType: s.numberFormatType, config: s }) },
                t
              );
            }
          }
          if (du(o) === "temporal" && s.timeFormatType && fu(o) && !o.timeUnit) {
            return Object.assign(
              { text: za({ fieldOrDatumDef: o, field: "datum.value", format: s.timeFormat, formatType: s.timeFormatType, config: s }) },
              t
            );
          }
        }
      ...
      const nw = new Set(["grid", "translate", "format", "formatType", "orient", "labelExpr", "tickCount", "position", "tickMinStep"]);
      function tw(e, n) {
        var t, i, r;
        let s = n.axis(e);
        const o = new Yx();
        ...
        const p = s !== undefined ? !s : gb("disable", c.style, s === null || s === void 0 ? void 0 : s.style, d).configValue;
        ...
        const m = { fieldOrDatumDef: a, axis: s, channel: e, model: n, scaleType: f, orient: l, labelAngle: g, mark: u, config: c };
        for (const y of Gx) {
          ...
          if (i && r) {
            ...
            const { configValue: e = undefined, configFrom: n = undefined } = ac(y) && y !== "values" ? gb(y, c.style, s.style, d) : {};
            const a = e !== undefined;
            if (i && !a) {
              o.set(y, t, r);
          ...
          Object.assign(
            Object.assign(
              Object.assign(
                ...
                Up("x", e, { defaultPos: "zeroOrMin", defaultPos2: "zeroOrMin", range: e.markDef.orient === "horizontal" })
              ),
          ...
          return Object.assign(
            Object.assign(
              Object.assign(
                ...
                Up("x", e, { defaultPos: t === "horizontal" ? "zeroOrMax" : "mid", defaultPos2: "zeroOrMin", range: t !== "vertical" })
              ),
              Up("y", e, { defaultPos: t === "vertical" ? "zeroOrMax" : "mid", defaultPos2: "zeroOrMin", range: t !== "horizontal" })
            ),
            Ep("size", e, { vgChannel: "strokeWidth" })
          );
        },
      ...
      function Pw(e) {
        ...
        const c = ["stroke", "strokeWidth", "strokeJoin", "strokeCap", "strokeDash", "strokeDashOffset", "strokeMiterLimit", "strokeOpacity"];
        o = c.reduce((n, i) => {
        ...
        if ((!(0, r.cy)(u) && vu(u) && j(u.value)) || (!u && j(ii("order", o, a)))) {
          ...
          if (fu(s)) {
            ...
            if ((0, r.cy)(t)) {
              ...
              return { field: Du(s, { binSuffix: ((n = e.stack) === null || n === void 0 ? void 0 : n.impute) ? "mid" : undefined, expr: "datum" }) };
            }
          }
          return undefined;
        }
            ...
            Object.assign(
              Object.assign(
                Object.assign(
                  Object.assign(
                    Object.assign(
                      Object.assign(Object.assign({ name: e.getName("marks"), type: kw[t].vgMark }, o ? { clip: true } : {}), a ? { style: a } : {}),
                      u ? { key: u.field } : {}
                    ),
                    c ? { sort: c } : {}
                  ),
      ...
      function Ww(e, n, t, i) {
        ...
        return Object.assign(
          Object.assign(
            Object.assign({}, N(n).length === 1 && n.type ? (n.type === "pad" ? {} : { autosize: n.type }) : { autosize: n }),
            Ad(t, false)
          ),
          Ad(e, true)
        );
