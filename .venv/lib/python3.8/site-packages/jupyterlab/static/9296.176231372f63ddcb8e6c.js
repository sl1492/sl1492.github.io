  ...
  [9296],
  {
    49296: (t, e, i) => {
      ...
      i.d(e, {
        ...
        WidgetType: () => kt,
        __test: () => Sr,
        closeHoverTooltips: () => Pn,
        crosshairCursor: () => un,
        drawSelection: () => Mo,
        dropCursor: () => Ho,
        getDrawSelectionConfig: () => ko,
        getPanel: () => Wn,
        getTooltip: () => Bn,
        gutter: () => jn,
        gutterLineClass: () => Xn,
        gutters: () => Un,
        hasHoverTooltips: () => Ln,
        highlightActiveLine: () => Zo,
        highlightActiveLineGutter: () => ur,
        highlightSpecialChars: () => Yo,
        highlightTrailingWhitespace: () => yr,
        highlightWhitespace: () => vr,
        hoverTooltip: () => Rn,
        keymap: () => oo,
        layer: () => yo,
        lineNumberMarkers: () => or,
        lineNumbers: () => hr,
        logException: () => we,
        panels: () => Fn,
        placeholder: () => on,
        rectangularSelection: () => cn,
        repositionTooltips: () => Vn,
        runScopeHandlers: () => lo,
        scrollPastEnd: () => Jo,
        showPanel: () => qn,
        showTooltip: () => Mn,
      ...
      function b(t) {
        if (t.nodeType == 3) return H(t, 0, t.nodeValue.length).getClientRects();
      ...
      class E {
        ...
        setRange(t) {
          ...
          this.set(e, Math.min(t.anchorOffset, e ? k(e) : 0), i, Math.min(t.focusOffset, i ? k(i) : 0));
        }
        set(t, e, i, s) {
          this.anchorNode = t;
          this.anchorOffset = e;
      ...
      class I {
        ...
        static before(t, e) {
          return new I(t.parentNode, S(t), e);
        }
        static after(t, e) {
          return new I(t.parentNode, S(t) + 1, e);
        }
      }
      const q = [];
      class Y {
      ...
      var rt = {
        ...
        webkit: st,
        safari: ot,
        webkit_version: st ? +(/\bAppleWebKit\/(\d+)/.exec(navigator.userAgent) || [0, 0])[1] : 0,
      ...
      class at extends Y {
        ...
        merge(t, e, i) {
          if (this.flags & 8 || (i && (!(i instanceof at) || this.length - (e - t) + i.length > lt || i.flags & 8))) return false;
      ...
      class ht extends Y {
        ...
        merge(t, e, i, s, o, n) {
          if (i && (!(i instanceof ht && i.mark.eq(this.mark)) || (t && o <= 0) || (e < this.length && n <= 0))) return false;
      ...
      class ft extends Y {
        ...
        split(t) {
          let e = ft.create(this.widget, this.length - t, this.side);
          this.length -= t;
          return e;
        }
        sync(t) {
        ...
        merge(t, e, i, s, o, n) {
          if (i && (!(i instanceof ft) || !this.widget.compare(i.widget) || (t > 0 && o <= 0) || (e < this.length && n <= 0))) return false;
          this.length = t + (i ? i.length : 0) + (this.length - e);
          return true;
        }
        become(t) {
          if (t instanceof ft && t.side == this.side && this.widget.constructor == t.widget.constructor) {
      ...
      at.prototype.children = ft.prototype.children = dt.prototype.children = q;
      function ut(t, e) {
        let i = t.dom,
          { children: s } = t,
          o = 0;
      ...
      class xt extends Y {
        ...
        merge(t, e, i, s, o, n) {
          if (i) {
            if (!(i instanceof xt)) return false;
      ...
      class Mt extends Y {
        ...
        merge(t, e, i, s, o, n) {
          if (i && (!(i instanceof Mt) || !this.widget.compare(i.widget) || (t > 0 && o <= 0) || (e < this.length && n <= 0))) return false;
          this.length = t + (i ? i.length : 0) + (this.length - e);
          return true;
        }
        domAtPos(t) {
        ...
        split(t) {
          let e = this.length - t;
          this.length = t;
          let i = new Mt(this.widget, e, this.deco);
        ...
        become(t) {
          if (t instanceof Mt && t.widget.constructor == this.widget.constructor) {
      ...
      At.none = s.RangeSet.empty;
      class Dt extends At {
        constructor(t) {
          let { start: e, end: i } = Et(t);
      ...
      Dt.prototype.point = false;
      class Tt extends At {
        constructor(t) {
          super(-2e8, -2e8, null, t);
        }
        eq(t) {
          return t instanceof Tt && this.spec.class == t.spec.class && bt(this.spec.attributes, t.spec.attributes);
        }
        range(t, e = t) {
      ...
      Tt.prototype.mapMode = s.MapMode.TrackBefore;
      Tt.prototype.point = true;
      class Ot extends At {
        ...
        get type() {
          return this.startSide != this.endSide ? Ct.WidgetRange : this.startSide <= 0 ? Ct.WidgetBefore : Ct.WidgetAfter;
        }
        get heightRelevant() {
          return this.block || (!!this.widget && (this.widget.estimatedHeight >= 5 || this.widget.lineBreaks > 0));
        }
        eq(t) {
          return t instanceof Ot && Rt(this.widget, t.widget) && this.block == t.block && this.startSide == t.startSide && this.endSide == t.endSide;
        }
        range(t, e = t) {
      ...
      class Lt {
        ...
        posCovered() {
          ...
          return !(t.breakAfter || (t instanceof Mt && t.deco.endSide < 0));
        }
        getLine() {
          if (!this.curLine) {
            this.content.push((this.curLine = new xt()));
            this.atCursorPos = true;
          }
          return this.curLine;
        }
        flushBuffer(t = this.bufferMarks) {
          if (this.pendingBuffer) {
            this.curLine.append(Ht(new dt(-1), t), t.length);
            this.pendingBuffer = 0;
          }
        }
        addBlockWidget(t) {
        ...
        finish(t) {
          ...
          if (!this.posCovered() && !(t && this.content.length && this.content[this.content.length - 1] instanceof Mt)) this.getLine();
        }
        buildText(t, e, i) {
          while (t > 0) {
            ...
            this.getLine().append(Ht(new at(this.text.slice(this.textOff, this.textOff + s)), e), i);
            this.atCursorPos = true;
            this.textOff += s;
            t -= s;
            i = 0;
        ...
        point(t, e, i, s, o, n) {
          ...
          if (i instanceof Ot) {
            if (i.block) {
              ...
              this.addBlockWidget(new Mt(i.widget || Pt.block, r, i));
            } else {
              let n = ft.create(i.widget || Pt.inline, r, r ? 0 : i.startSide);
      ...
      function Gt(t, e) {
        ...
        for (let i = 0; i < t.length; i++) {
          let s = t[i],
            o = e[i];
          if (s.from != o.from || s.to != o.to || s.direction != o.direction || !Gt(s.inner, o.inner)) return false;
        }
        return true;
      }
      const jt = [];
      function $t(t, e, i, s, o) {
        for (let n = 0; n <= s.length; n++) {
          ...
          for (let t = r, e = a, s = a; t < l; t++) {
            let o = jt[t];
            if (o == 128) {
              if (t < l - 1 && e == jt[t + 1] && e & 24) o = jt[t] = e;
              else jt[t] = 256;
            } else if (o == 64) {
              let o = t + 1;
              while (o < l && jt[o] == 64) o++;
              let n = (t && e == 8) || (o < i && jt[o] == 8) ? (s == 1 ? 1 : 8) : 256;
              for (let e = t; e < o; e++) jt[e] = n;
              t = o - 1;
            } else if (o == 8 && s == 1) {
              jt[t] = 1;
            }
            ...
            t: for (;;) {
              if (h < n.length && u == n[h].from) {
                ...
                if (f) {
                  ...
                  if (p.from > a) r.push(new _t(a, p.from, d));
                  let e = (p.direction == Nt) != !(d % 2);
                  Zt(t, e ? s + 1 : s, o, p.inner, p.from, p.to, r);
                  a = p.to;
                }
                u = p.to;
              } else if (u == i || (e ? jt[u] != l : jt[u] == l)) {
                break;
              } else {
                u++;
              }
            }
            if (f) Jt(t, a, u, s + 1, o, f, r);
            else if (a < u) r.push(new _t(a, u, d));
            a = u;
          }
        } else {
              ...
              if (h && u == n[h - 1].to) {
                ...
                if (!i)
                  for (let t = p.from, i = h; ; ) {
                    ...
                    else if (jt[t - 1] == l) break t;
                    else break;
                  }
                if (f) {
                  f.push(p);
                } else {
                  if (p.to < a) r.push(new _t(p.to, a, d));
                  let e = (p.direction == Nt) != !(d % 2);
                  Zt(t, e ? s + 1 : s, o, p.inner, p.from, p.to, r);
                  a = p.from;
                }
                u = p.from;
              } else if (u == e || (i ? jt[u - 1] != l : jt[u - 1] == l)) {
                break;
              } else {
                u--;
              }
            }
            if (f) Jt(t, u, a, s + 1, o, f, r);
            else if (u < a) r.push(new _t(u, a, d));
            a = u;
          }
        }
      }
      ...
      function te(t, e, i) {
        if (!t) return [new _t(0, 0, e == Ft ? 1 : 0)];
        if (e == Nt && !i.length && !Xt.test(t)) return ee(t.length);
        if (i.length) while (t.length > jt.length) jt[jt.length] = 256;
        let s = [],
          o = e == Nt ? 0 : 1;
        Zt(t, o, o, i, 0, t.length, s);
        return s;
      }
      function ee(t) {
        return [new _t(0, t, 0)];
      ...
      let ie = "";
      function se(t, e, i, o, n) {
        var r;
        let l = o.head - t.from;
        let a = _t.find(e, l, (r = o.bidiLevel) !== null && r !== void 0 ? r : -1, o.assoc);
        let h = e[a],
          c = h.side(n, i);
        if (l == c) {
          let t = (a += n ? 1 : -1);
        ...
        ie = t.text.slice(Math.min(l, f), Math.max(l, f));
      ...
      function oe(t, e, i) {
        for (let s = e; s < i; s++) {
          let e = Yt(t.charCodeAt(s));
          if (e == 1) return Nt;
          if (e == 2 || e == 4) return Ft;
        }
        return Nt;
      }
      ...
      const de = s.Facet.define({ combine: (t) => t.some((t) => t) });
      const ue = s.Facet.define({ combine: (t) => t.some((t) => t) });
      ...
      class ge {
        ...
        clip(t) {
          return this.range.to <= t.doc.length
            ? this
            : new ge(s.EditorSelection.cursor(t.doc.length), this.y, this.x, this.yMargin, this.xMargin, this.isSnapshot);
        }
      }
      const me = s.StateEffect.define({ map: (t, e) => t.map(e) });
      function we(t, e, i) {
        let s = t.facet(ae);
        if (s.length) s[0](e);
      ...
      const ve = s.Facet.define({ combine: (t) => (t.length ? t[0] : true) });
      let be = 0;
      ...
      class Se {
        ...
        static define(t, e) {
          ...
          return new Se(be++, t, i, s, (t) => {
            let e = [ye.of(t)];
            if (n)
              e.push(
                Ce.of((e) => {
                  let i = e.plugin(t);
                  return i ? n(i) : At.none;
                })
              );
            if (o) e.push(o(t));
            return e;
          ...
          if (!this.value) {
            if (this.spec) {
              try {
                ...
                we(t.state, e, "CodeMirror plugin crashed");
                this.deactivate();
              }
            }
        ...
        destroy(t) {
          ...
          if ((e = this.value) === null || e === void 0 ? void 0 : e.destroy) {
            try {
              ...
              we(t.state, i, "CodeMirror plugin crashed");
            }
          }
        }
        deactivate() {
      ...
      class Le {
        ...
        join(t) {
          return new Le(Math.min(this.fromA, t.fromA), Math.max(this.toA, t.toA), Math.min(this.fromB, t.fromB), Math.max(this.toB, t.toB));
        }
        addToSet(t) {
          let e = t.length,
            i = this;
        ...
        static extendWithRanges(t, e) {
          ...
          for (let s = 0, o = 0, n = 0, r = 0; ; s++) {
            ...
            while (o < e.length && e[o] < h) {
              ...
              let n = Math.max(r, t),
                l = Math.min(h, s);
              if (n <= l) new Le(n + a, l + a, n, l).addToSet(i);
              if (s > h) break;
              else o += 2;
            }
            if (!l) return i;
            new Le(l.fromA, l.toA, l.fromB, l.toB).addToSet(i);
            n = l.toA;
            r = l.toB;
          }
        }
      ...
      class He {
        constructor(t, e, i) {
          ...
          let o = [];
          this.changes.iterChangedRanges((t, e, i, s) => o.push(new Le(t, e, i, s)));
      ...
      class Pe extends Y {
        ...
        constructor(t) {
          ...
          this.updateDeco();
          this.updateInner([new Le(0, 0, 0, t.state.doc.length)], 0, null);
        }
        update(t) {
          var e;
          ...
          if (this.view.inputState.composing >= 0) {
            ...
            else if (!Ye(t.changes, this.hasComposition) && !t.selectionSet) s = t.state.selection.main.head;
          }
          let o = s > -1 ? We(this.view, t.changes, s) : null;
          this.domChanged = null;
          if (this.hasComposition) {
            this.markedForComposition.clear();
            let { from: e, to: s } = this.hasComposition;
            i = new Le(e, s, t.changes.mapPos(e, -1), t.changes.mapPos(s, 1)).addToSet(i.slice());
          }
          this.hasComposition = o ? { from: o.range.fromB, to: o.range.toB } : null;
          if ((rt.ie || rt.chrome) && !o && t && t.state.doc.lines != t.startState.doc.lines) this.forceSelection = true;
          let n = this.decorations,
            r = this.updateDeco();
          let l = Ie(n, r, t.changes);
          i = Le.extendWithRanges(i, l);
        ...
        updateInner(t, e, i) {
          ...
          if (this.view.viewport.from || this.view.viewport.to < this.view.state.doc.length)
            for (let n of this.children) if (n instanceof Mt && n.widget instanceof Ne) o.push(n.dom);
          s.updateGaps(o);
        }
        updateChildren(t, e, i) {
          ...
          for (let n = s.length - 1; ; n--) {
            ...
            if (i && i.range.fromB < a && i.range.toB > l) {
              let t = Lt.build(this.view.state.doc, l, i.range.fromB, this.decorations, this.dynamicDecorationMap);
              let e = Lt.build(this.view.state.doc, i.range.toB, a, this.decorations, this.dynamicDecorationMap);
              c = t.breakAtStart;
              f = t.openStart;
              d = e.openEnd;
              ...
              ({
                ...
                openStart: f,
                openEnd: d,
              } = Lt.build(this.view.state.doc, l, a, this.decorations, this.dynamicDecorationMap));
            }
            let { i: u, off: p } = o.findPos(r, 1);
            let { i: g, off: m } = o.findPos(e, -1);
            G(this, g, m, u, p, h, c, f, d);
          }
        ...
        updateSelection(t = false, e = false) {
          ...
          if (rt.gecko && r.empty && !this.hasComposition && Ve(l)) {
          ...
          if (
            ...
            this.view.observer.ignore(() => {
              if (rt.android && rt.chrome && this.dom.contains(h.focusNode) && qe(h.focusNode, this.dom)) {
                this.dom.blur();
              ...
              if (!t);
                ...
                if (rt.gecko) {
                  let t = ze(l.node, l.offset);
                  if (t && t != (1 | 2)) {
                    let e = (t == 1 ? z : K)(l.node, l.offset);
        ...
        moveToLine(t) {
          ...
          for (let s = t.offset; !i && s < e.childNodes.length; s++) {
            ...
            if (t instanceof xt) i = t.domAtPos(0);
          }
          for (let s = t.offset - 1; !i && s >= 0; s--) {
            let t = Y.get(e.childNodes[s]);
            if (t instanceof xt) i = t.domAtPos(t.length);
          }
        ...
        domAtPos(t) {
          ...
          for (; e < this.children.length - 1; ) {
            ...
            if (i < t.length || t instanceof xt) break;
            e++;
            i = 0;
          }
        ...
        coordsAt(t, e) {
          ...
          for (let o = this.length, n = this.children.length - 1; n >= 0; n--) {
            let r = this.children[n],
              ...
              a = l - r.length;
            if (l < t) break;
            if (a <= t && (a < t || r.covers(-1)) && (l > t || r.covers(1)) && (!i || (r instanceof xt && !(i instanceof xt && e >= 0)))) {
              i = r;
              s = a;
            }
            o = a;
        ...
        coordsForChar(t) {
          let { i: e, off: i } = this.childPos(t, 1),
            o = this.children[e];
          if (!(o instanceof xt)) return null;
          ...
          if (n == i) return null;
          let r = H(o.dom, i, n).getClientRects();
        ...
        computeBlockGapDeco() {
          ...
          for (let i = 0, s = 0; ; s++) {
            ...
            if (n > i) {
              ...
              t.push(At.replace({ widget: new Ne(s), block: true, inclusive: true, isBlockGap: true }).range(i, n));
            }
            if (!o) break;
            i = o.to + 1;
          }
        ...
        updateDeco() {
          let t = 0;
          let e = this.view.state.facet(Ce).map((e) => {
          ...
          this.decorations = [...e, this.computeBlockGapDeco(), this.view.viewState.lineGapDeco];
        ...
        scrollIntoView(t) {
          ...
          for (let h of this.view.state.facet(pe)) {
            try {
              if (h(this.view, t.range, t)) return true;
            } catch (a) {
              we(this.view.state, a, "scroll handler");
            }
          }
          let { range: e } = t;
      ...
      function Fe(t, e) {
        ...
        let o = K(i.focusNode, i.focusOffset);
        let n = s || o;
      ...
      function We(t, e, i) {
        ...
        let h = new Le(a.mapPos(n), a.mapPos(r), n, r);
        let c = [];
        for (let f = o.parentNode; ; f = f.parentNode) {
          let e = Y.get(f);
          if (e instanceof ht) c.push({ node: f, deco: e.mark });
          else if (e instanceof xt || (f.nodeName == "DIV" && f.parentNode == t.contentDOM)) return { range: h, text: o, marks: c, line: f };
          else if (f != t.contentDOM) c.push({ node: f, deco: new Dt({ inclusive: true, attributes: St(f), tagName: f.tagName.toLowerCase() }) });
          else return null;
        }
      }
      function ze(t, e) {
      ...
      function Qe(t, e, i) {
        ...
        for (let p = t.firstChild; p; p = p.nextSibling) {
          ...
          for (let d = 0; d < t.length; d++) {
            let u = t[d];
            if (o && je(o, u)) u = $e(Ue(u, o.bottom), o.top);
            let g = _e(e, u),
              m = Ge(i, u);
            if (g == 0 && m == 0) return p.nodeType == 3 ? Je(p, e, i) : Qe(p, e, i);
            if (!s || r > m || (r == m && n > g)) {
              s = p;
              o = u;
              n = g;
        ...
        if (s.nodeType == 3) return Je(s, d, i);
        if (l && s.contentEditable != "false") return Qe(s, d, i);
      ...
      function Je(t, e, i) {
        ...
        let o = -1,
          ...
          r = 0;
        for (let l = 0; l < s; l++) {
          let s = H(t, l, l + 1).getClientRects();
          for (let a = 0; a < s.length; a++) {
            ...
            if (h.left - 1 <= e && h.right + 1 >= e && c < n) {
              let i = e >= (h.left + h.right) / 2,
                s = i;
              if (rt.chrome || rt.gecko) {
                let e = H(t, l).getBoundingClientRect();
      ...
      function Ze(t, e, i, s = -1) {
        ...
        f = l + d;
        let u = a.from;
        if (u < t.viewport.from) return t.viewport.from == 0 ? 0 : i ? null : ti(t, r, a, c, f);
        if (u > t.viewport.to) return t.viewport.to == t.state.doc.length ? t.state.doc.length : i ? null : ti(t, r, a, c, f);
        ...
        if (m && ((o = t.docView.nearest(m)) === null || o === void 0 ? void 0 : o.isEditable) != false) {
          if (p.caretPositionFromPoint) {
            ...
            if (e) {
              ...
              if (!t.contentDOM.contains(w) || (rt.safari && ei(w, v, c)) || (rt.chrome && ii(w, v, c))) w = undefined;
            }
          }
        }
        if (!w || !t.docView.dom.contains(w)) {
          let e = xt.find(t.docView, u);
          if (!e) return d > a.top + a.height / 2 ? a.to : a.from;
          ({ node: w, offset: v } = Qe(e.dom, c, f));
        }
      ...
      function ei(t, e, i) {
        ...
        return H(t, s - 1, s).getBoundingClientRect().left > i;
      }
      function ii(t, e, i) {
        if (e != 0) return false;
        for (let o = t; ; ) {
        ...
        let s = t.nodeType == 1 ? t.getBoundingClientRect() : H(t, 0, Math.max(t.nodeValue.length, 1)).getBoundingClientRect();
        return i - s.left > 5;
      }
      function si(t, e) {
        ...
        if (Array.isArray(i.type))
          for (let s of i.type) {
            if (s.to > e || (s.to == e && (s.to == i.to || s.type == Ct.Text))) return s;
          }
        return i;
      }
      function oi(t, e, i, o) {
      ...
      class ci {
        ...
        constructor(t) {
          ...
          if (rt.gecko) $i(t.contentDOM.ownerDocument);
        }
        handleEvent(t) {
          if (!Mi(this.view, t) || this.ignoreDuringComposition(t)) return;
        ...
        keydown(t) {
          ...
          if (t.keyCode != 27 && gi.indexOf(t.keyCode) < 0) this.view.inputState.lastEscPress = 0;
          ...
          if (
            ...
            !t.altKey &&
            !t.metaKey &&
            (((e = ui.find((e) => e.keyCode == t.keyCode)) && !t.ctrlKey) || (pi.indexOf(t.key) > -1 && t.ctrlKey && !t.shiftKey))
          ) {
        ...
        for (let s of t) {
          ...
          if (t && t.domEventHandlers)
            for (let e in t.domEventHandlers) {
              ...
              if (o) i(e).handlers.push(fi(s.value, o));
            }
          if (t && t.domEventObservers)
            for (let e in t.domEventObservers) {
              let o = t.domEventObservers[e];
              if (o) i(e).observers.push(fi(s.value, o));
            }
        }
        for (let s in ki) i(s).handlers.push(ki[s]);
        for (let s in Ci) i(s).observers.push(Ci[s]);
        return e;
      }
      const ui = [
      ...
      const pi = "dthko";
      const gi = [16, 17, 18, 20, 91, 92, 224, 225];
      const mi = 6;
      function wi(t) {
      ...
      class bi {
        constructor(t, e, i, o) {
          ...
          this.scrolling = -1;
          this.lastEvent = e;
          this.scrollParent = O(t.contentDOM);
          this.atoms = t.state.facet(De).map((e) => e(t));
          ...
          this.multiple = t.state.facet(s.EditorState.allowMultipleSelections) && yi(t, e);
          this.dragging = xi(t, e) && Fi(e) == 1 ? null : false;
        }
        start(t) {
        ...
        move(t) {
          ...
          if (this.dragging || (this.dragging == null && vi(this.startEvent, t) < 10)) return;
          ...
          let n = Re(this.view);
          if (t.clientX - n.left <= o.left + mi) i = -wi(o.left - t.clientX);
          else if (t.clientX + n.right >= o.right - mi) i = wi(t.clientX - o.right);
          if (t.clientY - n.top <= o.top + mi) s = -wi(o.top - t.clientY);
          else if (t.clientY + n.bottom >= o.bottom - mi) s = wi(t.clientY - o.bottom);
        ...
        skipAtoms(t) {
          ...
          for (let i = 0; i < t.ranges.length; i++) {
            let o = t.ranges[i],
              n = null;
            if (o.empty) {
              let t = ai(this.atoms, o.from, 0);
              if (t != o.from) n = s.EditorSelection.cursor(t, -1);
            } else {
              let t = ai(this.atoms, o.from, -1);
              let e = ai(this.atoms, o.to, 1);
      ...
      const Ai = (rt.ie && rt.ie_version < 15) || (rt.ios && rt.webkit_version < 604);
      function Di(t) {
      ...
      function Ti(t, e) {
        ...
        let a = Yi != null && i.selection.ranges.every((t) => t.empty) && Yi == r.toString();
        if (a) {
          let t = -1;
          o = i.changeByRange((o) => {
      ...
      ki.mousedown = (t, e) => {
        ...
        let i = null;
        for (let s of t.state.facet(le)) {
          i = s(t, e);
          if (i) break;
        }
        if (!i && e.button == 0) i = Wi(t, e);
        if (i) {
          let s = !t.hasFocus;
          t.inputState.startMouseSelection(new bi(t, e, i, s));
          if (s) t.observer.ignore(() => B(t.contentDOM));
      ...
      let Ei = (t, e) => t >= e.top && t <= e.bottom;
      let Ri = (t, e, i) => Ei(e, i) && t >= i.left && t <= i.right;
      function Bi(t, e, i, s) {
        let o = xt.find(t.docView, e);
        if (!o) return 1;
        let n = e - o.posAtStart;
        if (n == 0) return 1;
        if (n == o.length) return -1;
        let r = o.coordsAt(n, -1);
        if (r && Ri(i, s, r)) return -1;
        let l = o.coordsAt(n, 1);
        if (l && Ri(i, s, l)) return 1;
        return r && Ei(s, r) ? -1 : 1;
      }
      function Li(t, e) {
        let i = t.posAtCoords({ x: e.clientX, y: e.clientY }, false);
        return { pos: i, bias: Bi(t, i, e.clientX, e.clientY) };
      }
      const Hi = rt.ie && rt.ie_version <= 11;
      let Pi = null,
        Vi = 0,
        Ni = 0;
      function Fi(t) {
        if (!Hi) return t.detail;
        let e = Pi,
          i = Ni;
        Pi = t;
        Ni = Date.now();
        return (Vi = !e || (i > Date.now() - 400 && Math.abs(e.clientX - t.clientX) < 2 && Math.abs(e.clientY - t.clientY) < 2) ? (Vi + 1) % 3 : 1);
      }
      function Wi(t, e) {
        let i = Li(t, e),
          o = Fi(e);
        ...
        return {
          ...
          get(e, r, l) {
            let a = Li(t, e),
              h;
            let c = Oi(t, a.pos, a.bias, o);
            if (i.pos != a.pos && !r) {
              let e = Oi(t, i.pos, i.bias, o);
            ...
            else if (l && o == 1 && n.ranges.length > 1 && (h = zi(n, a.pos))) return h;
      ...
      function Ki(t, e, i, s) {
        ...
        let r = s && n && Si(t, e) ? { from: n.from, to: n.to } : null;
      ...
      ki.drop = (t, e) => {
        ...
        if (i && i.length) {
          let s = Array(i.length),
            o = 0;
          let n = () => {
            if (++o == i.length) Ki(t, e, s.filter((t) => t != null).join(t.state.lineBreak), false);
          };
      ...
      ki.paste = (t, e) => {
        if (t.state.readOnly) return true;
        t.observer.flush();
        let i = Ai ? null : e.clipboardData;
        if (i) {
          Ti(t, i.getData("text/plain") || i.getData("text/uri-list"));
          return true;
        } else {
          Di(t);
          return false;
      ...
      const Xi = s.Annotation.define();
      function _i(t, e) {
        let i = [];
        for (let s of t.facet(fe)) {
          let o = s(t, e);
          if (o) i.push(o);
        }
        return i ? t.update({ effects: i, annotations: Xi.of(true) }) : null;
      }
      function Gi(t) {
        setTimeout(() => {
          let e = t.hasFocus;
      ...
      ki.beforeinput = (t, e) => {
        var i;
        let s;
        if (rt.chrome && rt.android && (s = ui.find((t) => t.inputType == e.inputType))) {
        ...
        if (rt.safari && e.inputType == "insertText" && t.inputState.composing >= 0) {
          setTimeout(() => Ci.compositionend(t, e), 20);
        }
        return false;
      };
      const ji = new Set();
      ...
      const Ui = ["pre-wrap", "normal", "pre-line", "break-spaces"];
      class Qi {
        constructor(t) {
          this.lineWrapping = t;
        ...
        mustRefreshForWrapping(t) {
          return Ui.indexOf(t) > -1 != this.lineWrapping;
        }
      ...
      class Zi {
        ...
        get type() {
          return typeof this._content == "number" ? Ct.Text : Array.isArray(this._content) ? this._content : this._content.type;
        }
        get to() {
        ...
        join(t) {
          ...
          return new Zi(this.from, this.length + t.length, this.top, this.height + t.height, e);
        }
      }
      var ts = (function (t) {
        t[(t["ByPos"] = 0)] = "ByPos";
      ...
      class is {
        ...
        setHeight(t, e) {
          if (this.height != e) {
            if (Math.abs(this.height - e) > es) t.heightChanged = true;
            this.height = e;
          }
        }
        replace(t, e, i) {
        ...
        applyChanges(t, e, i, s) {
          ...
          for (let r = s.length - 1; r >= 0; r--) {
            ...
            let f = o.lineAt(l, ts.ByPosNoHeight, i.setDoc(e), 0, 0);
            let d = f.to >= a ? f : o.lineAt(a, ts.ByPosNoHeight, i, 0, 0);
            c += d.to - a;
            a = d.to;
            while (r > 0 && f.from <= s[r - 1].toA) {
              ...
              h = s[r - 1].fromB;
              r--;
              if (l < f.from) f = o.lineAt(l, ts.ByPosNoHeight, i, 0, 0);
            }
            h += f.from - l;
            l = f.from;
            let u = hs.build(i.setDoc(n), t, h, c);
            o = o.replace(l, a, u);
          }
        ...
        static of(t) {
          ...
          return new rs(is.of(t.slice(0, e)), n, is.of(t.slice(i)));
        }
      }
      is.prototype.size = 1;
      class ss extends is {
        ...
        blockAt(t, e, i, s) {
          return new Zi(s, this.length, i, this.height, this.deco || 0);
        }
        lineAt(t, e, i, s, o) {
      ...
      class os extends ss {
        ...
        blockAt(t, e, i, s) {
          return new Zi(s, this.length, i, this.height, this.breaks);
        }
        replace(t, e, i) {
          let s = i[0];
          if (i.length == 1 && (s instanceof os || (s instanceof ns && s.flags & 4)) && Math.abs(this.length - s.length) < 10) {
            if (s instanceof ns) s = new os(s.length, this.height);
      ...
      class ns extends is {
        ...
        blockAt(t, e, i, s) {
          ...
          if (e.lineWrapping) {
            ...
            return new Zi(n.from, n.length, h, a, 0);
          } else {
            let s = Math.max(0, Math.min(n - o, Math.floor((t - i) / r)));
            let { from: l, length: a } = e.doc.line(o + s);
            return new Zi(l, a, i + r * s, r, 0);
          }
        }
        lineAt(t, e, i, s, o) {
          if (e == ts.ByHeight) return this.blockAt(t, i, s, o);
          if (e == ts.ByPosNoHeight) {
            let { from: e, to: s } = i.doc.lineAt(t);
            return new Zi(e, s - e, 0, 0, 0);
          }
          ...
          return new Zi(a.from, a.length, Math.max(s, Math.min(f, s + this.height - h)), h, 0);
        }
        forEachLine(t, e, i, s, o, n) {
          t = Math.max(t, o);
          ...
          for (let h = t, c = s; h <= e; ) {
            ...
            let s = l + a * e.length;
            n(new Zi(e.from, e.length, c, s, 0));
            c += s;
            h = e.to + 1;
          }
        }
        replace(t, e, i) {
          ...
          if (s > 0) {
            let t = i[i.length - 1];
            if (t instanceof ns) i[i.length - 1] = new ns(t.length + s);
            else i.push(null, new ns(s - 1));
          }
          if (t > 0) {
            let e = i[0];
            if (e instanceof ns) i[0] = new ns(t + e.length);
            else i.unshift(new ns(t - 1), null);
          }
          return is.of(i);
        }
        decomposeLeft(t, e) {
          e.push(new ns(t - 1), null);
        }
        decomposeRight(t, e) {
          e.push(null, new ns(this.length - t - 1));
        }
        updateHeight(t, e = 0, i = false, s) {
          let o = e + this.length;
          if (s && s.from <= e + this.length && s.more) {
            let i = [],
              n = Math.max(e, s.from),
              r = -1;
            if (s.from > e) i.push(new ns(s.from - e - 1).updateHeight(t, e));
            while (n <= o && s.more) {
              let e = t.doc.lineAt(n).length;
              if (i.length) i.push(null);
              let o = s.heights[s.index++];
              if (r == -1) r = o;
              else if (Math.abs(o - r) >= es) r = -2;
              let l = new os(e, o);
              l.outdated = false;
              i.push(l);
              n += e + 1;
            }
            if (n <= o) i.push(null, new ns(o - n).updateHeight(t, n));
            let l = is.of(i);
            if (r < 0 || Math.abs(l.height - this.height) >= es || Math.abs(r - this.heightMetrics(t, e).perLine) >= es) t.heightChanged = true;
            return l;
          } else if (i || this.outdated) {
      ...
      class rs extends is {
        ...
        forEachLine(t, e, i, s, o, n) {
          ...
          if (this.break) {
            ...
            let a = this.lineAt(l, ts.ByPos, i, s, o);
        ...
        balanced(t, e) {
          if (t.size > 2 * e.size || e.size > 2 * t.size) return is.of(this.break ? [t, null, e] : [t, e]);
          this.left = t;
          this.right = e;
      ...
      function ls(t, e) {
        let i, s;
        if (t[e] == null && (i = t[e - 1]) instanceof ns && (s = t[e + 1]) instanceof ns) t.splice(e - 1, 3, new ns(i.length + 1 + s.length));
      }
      const as = 5;
      class hs {
        constructor(t, e) {
        ...
        span(t, e) {
          if (this.lineStart > -1) {
            ...
            if (i instanceof os) i.length += t - this.pos;
            else if (t > this.pos || !this.isCovered) this.nodes.push(new os(t - this.pos, -1));
            this.writtenTo = t;
            if (e > t) {
        ...
        enterLine() {
          ...
          if (this.pos > t) this.nodes.push(new os(this.pos - t, -1));
        ...
        finish(t) {
          ...
          if (this.lineStart > -1 && !(e instanceof os) && !this.isCovered) this.nodes.push(new os(0, -1));
          else if (this.writtenTo < this.pos || e == null) this.nodes.push(this.blankContent(this.writtenTo, this.pos));
          let i = t;
          for (let s of this.nodes) {
            if (s instanceof os) s.updateHeight(this.oracle, i);
            i += s ? s.length : 1;
          }
          return this.nodes;
        }
      ...
      class fs {
        ...
        comparePoint(t, e, i, s) {
          if (t < e || (i && i.heightRelevant) || (s && s.heightRelevant)) Bt(t, e, this.changes, 5);
        }
      }
      function ds(t, e) {
      ...
      class ps {
        ...
        draw(t, e) {
          return At.replace({ widget: new gs(this.size * (e ? t.scaleY : t.scaleX), e) }).range(this.from, this.to);
        }
      }
      class gs extends kt {
        constructor(t, e) {
      ...
      class ms {
        constructor(t) {
          ...
          let e = t.facet(ke).some((t) => typeof t != "function" && t.class == "cm-lineWrapping");
          this.heightOracle = new Qi(e);
          this.stateDeco = t.facet(Ce).filter((t) => typeof t != "function");
          this.heightMap = is.empty().applyChanges(this.stateDeco, s.Text.empty, this.heightOracle.setDoc(t.doc), [new Le(0, 0, 0, t.doc.length)]);
          this.viewport = this.getViewport(0, null);
          this.updateViewportLines();
          this.updateForViewport();
          this.lineGaps = this.ensureLineGaps([]);
          this.lineGapDeco = At.set(this.lineGaps.map((t) => t.draw(this, false)));
        ...
        updateForViewport() {
          ...
          this.scaler = this.heightMap.height <= 7e6 ? xs : new Ms(this.heightOracle, this.heightMap, this.viewports);
        }
        updateViewportLines() {
          this.viewportLines = [];
          this.heightMap.forEachLine(this.viewport.from, this.viewport.to, this.heightOracle.setDoc(this.state.doc), 0, 0, (t) => {
            this.viewportLines.push(this.scaler.scale == 1 ? t : ks(t, this.scaler));
          });
        }
        update(t, e = null) {
          this.state = t.state;
          let i = this.stateDeco;
          this.stateDeco = this.state.facet(Ce).filter((t) => typeof t != "function");
          let o = t.changedRanges;
          let n = Le.extendWithRanges(o, cs(i, this.stateDeco, t ? t.changes : s.ChangeSet.empty(this.state.doc.length)));
        ...
        measure(t) {
          ...
          let p = (this.printing ? us : ds)(e, this.paddingTop);
          ...
          if (a) {
            ...
            for (let i of this.viewports) {
              ...
              this.heightMap = (
                r ? is.empty().applyChanges(this.stateDeco, s.Text.empty, this.heightOracle, [new Le(0, 0, 0, t.state.doc.length)]) : this.heightMap
              ).updateHeight(o, 0, r, new Ji(i.from, n));
            }
        ...
        getViewport(t, e) {
          ...
          let l = new ws(s.lineAt(n - i * 1e3, ts.ByHeight, o, 0, 0).from, s.lineAt(r + (1 - i) * 1e3, ts.ByHeight, o, 0, 0).to);
          if (e) {
            let { head: t } = e.range;
            if (t < l.from || t > l.to) {
              let i = Math.min(this.editorHeight, this.pixelViewport.bottom - this.pixelViewport.top);
              let n = s.lineAt(t, ts.ByPos, o, 0, 0),
                r;
              if (e.y == "center") r = (n.top + n.bottom) / 2 - i / 2;
              else if (e.y == "start" || (e.y == "nearest" && t < l.from)) r = n.top;
              else r = n.bottom - i;
              l = new ws(s.lineAt(r - 1e3 / 2, ts.ByHeight, o, 0, 0).from, s.lineAt(r + i + 1e3 / 2, ts.ByHeight, o, 0, 0).to);
            }
          }
          return l;
        }
        mapViewport(t, e) {
          let i = e.mapPos(t.from, -1),
            s = e.mapPos(t.to, 1);
          return new ws(
            this.heightMap.lineAt(i, ts.ByPos, this.heightOracle, 0, 0).from,
            this.heightMap.lineAt(s, ts.ByPos, this.heightOracle, 0, 0).to
          );
        }
        viewportIsAppropriate({ from: t, to: e }, i = 0) {
          if (!this.inView) return true;
          let { top: s } = this.heightMap.lineAt(t, ts.ByPos, this.heightOracle, 0, 0);
          let { bottom: o } = this.heightMap.lineAt(e, ts.ByPos, this.heightOracle, 0, 0);
          let { visibleTop: n, visibleBottom: r } = this;
          return (
        ...
        mapLineGaps(t, e) {
          ...
          let i = [];
          for (let s of t) if (!e.touchesRange(s.from, s.to)) i.push(new ps(e.mapPos(s.from), e.mapPos(s.to), s.size));
          return i;
        }
        ensureLineGaps(t, e) {
          ...
          let a = (o, r, h, c) => {
            ...
            if (!u) {
              ...
              u = new ps(o, r, this.gapSize(h, o, r, c));
            }
            l.push(u);
          };
          for (let s of this.viewportLines) {
            if (s.length < r) continue;
            let t = vs(s.from, s.to, this.stateDeco);
        ...
        updateLineGaps(t) {
          if (!ps.same(t, this.lineGaps)) {
            this.lineGaps = t;
            this.lineGapDeco = At.set(t.map((t) => t.draw(this, this.heightOracle.lineWrapping)));
          }
        }
        ...
        lineBlockAt(t) {
          return (
            ...
            ks(this.heightMap.lineAt(t, ts.ByPos, this.heightOracle, 0, 0), this.scaler)
          );
        }
        lineBlockAtHeight(t) {
          return ks(this.heightMap.lineAt(this.scaler.fromDOM(t), ts.ByHeight, this.heightOracle, 0, 0), this.scaler);
        }
        scrollAnchorAt(t) {
      ...
      class Ms {
        constructor(t, e, i) {
          ...
          this.viewports = i.map(({ from: i, to: o }) => {
            let n = e.lineAt(i, ts.ByPos, t, 0, 0).top;
            let r = e.lineAt(o, ts.ByPos, t, 0, 0).bottom;
            s += r - n;
      ...
      function ks(t, e) {
        ...
        let i = e.toDOM(t.top),
          s = e.toDOM(t.bottom);
        return new Zi(t.from, t.length, i, s - i, Array.isArray(t._content) ? t._content.map((t) => ks(t, e)) : t._content);
      }
      const Cs = s.Facet.define({ combine: (t) => t.join(" ") });
      const As = s.Facet.define({ combine: (t) => t.indexOf(true) > -1 });
      const Ds = o.StyleModule.newName(),
        Ts = o.StyleModule.newName(),
        Os = o.StyleModule.newName();
      const Es = { "&light": "." + Ts, "&dark": "." + Os };
      function Rs(t, e, i) {
      ...
      class Hs {
        ...
        readRange(t, e) {
          ...
          for (let s = t; ; ) {
            ...
            let n = Y.get(s),
              r = Y.get(o);
            if (n && r ? n.breakAfter : (n ? n.breakAfter : x(s)) || (x(o) && (s.nodeName != "BR" || s.cmIgnore) && this.text.length > t))
              this.lineBreak();
            s = o;
          }
        ...
        findPointInside(t, e) {
          for (let i of this.points)
            if (t.nodeType == 3 ? i.node == t : t.contains(i.node)) i.pos = this.text.length + (Ps(t, i.node, i.offset) ? e : 0);
        }
      }
      function Ps(t, e, i) {
        for (;;) {
          if (!e || i < k(e)) return false;
          if (e == t) return true;
          i = S(e) + 1;
          e = e.parentNode;
        }
      ...
      class Ns {
        constructor(t, e, i, o) {
          ...
          if (t.state.readOnly && e > -1) {
            ...
            let l = t.viewport;
            if ((rt.ios || rt.chrome) && t.state.selection.main.empty && i != o && (l.from > 0 || l.to < t.state.doc.length)) {
              let e = Math.min(i, o),
                s = Math.max(i, o);
              let n = l.from - e,
                r = l.to - s;
      ...
      function Fs(t, e) {
        ...
        if (e.bounds) {
          ...
          let c = zs(t.state.doc.sliceString(o, l, Ls), e.text, a - o, h);
          if (c) {
            if (rt.chrome && r == 13 && c.toB == c.from + 2 && e.text.slice(c.from, c.toB) == Ls + Ls) c.toB--;
            i = { from: o + c.from, to: o + c.toA, insert: s.Text.of(e.text.slice(c.from, c.toB).split(Ls)) };
          }
        } else if (o && ((!t.hasFocus && t.state.facet(ve)) || o.main.eq(n))) {
          o = null;
        }
        if (!i && !o) return false;
        ...
        } else if (rt.chrome && i && i.from == i.to && i.from == n.head && i.insert.toString() == "\n " && t.lineWrapping) {
          if (o) o = s.EditorSelection.single(o.main.anchor - 1, o.main.head - 1);
          i = { from: n.from, to: n.to, insert: s.Text.of([" "]) };
        }
        if (i) {
          if (rt.ios && t.inputState.flushIOSKey(i)) return true;
          if (
            rt.android &&
            ((i.to == n.to &&
              ...
              (i.from == n.from && i.to == n.to + 1 && i.insert.length == 0 && P(t.contentDOM, "Delete", 46)))
          )
            return true;
          ...
          let s;
          let l = () => s || (s = Ws(t, i, o));
          if (!t.state.facet(ce).some((s) => s(t, i.from, i.to, e, l))) t.dispatch(l());
          return true;
      ...
      const Ys = rt.ie && rt.ie_version <= 11;
      class Xs {
        constructor(t) {
          this.view = t;
          this.active = false;
        ...
        onSelectionChange(t) {
          ...
          if (i.state.facet(ve) ? i.root.activeElement != this.dom : !v(i.dom, s)) return;
        ...
        readSelectionRange() {
          ...
          let e = g(t.root);
          if (!e) return false;
          let i = (rt.safari && t.root.nodeType == 11 && w(this.dom.ownerDocument) == this.dom && js(this.view, e)) || e;
      ...
      class $s {
        ...
        constructor(t = {}) {
          ...
          this._root = t.root || V(t.parent) || document;
          this.viewState = new ms(t.state || s.EditorState.create(t));
          if (t.scrollTo && t.scrollTo.is(me)) this.viewState.scrollTarget = t.scrollTo.value.clip(this.viewState.state);
          this.plugins = this.state.facet(ye).map((t) => new xe(t));
          for (let i of this.plugins) i.update(this);
          this.observer = new Xs(this);
          this.inputState = new ci(this);
          this.inputState.ensureHandlers(this.plugins);
          this.docView = new Pe(this);
          this.mountStyles();
          this.updateAttrs();
          this.updateState = 0;
          this.requestMeasure();
        ...
        update(t) {
          ...
          try {
            ...
            for (let e of t) {
              ...
              if (e.scrollIntoView) {
                ...
                f = new ge(t.empty ? t : s.EditorSelection.cursor(t.head, t.head > t.anchor ? -1 : 1));
              }
              for (let t of e.effects) if (t.is(me)) f = t.value.clip(this.state);
            }
            this.viewState.update(o, f);
            this.bidiCache = Js.update(this.bidiCache, o.changes);
            if (!o.empty) {
              this.updatePlugins(o);
              this.inputState.update(o);
            }
            e = this.docView.update(o);
            if (this.state.facet(Be) != this.styleModules) this.mountStyles();
            i = this.updateAttrs();
          ...
          if (o.startState.facet(Cs) != o.state.facet(Cs)) this.viewState.mustMeasureContent = true;
          ...
          if (!o.empty)
            for (let s of this.state.facet(he)) {
              try {
                s(o);
              } catch (d) {
          ...
          if (a || c)
            Promise.resolve().then(() => {
              ...
              if (c) {
                if (!Fs(this, c) && h.force) P(this.contentDOM, h.key, h.keyCode);
              }
            });
        }
        setState(t) {
          ...
          try {
            ...
            this.viewState = new ms(t);
            this.plugins = t.facet(ye).map((t) => new xe(t));
          ...
          for (let e of this.plugins) {
            ...
            if (i && i.docViewUpdate) {
              try {
                ...
                we(this.state, t, "doc view update listener");
              }
            }
          }
        }
        measure(t = true) {
          ...
          try {
            for (let t = 0; ; t++) {
              ...
              let c = He.create(this, this.state, []),
                f = false;
              c.flags |= l;
              if (!e) e = c;
              else e.flags |= l;
          ...
          if (e && !e.empty) for (let l of this.state.facet(he)) l(e);
        }
        get themeClasses() {
          return Ds + " " + (this.state.facet(As) ? Os : Ts) + " " + this.state.facet(Cs);
        }
        updateAttrs() {
          let t = Zs(this, Me, { class: "cm-editor" + (this.hasFocus ? " cm-focused " : " ") + this.themeClasses });
          let e = {
            spellcheck: "false",
            autocorrect: "off",
            autocapitalize: "off",
            translate: "no",
            contenteditable: !this.state.facet(ve) ? "false" : "true",
            class: "cm-content",
        ...
        mountStyles() {
          this.styleModules = this.state.facet(Be);
          let t = this.state.facet($s.cspNonce);
          o.StyleModule.mount(this.root, this.styleModules.concat(Bs).reverse(), t ? { nonce: t } : undefined);
        }
        readMeasured() {
        ...
        moveByChar(t, e, i) {
          return hi(this, t, ni(this, t, e, i));
        }
        moveByGroup(t, e) {
          return hi(
            this,
            t,
            ni(this, t, e, (e) => ri(this, t.head, e))
          );
        }
        visualLineSide(t, e) {
        ...
        moveVertically(t, e, i) {
          return hi(this, t, li(this, t, e, i));
        }
        domAtPos(t) {
        ...
        coordsAtPos(t, e = 1) {
          ...
          let s = this.state.doc.lineAt(t),
            o = this.bidiSpans(s);
          let n = o[_t.find(o, t - s.from, -1, e)];
        ...
        bidiSpans(t) {
          if (t.length > Us) return ee(t.length);
          let e = this.textDirectionAt(t.from),
            i;
          for (let o of this.bidiCache) {
            if (o.from == t.from && o.dir == e && (o.fresh || Gt(o.isolates, (i = Oe(this, t))))) return o.order;
          }
          if (!i) i = Oe(this, t);
          let s = te(t.text, e, i);
          this.bidiCache.push(new Js(t.from, t.to, e, i, true, s));
          return s;
        }
        get hasFocus() {
          var t;
          return (
            (this.dom.ownerDocument.hasFocus() ||
              (rt.safari && ((t = this.inputState) === null || t === void 0 ? void 0 : t.lastContextMenu) > Date.now() - 3e4)) &&
        ...
        static scrollIntoView(t, e = {}) {
          return me.of(new ge(typeof t == "number" ? s.EditorSelection.cursor(t) : t, e.y, e.x, e.yMargin, e.xMargin));
        }
        scrollSnapshot() {
          let { scrollTop: t, scrollLeft: e } = this.scrollDOM;
          let i = this.viewState.scrollAnchorAt(t);
          return me.of(new ge(s.EditorSelection.cursor(i.from), "start", "start", i.top - t, e, true));
        }
        static domEventHandlers(t) {
          return Se.define(() => ({}), { eventHandlers: t });
        }
        static domEventObservers(t) {
          return Se.define(() => ({}), { eventObservers: t });
        }
        static theme(t, e) {
          let i = o.StyleModule.newName();
          let s = [Cs.of(i), Be.of(Rs(`.${i}`, t))];
          if (e && e.dark) s.push(As.of(true));
          return s;
        }
        static baseTheme(t) {
          return s.Prec.lowest(Be.of(Rs("." + Ds, t, Es)));
        }
      ...
      $s.inputHandler = ce;
      $s.scrollHandler = pe;
      $s.focusChangeEffect = fe;
      $s.perLineTextDirection = de;
      $s.exceptionSink = ae;
      $s.updateListener = he;
      $s.editable = ve;
      $s.mouseSelectionStyle = le;
      $s.dragMovesSelection = re;
      $s.clickAddsSelectionRange = ne;
      $s.decorations = Ce;
      $s.outerDecorations = Ae;
      $s.atomicRanges = De;
      $s.bidiIsolatedRanges = Te;
      $s.scrollMargins = Ee;
      $s.darkTheme = As;
      $s.cspNonce = s.Facet.define({ combine: (t) => (t.length ? t[0] : "") });
      $s.contentAttributes = ke;
      $s.editorAttributes = Me;
      $s.lineWrapping = $s.contentAttributes.of({ class: "cm-lineWrapping" });
      $s.announce = s.StateEffect.define();
      const Us = 4096;
      const Qs = {};
      class Js {
        ...
        static update(t, e) {
          ...
          for (let o = Math.max(0, t.length - 10); o < t.length; o++) {
            ...
            if (n.dir == s && !e.touchesRange(n.from, n.to))
              i.push(new Js(e.mapPos(n.from, 1), e.mapPos(n.to, -1), n.dir, n.isolates, false, n.order));
          }
          return i;
        }
      }
      ...
      const to = rt.mac ? "mac" : rt.windows ? "win" : rt.linux ? "linux" : "key";
      function eo(t, e) {
        const i = t.split(/-(?!$)/);
        let s = i[i.length - 1];
        if (s == "Space") s = " ";
      ...
      const so = s.Prec.default(
        $s.domEventHandlers({
          keydown(t, e) {
            return fo(ro(e.state), t, e, "editor");
          },
        })
      );
      const oo = s.Facet.define({ enables: so });
      const no = new WeakMap();
      function ro(t) {
        let e = t.facet(oo);
        let i = no.get(e);
        if (!i) no.set(e, (i = co(e.reduce((t, e) => t.concat(e), []))));
        return i;
      }
      function lo(t, e, i) {
        return fo(ro(t.state), e, t, i);
      }
      let ao = null;
      const ho = 4e3;
      function co(t, e = to) {
          ...
          for (let e = 1; e < f.length; e++) {
            ...
            if (!c[i])
              c[i] = {
                ...
                run: [
                  (e) => {
                    let s = (ao = { view: e, prefix: i, scope: t });
                    setTimeout(() => {
                      if (ao == s) ao = null;
                    }, ho);
                    return true;
      ...
      function fo(t, e, i, o) {
        ...
        let c = "",
          ...
          d = false,
          u = false;
        if (ao && ao.view == i && ao.scope == o) {
          c = ao.prefix + " ";
          if (gi.indexOf(e.keyCode) < 0) {
            d = true;
            ao = null;
          }
        }
        ...
        if (w) {
          if (m(w[c + io(l, e, !h)])) {
            f = true;
          } else if (h && (e.altKey || e.metaKey || e.ctrlKey) && !(rt.windows && e.ctrlKey && e.altKey) && (v = n[e.keyCode]) && v != l) {
            if (m(w[c + io(v, e, true)])) {
              f = true;
            } else if (e.shiftKey && (b = r[e.keyCode]) != l && b != v && m(w[c + io(b, e, false)])) {
              f = true;
            }
          } else if (h && e.shiftKey && m(w[c + io(l, e, true)])) {
            f = true;
          }
      ...
      class uo {
        ...
        static forRange(t, e, i) {
          if (i.empty) {
            ...
            if (!s) return [];
            let o = po(t);
            return [new uo(e, s.left - o.left, s.top - o.top, null, s.bottom - s.top)];
          } else {
            return mo(t, e, i);
          }
        }
      ...
      function mo(t, e, i) {
        ...
        if (g && (t.lineWrapping || u.widgetLineBreaks)) g = go(t, s, g);
        if (m && (t.lineWrapping || p.widgetLineBreaks)) m = go(t, o, m);
        if (g && m && g.from == m.from) {
          ...
          else if (e.bottom < s.top && t.elementAtHeight((e.bottom + s.top) / 2).type == Ct.Text) e.bottom = s.top = (e.bottom + s.top) / 2;
          return v(e).concat(o).concat(v(s));
        }
        function w(t, i, s, o) {
          return new uo(e, t - a.left, i - a.top - 0.01, s - t, o - i + 0.01);
        }
      ...
      class vo {
        ...
        update(t) {
          if (t.startState.facet(bo) != t.state.facet(bo)) this.setOrder(t.state);
        ...
        draw(t) {
          if (t.length != this.drawn.length || t.some((t, e) => !wo(t, this.drawn[e]))) {
      ...
      function yo(t) {
        return [Se.define((e) => new vo(e, t)), bo.of(t)];
      }
      const So = !rt.ios;
      const xo = s.Facet.define({
        combine(t) {
      ...
      function Mo(t = {}) {
        return [xo.of(t), Ao, To, Eo, ue.of(true)];
      }
      function ko(t) {
        return t.facet(xo);
      }
      ...
      const Ao = yo({
        ...
        markers(t) {
          ...
          for (let n of e.selection.ranges) {
            ...
            if (n.empty ? !r || So : i.drawRangeCursor) {
              ...
              for (let s of uo.forRange(t, e, i)) o.push(s);
            }
          }
          return o;
        },
      ...
      const To = yo({
        above: false,
        markers(t) {
          return t.state.selection.ranges.map((e) => (e.empty ? [] : uo.forRange(t, "cm-selectionBackground", e))).reduce((t, e) => t.concat(e));
        },
        update(t, e) {
          return t.docChanged || t.selectionSet || t.viewportChanged || Co(t);
        },
      ...
      if (So) {
        Oo[".cm-line"].caretColor = "transparent !important";
        Oo[".cm-content"] = { caretColor: "transparent !important" };
      }
      const Eo = s.Prec.highest($s.theme(Oo));
      const Ro = s.StateEffect.define({
        map(t, e) {
          return t == null ? null : e.mapPos(t);
        },
      });
      const Bo = s.StateField.define({
        create() {
          return null;
        },
        update(t, e) {
          if (t != null) t = e.changes.mapPos(t);
          return e.effects.reduce((t, e) => (e.is(Ro) ? e.value : t), t);
        },
      });
      const Lo = Se.fromClass(
        class {
          constructor(t) {
            this.view = t;
            this.cursor = null;
          ...
          update(t) {
            ...
            if (i == null) {
              ...
              if (t.startState.field(Bo) != i || t.docChanged || t.geometryChanged) this.view.requestMeasure(this.measureReq);
            }
          }
          readPos() {
            let { view: t } = this;
            let e = t.state.field(Bo);
          ...
          setDropPos(t) {
            if (this.view.state.field(Bo) != t) this.view.dispatch({ effects: Ro.of(t) });
          }
        },
        {
          eventObservers: {
      ...
      class No {
        ...
        createDeco(t) {
          let e = new s.RangeSetBuilder(),
            i = e.add.bind(e);
          for (let { from: s, to: o } of Vo(t, this.maxLength)) Po(t.state.doc, this.regexp, s, o, (e, s) => this.addMatch(s, t, e, i));
          return e.finish();
        }
        updateDeco(t, e) {
          let i = 1e9,
          ...
          for (let o of t.visibleRanges) {
            ...
            if (r > n) {
              ...
              if (i == s) {
                ...
                Po(t.state.doc, this.regexp, l, a, (e, i) => this.addMatch(i, t, e, f));
              }
      ...
      const Fo = /x/.unicode != null ? "gu" : "g";
      const Wo = new RegExp("[\0-\b\n--­؜​‎‏\u2028\u2029‭‮⁦⁧⁩\ufeff￹-￼]", Fo);
      const zo = {
        0: "null",
        7: "bell",
        8: "backspace",
      ...
      function Io() {
        var t;
        if (Ko == null && typeof document != "undefined" && document.body) {
          let e = document.body.style;
          Ko = ((t = e.tabSize) !== null && t !== void 0 ? t : e.MozTabSize) != null;
        }
        return Ko || false;
      }
      const qo = s.Facet.define({
        combine(t) {
          let e = (0, s.combineConfig)(t, { render: null, specialChars: Wo, addSpecialChars: null });
          if ((e.replaceTabs = !Io())) e.specialChars = new RegExp("\t|" + e.specialChars.source, Fo);
          if (e.addSpecialChars) e.specialChars = new RegExp(e.specialChars.source + "|" + e.addSpecialChars.source, Fo);
          return e;
        },
      });
      function Yo(t = {}) {
                ...
                return new No({
                  ...
                  decoration: (e, i, o) => {
                    ...
                    if (r == 9) {
                      ...
                      return At.replace({ widget: new Uo(((e - (r % e)) * this.view.defaultCharacterWidth) / this.view.scaleX) });
                    }
                    return this.decorationCache[r] || (this.decorationCache[r] = At.replace({ widget: new $o(t, r) }));
                  },
      ...
      class $o extends kt {
        ...
        toDOM(t) {
          let e = jo(this.code);
          let i = t.state.phrase("Control character") + " " + (zo[this.code] || "0x" + this.code.toString(16));
      ...
      function Jo() {
        return [
          ...
          ke.of((t) => {
            var e;
            return ((e = t.plugin(Qo)) === null || e === void 0 ? void 0 : e.attrs) || null;
          }),
        ];
      }
      function Zo() {
      ...
      const tn = At.line({ class: "cm-activeLine" });
      const en = Se.fromClass(
        class {
          constructor(t) {
      ...
      function on(t) {
        return Se.fromClass(
          class {
            constructor(e) {
              this.view = e;
              this.placeholder = t ? At.set([At.widget({ widget: new sn(t), side: 1 }).range(0)]) : At.none;
            }
            get decorations() {
              return this.view.state.doc.length ? At.none : this.placeholder;
            }
          },
          { decorations: (t) => t.decorations }
        );
      ...
      function rn(t, e, i) {
        ...
        let r = [];
        if (e.off > nn || i.off > nn || e.col < 0 || i.col < 0) {
      ...
      function an(t, e) {
        ...
        let o = t.state.doc.lineAt(i),
          n = i - o.from;
        let r = n > nn ? -1 : n == o.length ? ln(t, e.clientX) : (0, s.countColumn)(o.text, t.state.tabSize, i - o.from);
      ...
      function cn(t) {
        ...
        return $s.mouseSelectionStyle.of((t, i) => (e(i) ? hn(t, i) : null));
      }
      const fn = {
        Alt: [18, (t) => !!t.altKey],
      ...
      const dn = { style: "cursor: crosshair" };
      function un(t = {}) {
        let [e, i] = fn[t.key || "Alt"];
        let s = Se.fromClass(
          class {
            constructor(t) {
              this.view = t;
        ...
        return [
          s,
          $s.contentAttributes.of((t) => {
            var e;
            return ((e = t.plugin(s)) === null || e === void 0 ? void 0 : e.isDown) ? dn : null;
          }),
        ];
      }
      const pn = "-10000px";
      ...
      const vn = s.Facet.define({
        combine: (t) => {
          var e, i, s;
          return {
            position: rt.ios ? "absolute" : ((e = t.find((t) => t.position)) === null || e === void 0 ? void 0 : e.position) || "fixed",
            parent: ((i = t.find((t) => t.parent)) === null || i === void 0 ? void 0 : i.parent) || null,
            tooltipSpace: ((s = t.find((t) => t.tooltipSpace)) === null || s === void 0 ? void 0 : s.tooltipSpace) || wn,
          };
        },
      });
      const bn = new WeakMap();
      const yn = Se.fromClass(
        class {
          constructor(t) {
            this.view = t;
            this.above = [];
          ...
          readMeasure() {
            ...
            if (this.position == "fixed" && this.manager.tooltipViews.length) {
              ...
              } else if (t.style.top == pn && t.style.left == "0px") {
          ...
          writeMeasure(t) {
            ...
            for (let l = 0; l < this.manager.tooltips.length; l++) {
              ...
              let g = d.right - d.left,
                m = (e = bn.get(h)) !== null && e !== void 0 ? e : d.bottom - d.top;
              let w = h.offset || xn,
          ...
          maybeMeasure() {
            if (this.manager.tooltips.length) {
              ...
              if (this.inView != this.view.inView) {
                ...
                if (!this.inView) for (let t of this.manager.tooltipViews) t.dom.style.top = pn;
              }
            }
          }
        },
      ...
      const xn = { x: 0, y: 0 };
      const Mn = s.Facet.define({ enables: [yn, Sn] });
      const kn = s.Facet.define({ combine: (t) => t.reduce((t, e) => t.concat(e), []) });
      class Cn {
        static create(t) {
          return new Cn(t);
        }
      ...
      class Dn {
        ...
        get tooltip() {
          ...
          let e = t ? t.manager.tooltips.findIndex((t) => t.create == Cn.create) : -1;
        ...
        mousemove(t) {
          ...
          if ((s.length && o && !On(o.dom, t)) || this.pending) {
            let { pos: o } = s[0] || this.pending,
              n = (i = (e = s[0]) === null || e === void 0 ? void 0 : e.end) !== null && i !== void 0 ? i : o;
            if (o == n ? this.view.posAtCoords(this.lastMove) != o : !En(this.view, o, n, t.clientX, t.clientY)) {
      ...
      function On(t, e) {
        let i = t.getBoundingClientRect();
        return e.clientX >= i.left - Tn && e.clientX <= i.right + Tn && e.clientY >= i.top - Tn && e.clientY <= i.bottom + Tn;
      }
      function En(t, e, i, s, o, n) {
      ...
      function Rn(t, e = {}) {
        ...
        return [o, Se.define((s) => new Dn(s, t, o, i, e.hoverTime || 300)), An];
      }
      function Bn(t, e) {
        let i = t.plugin(yn);
        if (!i) return null;
      ...
      function Ln(t) {
        return t.facet(kn).some((t) => t);
      }
      const Hn = s.StateEffect.define();
      const Pn = Hn.of(null);
      function Vn(t) {
        let e = t.plugin(yn);
        if (e) e.maybeMeasure();
      }
      const Nn = s.Facet.define({
        combine(t) {
          let e, i;
          for (let s of t) {
            e = e || s.topContainer;
      ...
      const zn = Se.fromClass(
        class {
          constructor(t) {
            this.input = t.state.facet(qn);
            this.specs = this.input.filter((t) => t);
            this.panels = this.specs.map((e) => e(t));
            let e = t.state.facet(Nn);
            this.top = new Kn(t, true, e.topContainer);
            this.bottom = new Kn(t, false, e.bottomContainer);
          ...
          update(t) {
            ...
            if (this.bottom.container != e.bottomContainer) {
              this.bottom.sync([]);
              this.bottom = new Kn(t.view, false, e.bottomContainer);
            }
            this.top.syncClasses();
            this.bottom.syncClasses();
            let i = t.state.facet(qn);
            if (i != this.input) {
              let e = i.filter((t) => t);
              let s = [],
                o = [],
      ...
      const qn = s.Facet.define({ enables: zn });
      class Yn extends s.RangeValue {
        compare(t) {
          return this == t || (this.constructor == t.constructor && this.eq(t));
        }
        eq(t) {
      ...
      Yn.prototype.toDOM = undefined;
      Yn.prototype.mapMode = s.MapMode.TrackBefore;
      ...
      function jn(t) {
        return [Un(), Gn.of(Object.assign(Object.assign({}, _n), t))];
      }
      const $n = s.Facet.define({ combine: (t) => t.some((t) => t) });
      function Un(t) {
        let e = [Qn];
        if (t && t.fixed === false) e.push($n.of(true));
        return e;
      }
      const Qn = Se.fromClass(
        class {
          constructor(t) {
            this.view = t;
            ...
            this.gutters = t.state.facet(Gn).map((e) => new er(t, e));
            for (let e of this.gutters) this.dom.appendChild(e.dom);
            this.fixed = !t.state.facet($n);
            if (this.fixed) {
          ...
          update(t) {
            ...
            if (this.view.state.facet($n) != !this.fixed) {
          ...
          syncGutters(t) {
            ...
            let i = s.RangeSet.iter(this.view.state.facet(Xn), this.view.viewport.from);
            let o = [];
            let n = this.gutters.map((t) => new tr(t, this.view.viewport, -this.view.documentPadding.top));
          ...
          updateGutters(t) {
            let e = t.startState.facet(Gn),
              i = t.state.facet(Gn);
            let o =
              t.docChanged ||
              t.heightChanged ||
              t.viewportChanged ||
              !s.RangeSet.eq(t.startState.facet(Xn), t.state.facet(Xn), t.view.viewport.from, t.view.viewport.to);
            if (e == i) {
      ...
      class er {
        constructor(t, e) {
          ...
          this.markers = Jn(e.markers(t));
          if (e.initialSpacer) {
            this.spacer = new ir(t, 0, 0, [e.initialSpacer(t)]);
        ...
        update(t) {
          let e = this.markers;
          this.markers = Jn(this.config.markers(t.view));
      ...
      class ir {
        ...
        update(t, e, i, s) {
          ...
          if (!sr(this.markers, s)) this.setMarkers(t, s);
        }
        setMarkers(t, e) {
      ...
      const ar = Gn.compute([nr], (t) => ({
        class: "cm-lineNumbers",
        renderEmptyElements: false,
        markers(t) {
          return t.state.facet(or);
        },
        lineMarker(t, e, i) {
          if (i.some((t) => t.toDOM)) return null;
          return new rr(lr(t, t.state.doc.lineAt(e.from).number));
        },
        widgetMarker: () => null,
        lineMarkerChange: (t) => t.startState.facet(nr) != t.state.facet(nr),
        initialSpacer(t) {
          return new rr(lr(t, cr(t.state.doc.lines)));
        },
        updateSpacer(t, e) {
          let i = lr(e.view, cr(e.view.state.doc.lines));
          return i == t.number ? t : new rr(i);
        },
        domEventHandlers: t.facet(nr).domEventHandlers,
      }));
      function hr(t = {}) {
        return [nr.of(t), Un(), ar];
      }
      function cr(t) {
        let e = 9;
        while (e < t) e = e * 10 + 9;
      ...
      const fr = new (class extends Yn {
        constructor() {
          super(...arguments);
          this.elementClass = "cm-activeLineGutter";
        }
      })();
      const dr = Xn.compute(["selection"], (t) => {
        let e = [],
          i = -1;
      ...
      const wr = mr(new No({ regexp: /\t| +/g, decoration: (t) => gr(t[0]), boundary: /\S/ }));
      function vr() {
        return wr;
      }
      const br = mr(new No({ regexp: /\s+$/g, decoration: At.mark({ class: "cm-trailingSpace" }), boundary: /\S/ }));
      function yr() {
        return br;
      }
      const Sr = { HeightMap: is, HeightOracle: Qi, MeasuredHeights: Ji, QueryType: ts, ChangedRange: Le, computeOrder: te, moveVisually: se };
    },
  },
]);
