...
(self["webpackChunk_jupyterlab_application_top"] = self["webpackChunk_jupyterlab_application_top"] || []).push([
  [6492],
  {
    46492: (e, t, a) => {
      ...
      function R(e, t) {
        e: for (;;) {
          if (e.next < 0) return console.log("exit at end", e.pos);
          if (e.next == 36) {
            e.advance();
      ...
      function ge(e, t) {
        ...
        return (0, l.Ar)(["QuotedIdentifier", "SpecialVar", "String", "LineComment", "BlockComment", "."], (0, l.et)(a));
      }
      let he = J.configure({
        props: [
      ...
      class be {
        ...
        static define(e) {
          ...
          let a = n.LRLanguage.define({
            name: "sql",
            parser: he.configure({ tokenizers: [{ from: H, to: F(t) }] }),
            languageData: {
